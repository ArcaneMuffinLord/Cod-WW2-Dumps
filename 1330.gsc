...
_id_622A( var_0, var_1 )
{
    ...
    var_10 = var_9 * 2;
    self._id_29E1 = spawnplane( "script_model", var_1 );
    ...
    var_14 = var_13 * 2;
    self._id_5A88 = spawnplane( "script_model", var_1 );
...
_id_5FC7()
{
    ...
    for (;;)
    {
        ...
        if ( _func_203( self.origin, var_0 ) > 0 )
        {
            var_0 = var_0 - ( 0, 0, 500 );
            _id_622A( self, var_0 );
            wait( randomfloat( level._id_6226 ) + level._id_6225 );
            _id_6229();
            wait( randomfloat( level._id_6228 ) + level._id_6227 );
            continue;
        }
...
_id_5FC8()
{
    ...
    for (;;)
    {
        ...
        if ( _func_203( self.origin, var_0 ) > 0 )
        {
            ...
            magicgrenademanual( var_2, var_0, ( 0, 0, 0 ), 0.05, self );
            wait( level._id_622C );
            continue;
        }
...
_id_5FC9()
{
    ...
    for (;;)
    {
        ...
        if ( _func_203( self.origin, var_0 ) > 0 )
        {
            ...
            wait( level._id_6233 + randomfloat( level._id_6234 ) );
            continue;
        }
...
_id_2817( var_0 )
{
    ...
    objective_add( var_1._id_3EE2, "invisible", ( 0, 0, 0 ) );
    objective_position( var_1._id_3EE2, var_0 );
    objective_icon( var_1._id_3EE2, "cb_compassping_minion_friend_mp" );

    if ( !level.teambased )
        objective_playerteam( var_1._id_3EE2, self getentitynumber() );
    else
        objective_team( var_1._id_3EE2, self.team );

    var_1._id_3770 = _id_04D1::_id_45A9();
    objective_add( var_1._id_3770, "invisible", ( 0, 0, 0 ) );
    objective_position( var_1._id_3770, var_0 );
    objective_icon( var_1._id_3770, "cb_compassping_enemy_objective" );

    if ( !level.teambased )
        objective_playerenemyteam( var_1._id_3770, self getentitynumber() );
    else
        objective_team( var_1._id_3770, level._id_6C63[self.team] );
...
_id_63CF( var_0 )
{
    ...
    objective_state( var_0._id_3770, "active" );
    objective_state( var_0._id_3EE2, "active" );
    wait( level._id_6230 + randomfloat( level._id_6231 ) );
...
_id_464F()
{
    ...
    var_2 = ( var_0 * randomfloatrange( level._id_622F, level._id_622E ), var_1 * randomfloatrange( level._id_622F, level._id_622E ), 0.0 );
    var_2 = self.origin + var_2;
    var_2 = getgroundposition( var_2, 3 );
    return var_2;
}
