...
{
    if ( isdefined( var_0 ) && var_0 getentitynumber() == worldentnumber() && isdefined( var_1 ) && isdefined( var_1._id_5A2C ) )
        return 1;
...
{
    var_2 = 0;
    return var_1 && level._id_5A29 && !( isdefined( var_0._id_1F3F ) && var_0._id_1F3F ) && game["state"] == "playing" && !var_0 maps\mp\_utility::isusingremote() && !level._id_8C03 && ( !isagent( var_0 ) || var_2 );
}
...
_id_5A29( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11, var_12, var_13, var_14 )
{
    ...
    if ( isagent( var_9 ) && !isdefined( var_9._id_565F ) )
        return;

    if ( isplayer( var_9 ) )
        self _meth_82FF( "ui_killcam_killedby_id", var_9 getentitynumber() );
    else if ( isagent( var_9 ) || var_15 )
        ...
        else
        {
            ...
            if ( isdefined( var_22 ) )
            {
                ...
                if ( isdefined( var_24 ) && var_24 != 0 )
                {
                    ...
                    var_25 = tablelookuprownum( "mp/statstable.csv", 18, var_29 );
                }
                else
                    var_25 = tablelookuprownum( "mp/statstable.csv", 2, var_22 );
                ...
                if ( !level._id_8C03 && maps\mp\_utility::_id_761E() && isplayer( var_9 ) && !isbot( self ) && !isagent( self ) && maps\mp\gametypes\_class::_id_5E0A( var_9 ) )
                {
            ...
            for ( var_30 = 0; var_30 < 4; var_30++ )
            {
                ...
                {
                    var_31 = tablelookuprownum( "mp/attachmenttable.csv", 3, maps\mp\_utility::_id_1150( var_21[var_30] ) );
    ...
    if ( isagent( var_9 ) && var_12 != "replay" && var_12 != "playofthegame" )
