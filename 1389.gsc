...
_id_52B5()
{
    ...
    for ( var_5 = 1; var_5 <= var_3; var_5++ )
    {
        ...
        {
            var_7 = tablelookupbyrow( var_0, var_6, 1 );

            if ( isdefined( level.wavetabletypestoexclude ) )
            {
                if ( isarray( level.wavetabletypestoexclude ) && common_scripts\utility::_id_0F79( level.wavetabletypestoexclude, var_7 ) )
                    continue;
            }

            var_4 = _id_0547::_id_9470( tablelookupbyrow( var_0, var_6, 0 ) );
            var_8 = _id_0547::_id_9470( tablelookupbyrow( var_0, var_6, var_5 + 1 ) );
...
_id_4743( var_0, var_1 )
{
    ...
    return level._id_3774[var_1][int( min( var_0, level._id_3775 ) )];
}
