...
{
    var_2 = tablelookuprownum( "mp/zombieHintTable.csv", 2, var_1._id_7B79 );

    if ( var_2 == -1 )
        return;

    var_3 = int( tablelookupbyrow( "mp/zombieHintTable.csv", var_2, 0 ) );
    var_4 = int( tablelookupbyrow( "mp/zombieHintTable.csv", var_2, 1 ) );
    var_5 = ( var_4 << 4 ) + var_3;
