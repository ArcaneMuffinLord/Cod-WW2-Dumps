...
attemptheavymeleekill( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9 )
{
    ...
    var_11 = 24;
    var_12 = 21;
    var_13 = rotatevector( var_10, var_2.angles );
    var_14 = getgroundposition( var_2.origin + var_13, var_11, 64, 64, 0 );

    if ( !isdefined( var_14 ) || abs( var_14[2] - var_2.origin[2] ) > var_12 )
        return 0;
...
_id_4ADD( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10 )
{
    ...
    else
    {
        ...
        var_26 = getgroundposition( var_5.origin + var_24, 16 );
...
_id_2678( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    ...
    for ( var_13 = 0; var_13 <= 1.0; var_12 = gettime() )
    {
        ...
        if ( !getdvarint( "cancel_anim_delta", 0 ) )
            var_16 = getmovedelta( var_0, 0, var_15 );

        var_17 = getangledelta( var_0, 0, var_15 );
        var_18 = transformmove( var_4, var_5, common_scripts\utility::_id_A2BE(), common_scripts\utility::_id_A2BE(), var_16, ( 0, var_17, 0 ) );
        var_13 = ( var_12 - var_10 ) * 0.001 / var_6;
        var_19 = min( var_13, 1.0 );
        self.origin = vectorlerp( var_8, var_18["origin"], var_19 );
        self.angles = anglelerp( var_9, var_18["angles"], var_19 );
...
_id_4AB2( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    ...
    if ( !animhasnotetrack( var_2, "dismember_head" ) )
        return;
