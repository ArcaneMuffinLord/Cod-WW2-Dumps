...
_id_0B9A( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    if ( maps\mp\_utility::_id_579B() && isdefined( var_3 ) && isdefined( level._id_79C2._id_80B0 ) && isdefined( level._id_79C2._id_80B0._id_0B98 ) )
        var_7 = round( 3 * level._id_79C2._id_80B0._id_0B98 );
    ...
    for ( var_8 = 0; var_8 < var_7 && !maps\mp\_utility::_id_5668( 0, var_3 ); var_8++ )
    {
        ...
        {
            var_12 = spawnstruct();
            var_12.origin = ( level._id_5FEB[0] + cos( var_9 + 90 ) * var_11 * 700, level._id_5FEB[1] + sin( var_9 + 90 ) * var_11 * 700, level._id_5FEB[2] );
            var_12._id_7F31 = abs( ( abs( var_11 ) - 5 ) / 50 );
...
_id_4435( var_0, var_1, var_2 )
{
    foreach ( var_4 in level.players )
    {
        ...
        foreach ( var_10 in var_0 )
        {
            ...
            if ( isdefined( self ) && var_4 == self && var_11 <= 1000 )
            {
                ...
                {
                    if ( !bullettracepassed( var_4.origin + ( 0, 0, 32 ), var_4.origin + ( 0, 0, 10000 ), 0, var_4 ) )
                    {
    ...
    foreach ( var_17 in var_15 )
    {
        ...
        if ( !bullettracepassed( var_17["position"] + ( 0, 0, 32 ), var_17["position"] + ( 0, 0, 10000 ), 0, undefined ) )
        {
