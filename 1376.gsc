...
_id_6BFA( var_0 )
{
    ...
    wait( getanimlength( var_1["zom_zeppelin_panels_01_open"] ) );
...
_id_243F( var_0 )
{
    ...
    wait( getanimlength( var_1["zom_zeppelin_panels_01_close"] ) );
...
{
    var_2 = getent( "overcharge_trig", "targetname" );
    var_3 = 0;
...
_id_52F0()
{
    level._id_179A = getent( "nest_ee_blimp", "targetname" );
...
_id_113A( var_0 )
{
    ...
    foreach ( var_3 in var_1 )
    {
        var_3._id_65D8 = getent( var_3.target, "targetname" );
...
_id_113D( var_0 )
{
    self._id_1F5D = getent( var_0, "targetname" );
...
{
    var_4 = spawnturret( "misc_turret", self.origin, var_0 );
...
_id_9025( var_0 )
{
    if ( level._id_179A._id_1F5D._id_5DDA == 1 && !common_scripts\utility::_id_562E( level._id_179A._id_4B8B ) )
    {
        ...
        {
            var_9 = vectorlerp( var_1.origin, level._id_179A.origin, var_7 / 10 );
    ...
    if ( _id_8B88() )
    {
        ...
        if ( 1 )
            playfxontag( level._effect["zmb_geistkraft_radius_400"], var_1, "TAG_ORIGIN" );
        ...
        if ( 1 )
            stopfxontag( level._effect["zmb_geistkraft_radius_400"], var_1, "TAG_ORIGIN" );
    }
...
_id_8C16( var_0 )
{
    ...
    for (;;)
    {
        ...
        var_3 = spawnfx( level._effect["gk_raven_hc_ee_uber_stg_" + ( var_2 + 1 )], var_0._id_9FE6.origin, anglestoforward( var_0._id_9FE6.angles ), anglestoup( var_0._id_9FE6.angles ) );
        triggerfx( var_3 );
        var_2++;
    }
}
    ...
    for (;;)
    {
        ...
        if ( common_scripts\utility::_id_562E( self._id_1F1F ) )
        {
            foreach ( var_4 in var_1 )
            {
                ...
                var_10 = bullettracepassed( var_9, var_8, 0, var_4 );
                var_11 = bullettracepassed( var_8, var_9, 0, var_4 );
...
_id_3BAE( var_0 )
{
    ...
    playfxontag( level._effect["zmb_zep_rocket_smoketrail"], var_1, "tag_origin" );
...
_id_3A12( var_0 )
{
    ...
    earthquakes( 0.55, 0.6, var_0, 200 );
    waitframe();
    ...
    for (;;)
    {
        ...
        if ( common_scripts\utility::_id_562E( level._id_179A._id_1F8D ) )
        {
            ...
            while ( isalive( var_2 ) )
            {
                ...
                level._id_8C4B = spawnsighttrace( level._id_8C4C, level._id_8C4C, level._id_8C46, 0 );
                var_14 = bullettrace( level._id_179A._id_6655 gettagorigin( "TAG_AIM" ), level._id_8C46, 0, level._id_179A._id_6655 );
                var_15 = abs( var_14["position"][2] - var_2.origin[2] );
            ...
            _id_17B2( var_16 );
            var_17 = _id_7E3A();
            playfxontag( common_scripts\utility::_id_44F5( "zmb_zeppelin_shot_charge" ), level._id_179A._id_6655, "TAG_YAW" );
            playfxontag( common_scripts\utility::_id_44F5( "zmb_zeppelin_shot_charge_barrel" ), level._id_179A._id_6655, "TAG_AIM" );
            ...
            playfxontag( level._effect["zmb_zeppelin_spotlight_assault"], var_20, "tag_origin" );
            playfxontag( level._effect["zmb_zeppelin_shot"], var_16, "tag_origin" );
            wait 1;
            stopfxontag( level._effect["zmb_zeppelin_spotlight_assault"], var_20, "tag_origin" );
            _id_17B3();
...
_id_2FF3()
{
    ...
    self._id_3F44 = var_1;
    playfxontag( var_1, self._id_65D8, "tag_origin" );
}
...
_id_23D4()
{
    ...
    stopfxontag( var_0, self._id_65D8, "tag_origin" );
...
_id_A690( var_0 )
{
    var_1 = getanimlength( _id_946F( var_0 ) );
    wait( var_1 );
}
...
{
    wait( var_1 / 2 );
    var_2 = getent( "nest_ee_blimp_attack_gun", "targetname" );
    var_2 linktosynchronizedparent( level._id_179A );
    var_3 = spawn( "script_model", var_2.origin );
    var_3 setmodel( "tag_origin" );
    playfxontag( common_scripts\utility::_id_44F5( "zmb_zeppelin_projectile" ), var_3, "tag_origin" );
...
_id_180A( var_0, var_1 )
{
    ...
    playfxontag( level._effect["zmb_zep_battery_fire_trail"], var_2, "tag_origin" );
