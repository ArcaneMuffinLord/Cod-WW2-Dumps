...
_id_49DA()
{
    ...
    if ( isdefined( level._id_47CF ) )
        playfxontagforclients( common_scripts\utility::_id_44F5( level._id_47CF ), var_4, "TAG_ORIGIN", self );
    else
        playfxontagforclients( common_scripts\utility::_id_44F5( "glidebomb_hatchdoors_light_med" ), var_4, "TAG_ORIGIN", self );
        ...
        if ( length( var_9 ) > 0.01 )
        {
            ...
            if ( var_4 )
            {
                ...
                if ( var_5 < 1 )
                {
                    ...
                    var_12 = anglelerp( self.angles, var_0.angles, var_5 );
                    var_5 = var_5 + 0.05;
                }
                else
                {
            ...
            else
            {
                ...
                if ( var_15 > 0.99 )
                {
                    ...
                    playfxontag( common_scripts\utility::_id_44F5( "fritz_streamers" ), var_0, "tag_tip_fx" );
                    playfxontagforclients( common_scripts\utility::_id_44F5( "fritz_flying_1P" ), var_0, "tag_tip_fx", var_1 );
                    var_11 = var_10 * ( -1 * var_7 );
                    var_2 = vectorlerp( var_2, var_11, var_5 );
                    self.origin = var_0.origin + var_2;
                    self.angles = anglelerp( self.angles, var_0.angles, var_5 );
                    var_5 = var_5 + 0.05;
...
_id_2380( var_0, var_1 )
{
    ...
    if ( isdefined( self ) )
    {
        ...
        if ( isdefined( var_0 ) )
            playfxontagforclients( common_scripts\utility::_id_44F5( "fritz_explosion_1P" ), var_0, "tag_tip_fx", self );
...
_id_4434( var_0 )
{
    ...
    foreach ( var_6 in level.players )
    {
        ...
        foreach ( var_3 in var_0 )
        {
            ...
            var_10 = distance2d( var_3._id_01A4.origin, var_6.origin );
...
_id_4433()
{
    ...
    foreach ( var_3 in var_1 )
    {
        if ( isdefined( var_3.target ) )
            var_3._id_01A4 = getent( var_3.target, "targetname" );
    }
