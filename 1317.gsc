...
_id_9FDE( var_0, var_1 )
{
    ...
    playfxontag( common_scripts\utility::_id_44F5( "uav_exit" ), var_0, "tag_origin" );
...
_id_463C( var_0, var_1, var_2, var_3 )
{
    ...
    return int( clamp( var_10, getuavstrengthmin(), getuavstrengthmax() ) );
}
...
_id_A188( var_0 )
{
    ...
    var_3 = 0;
    var_4 = var_1 > getuavstrengthlevelneutral();
    var_5 = var_1 >= getuavstrengthlevelshowenemyfastsweep();
    var_6 = var_1 >= getuavstrengthlevelshowenemydirectional();
...
_id_A187()
{
    foreach ( var_1 in level.players )
    {
        ...
        var_7 = 0;
        var_8 = var_2 > getuavstrengthlevelneutral();
        var_9 = var_2 >= getuavstrengthlevelshowenemyfastsweep();
        var_10 = var_2 >= getuavstrengthlevelshowenemydirectional();
...
_id_09A8( var_0, var_1 )
{
    if ( 0 )
    {
        self._id_620D = spawnplane( "script_model", ( 0, 0, 0 ) );
...
_id_27DD()
{
    ...
    {
        self._id_9846 = newclienthudelem( self );
        self._id_9846.x = -350;
        self._id_9846.y = -70;
        ...
        self._id_6C0C = newclienthudelem( self );
        self._id_6C0C.x = -320;
        self._id_6C0C.y = -70;
