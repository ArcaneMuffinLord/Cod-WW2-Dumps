...
_id_5312()
{
    ...
    for (;;)
    {
        var_1 = tablelookupbyrow( "mp/killstreakTable.csv", var_0, 1 );
        ...
        {
            var_2 = tablelookupistringbyrow( "mp/killstreakTable.csv", var_0, 10 );
            var_3 = tablelookupbyrow( "mp/killstreakTable.csv", var_0, 12 );
            game["dialog"][var_1] = var_3;
            var_4 = tablelookupbyrow( "mp/killstreakTable.csv", var_0, 13 );
