...
_id_06E7( var_0, var_1, var_2 )
{
    ...
    foreach ( var_9 in var_1 )
    {
        ...
        if ( var_11 == 1 )
        {
            ...
            var_13 = distance2d( var_12, common_scripts\utility::_id_A2BE() );
...
{
    var_2 = getdvarvector( "snd_debugRavenAudioColor" );
...
_id_06E4( var_0 )
{
    ...
    if ( level._id_05B8.size >= var_5 )
    {
        ...
        level._id_05B8 = sortbydistance( level._id_05B8, var_10 );
