...
_id_A169( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_1 ) && var_1 != 0 )
        var_3 = tablelookuprownum( "mp/statstable.csv", 18, var_1 );
...
_id_A168( var_0 )
{
    ...
    if ( isdefined( var_1._id_69AD ) )
    {
        ...
        var_4 = tablelookuprownum( var_2, 1, var_5 );
    }
    ...
    if ( isdefined( var_1._id_37FE ) )
    {
        ...
        var_6 = tablelookuprownum( var_2, 1, var_7 );
    }
    ...
    for ( var_9 = 0; var_9 < 4; var_9++ )
    {
        ...
        if ( isdefined( var_10 ) && var_10 != 0 )
        {
            ...
            var_11 = tablelookuprownum( "mp/killstreakTable.csv", 1, var_12 );
        }
    ...
    if ( isdefined( var_13 ) && var_13 != 0 )
    {
        ...
        var_14 = tablelookuprownum( var_2, 1, var_15 );
    }
    else
        var_14 = 0;
