...
_id_5626( var_0 )
{
    ...
    if ( distancesquared( var_3, var_2 ) > squared( 300 ) )
        return 0;
    ...
    var_8 = acos( vectordot( var_7, var_6 ) );

    if ( var_8 > 30 )
        return 0;

    if ( !common_scripts\utility::_id_562E( var_0._id_8C80 ) && !sighttracepassed( var_3, var_2, 0, var_0 ) )
        return 0;
