...
_id_AA35( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( self._id_AA3B ) || isdefined( self._id_AA39 ) )
    {
        ...
        {
            var_8 = isglassdestroyed( self._id_AA3B );
            var_9 = getglassorigin( self._id_AA3B );
        }
        ...
        if ( isdefined( self._id_AA39 ) )
        {
            ...
            physicsexplosionsphere( var_9, var_4, var_3, var_5 );
        ...
        glassradiusdamage( var_9, var_4, var_7, var_6 );
    }
...
_id_AA2E( var_0, var_1 )
{
    ...
    foreach ( var_8 in var_5 )
    {
        ...
        {
            if ( isdefined( self._id_AA3B ) && !isglassdestroyed( self._id_AA3B ) )
            {
...
_id_8CAA( var_0 )
{
    ...
    for (;;)
    {
        var_1 = rotatevector( var_1, ( 0, 0, 5 * var_3 ) );
...
_id_AA30( var_0 )
{
    ...
    foreach ( var_3 in var_1 )
    {
        ...
        var_5 = getnodesinradius( var_3.origin, 90, 0, 90 );
        var_3._id_75EF = [];
        ...
        var_11 = getglassarray( "window_shatter" );

        if ( isdefined( var_11 ) )
        {
            foreach ( var_13 in var_11 )
            {
                var_14 = getglassorigin( var_13 );
...
_id_5977( var_0 )
{
    ...
    var_3 = float( tablelookup( var_2, 0, var_1, 1 ) );
    var_4 = float( tablelookup( var_2, 0, var_1, 2 ) );
    var_5 = float( tablelookup( var_2, 0, var_1, 3 ) );
    var_6 = float( tablelookup( var_2, 0, var_1, 4 ) );
    var_7 = float( tablelookup( var_2, 0, var_1, 5 ) );
...
_id_598A()
{
    ...
    earthquakes( 0.2, 1.5, self.origin, 850, self );
}
...
_id_8A72( var_0, var_1, var_2 )
{
    ...
    var_8 = getstartorigin( var_1, var_2, var_6 );
    var_9 = getstartangles( var_1, var_2, var_6 );
    ...
    for (;;)
    {
        ...
        while ( isdefined( var_5 ) && var_5 istouching( self ) )
        {
            ...
            if ( self._id_606E > 0 )
            {
                ...
                var_10 = angleclamp180( var_9 - var_8 );
                var_10 = clamp( var_10, 0 - self._id_606E, self._id_606E );
                var_11 = transformmove( self._id_0186.origin, ( 0, var_10, 0 ), self._id_0186.origin, ( 0, 0, 0 ), self._id_5EC8.origin, self._id_5EC8.angles )["origin"];
                var_12 = transformmove( self._id_0186.origin, ( 0, var_10, 0 ), self._id_0186.origin, ( 0, 0, 0 ), self._id_502E.origin, self._id_502E.angles )["origin"];
            }
            else
            {
                var_10 = 0;
            ...
            var_13 = distance2d( var_7, var_12 );
            ...
            if ( var_13 < self._id_502E._id_8276 && vectordot( vectornormalize( var_6 ), vectornormalize( var_11 - var_12 ) ) > 0.5 )
            {
                ...
                var_17 = distance2d( var_16, var_12 );
                    ...
                    if ( _id_0547::_id_3048( var_11, var_7, var_7 + 9999 * var_18 ) < self._id_5EC8._id_8276 && vectordot( var_18, var_11 - var_7 ) > 0 )
                    {
                        ...
                        foreach ( var_21 in level.players )
                        {
                            if ( var_21 != var_5 )
                            {
                                ...
                                if ( distance( var_22, var_12 ) < 195 || vectordot( vectornormalize( var_12 - var_22 ), anglestoforward( var_21 _meth_8566() ) ) > 0 && ( sighttracepassed( var_22, var_12 + ( 0, 0, 60 ), 0, undefined ) || sighttracepassed( var_22, self._id_0186.origin, 0, undefined ) ) )
                                {
                                    var_19 = 1;
                                    break;
                                }
...
_id_4A11( var_0, var_1, var_2 )
{
    ...
    for ( var_17 = 0; var_17 < var_11 && isalive( self ); var_17 = var_17 + 0.05 )
    {
        ...
        var_20 = transformmove( var_0._id_0186.origin, var_0._id_0186.angles, ( 0, 0, 0 ), ( 0, 0, 0 ), getmovedelta( var_5, 0, var_19 ), _func_212( var_5, 0, var_19 ) );
        var_21 = transformmove( var_1.origin, var_1.angles, var_0._id_502E.origin, var_0._id_502E.angles, var_20["origin"], var_20["angles"] );
        ...
        if ( var_13 && abs( getmovedelta( var_5, var_18, var_19 )[2] ) < 1 && ( var_22 || var_23 ) )
        {
            self _meth_839D( "gravity" );
            var_14 = 1;
        }
...
_id_347B( var_0, var_1 )
{
    ...
    {
        if ( !maps\mp\_utility::isreallyalive( var_5 ) || !self istouching( var_5 ) && distance2d( var_5.origin, self._id_5978 ) > self._id_5974 )
            continue;
...
_id_3DB3()
{
    ...
    while ( !common_scripts\utility::_id_3C77( "flag_first_fol_inc_selected" ) )
    {
        ...
        {
            if ( !sighttracepassed( var_1.origin, self._id_5978, 0, self._id_3255 ) )
            {
                wait( var_0 );
                continue;
            }
...
_id_3DB2( var_0 )
{
    earthquakes( 0.1, 0.2, self._id_3255.origin, 250 );
