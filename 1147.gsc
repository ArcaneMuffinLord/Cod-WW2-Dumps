...
_id_61D0()
{
    var_0["friendly"] = spawnfx( level._id_3960._id_16F1["friendly"], self gettagorigin( "tag_fx" ) );
    var_0["enemy"] = spawnfx( level._id_3960._id_16F1["enemy"], self gettagorigin( "tag_fx" ) );
