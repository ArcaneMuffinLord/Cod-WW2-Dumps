...
_id_8225( var_0 )
{
    ...
    while ( var_0._id_480C.size != 0 )
    {
        ...
        var_6 = 0;
        var_7 = 0;
        var_8 = transformmove( var_1.origin, var_1.angles, self._id_6C3E.origin, self._id_6C3E.angles, self.origin, self.angles );
...
_id_7388()
{
    ...
    for (;;)
    {
        ...
        if ( isagent( self ) && isdefined( self._id_0EAE ) )
        {
...
_id_A047( var_0, var_1 )
{
    ...
    if ( maps\mp\_utility::_id_585F() && common_scripts\utility::_id_562E( level.use_zombie_unresolved_collision ) )
    {
        ...
        var_2 = common_scripts\utility::_id_0F73( var_2, getnodesinradius( var_0.origin, 300, 0, 200, "End 3D" ) );
