...
_id_954D( var_0 )
{
    ...
    if ( isdefined( var_0._id_81C7 ) )
    {
        ...
        var_0._id_3F3F = spawnfx( common_scripts\utility::_id_44F5( var_0._id_81BB ), var_0.origin, anglestoforward( var_0.angles ), anglestoup( var_0.angles ) );

    if ( gettime() < 500 )
        triggerfx( var_0._id_3F3F, 0.5 );
    else
        triggerfx( var_0._id_3F3F );
}
