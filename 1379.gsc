...
{
    if ( !common_scripts\utility::_id_562E( self.exploder_godmode ) && _id_0547::_id_5565( var_10, tolower( "TAG_WEAPON" ) ) )
    {
        if ( common_scripts\utility::_id_562E( self._id_392C ) )
        {
...
_id_AB95( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9 )
{
    ...
    if ( common_scripts\utility::_id_562E( self._id_392C ) && _id_0547::_id_5565( var_9, tolower( "TAG_WEAPON" ) ) )
        return 1;
...
_id_0BBF( var_0, var_1, var_2, var_3 )
{
    ...
    var_8 = transformmove( var_6, var_7, var_4, var_5, var_0.origin, var_0.angles );
