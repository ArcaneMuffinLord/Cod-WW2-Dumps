...
_id_3C16( var_0, var_1, var_2 )
{
    ...
    var_3 = spawnplane( "script_model", var_1 );
    var_4 = spawnplane( "script_model", var_1 );
    ...
    var_9 = ( 32, -8, 16 );
    var_10 = self.origin + rotatevector( var_9, self.angles );
    var_11 = magicbullet( _id_052A::_id_458D( var_2, self.team ), var_8["position"] + ( 0, 0, _id_052A::_id_4578() ), var_8["position"], 1.5, _id_052A::_id_4578(), self );
