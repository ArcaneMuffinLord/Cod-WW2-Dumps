...
_id_6E41()
{
    ...
    var_1 = getent( "pack_a_punch_weapon_display", "targetname" );
    var_1 _meth_8511();
    ...
    for (;;)
    {
        ...
        if ( var_6 )
        {
            ...
            if ( !common_scripts\utility::_id_3C77( "pap_in_use" ) )
                playfxontag( level._effect["zmb_pack_a_punch_lathe_ammo"], self._id_82EF, "lathe_01" );
...
{
    var_1 = self;
    return var_1 usebuttonpressed() && _id_0547::_id_5565( var_1 _meth_84D1(), var_0 );
}
...
_id_854A( var_0, var_1 )
{
    ...
    level notify( "PAP_display_reset" );
    var_5 = getent( "pack_a_punch_weapon_display", "targetname" );
    ...
    var_8 = spawnfx( level._effect["zmb_pack_a_punch_lathe"], var_4, anglestoforward( self _meth_8181( "lathe_01" ) ), anglestoup( self _meth_8181( "lathe_01" ) ) );
    triggerfx( var_8 );
...
_id_86EE( var_0 )
{
    ...
    for ( var_5 = 0; var_5 < var_1; var_5++ )
    {
        ...
        for ( var_7 = pow( 10, var_1 - var_5 ); var_3 >= var_7 / 10; var_6++ )
