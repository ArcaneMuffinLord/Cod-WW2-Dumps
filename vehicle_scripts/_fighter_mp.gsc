...
fighterinitmg( var_0 )
{
    ...
    foreach ( var_3 in var_0 )
    {
        ...
        var_6 = combineangles( var_4, ( 0, -1 * var_1, 0 ) );
        var_7 = undefined;

        if ( isdefined( var_3._id_6A1B ) )
            var_7 = var_5 + rotatevector( var_3._id_6A1B, var_4 );
        else
            var_7 = var_5;

        var_8 = spawnturret( var_3._id_231A, var_7, var_3._id_5135 );
...
_id_6DB8()
{
    ...
    for (;;)
    {
        ...
        if ( self._id_29B1.size < var_4 )
        {
            ...
            playfxontag( var_11.fx, var_11, "tag_origin" );
...
_id_6DB7()
{
    ...
    if ( isdefined( self._id_29B1 ) )
    {
        foreach ( var_1 in self._id_29B1 )
        {
            if ( isdefined( var_1 ) )
            {
                stopfxontag( var_1.fx, var_1, "tag_origin" );
                var_1 delete();
            }
        }
...
_id_721B()
{
    ...
    if ( isdefined( var_0 ) )
    {
        for (;;)
        {
            ...
            playfxontag( var_0, self, self._id_9BDD );
            common_scripts\utility::_id_37A1( "engineeffects" );
            stopfxontag( var_0, self, self._id_9BDD );
        }
    }
}
...
fx_speed_handler()
{
    ...
    while ( isdefined( self ) )
    {
        ...
        if ( var_2 >= 0.5 )
        {
            if ( !var_1 )
            {
                playfxontagforclients( level._effect["mp_raid_bomber_speedup"], self, self._id_9BDD, var_0 );
                var_1 = 1;
            }
        }
        else if ( var_1 )
