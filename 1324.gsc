...
_id_A17C()
{
    ...
    {
        var_0 = getnodesinradiussorted( self.origin, 128, 0, 64 );
        ...
        foreach ( var_2 in var_0 )
        {
            if ( isdefined( var_2 ) && _func_200( var_2, 1 ) )
            {
                ...
                if ( bullettracepassed( self geteye(), var_3, 0, self ) )
                {
                    if ( _id_583F( var_3 ) )
                    {
                        self._id_9A28 = var_3;
...
_id_583F( var_0 )
{
    if ( canspawn( var_0 ) && self _meth_8346() )
        return 1;
    else
        return 0;
}
...
_id_63EF()
{
    ...
    for (;;)
    {
        ...
        var_2 = playerphysicstrace( self._id_9A28 + ( 0, 0, 16 ), self._id_9A28 - ( 0, 0, 2048 ) ) + ( 0, 0, 1 );
...
_id_47EC( var_0, var_1, var_2 )
{
    ...
    var_4 = spawnfx( var_1, self gettagorigin( "tag_fx" ), anglestoforward( var_3 ), anglestoup( var_3 ) );
    triggerfx( var_4 );
...
_id_86BB( var_0 )
{
    ...
    {
        self._id_0F67 = newclienthudelem( self );
        self._id_0F67.x = 0;
        self._id_0F67.y = 0;
...
_id_A147( var_0, var_1 )
{
    ...
    {
        if ( var_0 )
            playfxontagforclients( var_2, self, "j_head", self );
        else
            _func_295( var_2, self, "j_head", self );
    }
...
_id_8656()
{
    ...
    for (;;)
    {
        ...
        {
            var_2 = magicgrenademanual( var_0, self.origin, ( 0, 0, 0 ), 1.25, self, 1 );
            var_2._id_5751 = 1;
...
handleescalationboostafterkill()
{
    ...
    if ( self._id_7AD2 >= 2 )
    {
        ...
        var_4 = min( var_1 - var_3, var_2 );
        var_5 = min( var_3 + var_4, var_1 );
...
monitorgrenadierprogress()
{
    ...
    var_0 = tablelookuprownum( "mp/grenadierUpgradeTable.csv", 0, level.gametype );

    if ( !isdefined( var_0 ) || var_0 == -1 )
        var_0 = tablelookuprownum( "mp/grenadierUpgradeTable.csv", 0, "default" );

    var_1 = int( tablelookupbyrow( "mp/grenadierUpgradeTable.csv", var_0, 5 ) ) / 100;
    ...
    while ( self._id_0079 == 7 && !self.grenadierfrenzy && !self.enteredfrenzyloop )
    {
        ...
        if ( var_3 > self.previousgrenadiertier )
        {
            if ( var_3 <= 3 )
            {
                ...
                {
                    var_4 = int( tablelookupbyrow( "mp/grenadierUpgradeTable.csv", var_0, 3 ) );
    ...
    if ( var_0 )
    {
        ...
        if ( self.grenadierfrenzy == 0 )
        {
            ...
            else if ( getdvarint( "spv_grenadier_frenzy_mode", 0 ) == 3 )
            {
                ...
                playfxontagforclients( var_1, self, "j_head", self );
                _id_0513::_id_A13B();
                maps\mp\_utility::_id_870F();
                return;
            }
...
getgrenadierprogress()
{
    ...
    if ( self.score < int( tablelookupbyrow( "mp/grenadierUpgradeTable.csv", var_0, 1 ) ) )
    {
        var_1 = 0;
        var_2 = 0;
        var_3 = int( tablelookupbyrow( "mp/grenadierUpgradeTable.csv", var_0, 1 ) );
        var_4 = ( self.score - var_2 ) / ( var_3 - var_2 );
    }
    else if ( self.score < int( tablelookupbyrow( "mp/grenadierUpgradeTable.csv", var_0, 2 ) ) )
    {
        var_1 = 1;
        var_2 = int( tablelookupbyrow( "mp/grenadierUpgradeTable.csv", var_0, 1 ) );
        var_3 = int( tablelookupbyrow( "mp/grenadierUpgradeTable.csv", var_0, 2 ) );
        var_4 = ( self.score - var_2 ) / ( var_3 - var_2 );
    }
    else if ( self.score < int( tablelookupbyrow( "mp/grenadierUpgradeTable.csv", var_0, 3 ) ) )
    {
        var_1 = 2;
        var_2 = int( tablelookupbyrow( "mp/grenadierUpgradeTable.csv", var_0, 2 ) );
        var_3 = int( tablelookupbyrow( "mp/grenadierUpgradeTable.csv", var_0, 3 ) );
        var_4 = ( self.score - var_2 ) / ( var_3 - var_2 );
    }
    else if ( self.score >= int( tablelookupbyrow( "mp/grenadierUpgradeTable.csv", var_0, 3 ) ) )
    {
        var_1 = 3;
        var_2 = int( tablelookupbyrow( "mp/grenadierUpgradeTable.csv", var_0, 3 ) );
        var_3 = int( tablelookupbyrow( "mp/grenadierUpgradeTable.csv", var_0, 4 ) );
...
monitorfrenzypoints( var_0, var_1 )
{
    ...
    var_2 = tablelookuprownum( "mp/grenadierUpgradeTable.csv", 0, level.gametype );

    if ( !isdefined( var_2 ) || var_2 == -1 )
        var_2 = tablelookuprownum( "mp/grenadierUpgradeTable.csv", 0, "default" );

    var_3 = int( tablelookupbyrow( "mp/grenadierUpgradeTable.csv", var_2, 4 ) );
    var_4 = int( tablelookupbyrow( "mp/grenadierUpgradeTable.csv", var_2, 5 ) ) / 100;
        ...
        if ( isdefined( var_1 ) )
        {
            foreach ( var_3 in var_1 )
            {
                ...
                if ( _id_0513::_id_5696( var_3 ) )
                {
                    ...
                    {
                        self setweaponammostock( var_3, var_5 + weaponclipsize( var_3 ) );
                        var_0 = 1;
                    }
                }
            }
...
getattachmentsforweapon( var_0, var_1 )
{
    ...
    var_2 = getpossibleweaponattachments( var_0 );
...
buildwunderlustweaponlist()
{
    ...
    for ( var_2 = 0; var_2 <= var_1; var_2++ )
    {
        ...
        var_4 = tablelookupbyrow( "mp/statstable.csv", var_2, 1 );

        if ( var_3 == "weapon_other" && tolower( getsubstr( var_4, 0, 7 ) ) != "weapon_" )
            continue;

        var_5 = tablelookupbyrow( "mp/statstable.csv", var_2, 2 );
        ...
        var_6 = tablelookupbyrow( "mp/statstable.csv", var_2, 18 );
        ...
        if ( tablelookupbyrow( "mp/statstable.csv", var_2, 53 ) == "1" )
            var_7 = 1;

        var_8 = tablelookupbyrow( "mp/statstable.csv", var_2, 56 );
    ...
    {
        var_21 = tablelookupbyrow( "mp/attachmentcombos_mtx12.csv", 0, var_20 );
        ...
        if ( isdefined( var_4 ) )
        {
            foreach ( var_6 in var_4 )
            {
                ...
                if ( _id_0513::_id_5696( var_6 ) )
                {
                    ...
                    {
                        self setweaponammostock( var_6, var_8 + weaponclipsize( var_6 ) );
                        var_3 = 1;
                    }
                }
            }
