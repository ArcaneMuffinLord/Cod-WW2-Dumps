...
_id_9900( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    ...
    foreach ( var_16 in _id_0547::_id_408F() )
    {
        ...
        if ( !bullettracepassed( var_13, var_18, 0, var_7 ) )
            continue;
...
_id_9901( var_0 )
{
    ...
    var_2 = self;
    var_2._id_98F0 = _id_4385() + var_1 + randomfloatrange( 0.1, 0.6 );
}
...
_id_98EE( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    ...
    foreach ( var_10 in [ "j_head", "j_spine4" ] )
    {
        ...
        playfxontag( common_scripts\utility::_id_44F5( var_8 ), var_7, var_10 );
        break;
    }
...
_id_98E9( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    ...
    physicsexplosioncylinder( var_0, var_1, 0, 1.7 );
}
...
_id_98FC()
{
    ...
    for (;;)
    {
        ...
        foreach ( var_5 in _id_0547::_id_408F() )
        {
            ...
            if ( distance2d( var_5.origin, var_0.origin ) > var_6 + var_1 )
                continue;
