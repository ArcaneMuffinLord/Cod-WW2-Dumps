...
_id_4690( var_0 )
{
    ...
    {
        if ( var_2 == tablelookupbyrow( var_3, 0, var_6 ) )
        {
            var_5 = var_6;
            break;
        }
    ...
    {
        var_9 = tablelookupbyrow( var_3, var_8, 0 );

        if ( isdefined( var_9 ) && _id_56BE( var_9 ) )
        {
            var_10 = tablelookupbyrow( var_3, var_8, var_5 );
    ...
    if ( getdvarint( "spawning_revised_fatique" ) != 0 )
    {
        ...
        if ( var_16 && var_10.size > 0 )
        {
            if ( var_9 > 0 && var_11 > 0 && var_11 / var_9 > 0.9 )
            {
                ...
                {
                    if ( distance2d( var_6.origin, var_20.origin ) <= 1300 )
