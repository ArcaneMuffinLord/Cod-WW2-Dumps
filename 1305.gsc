...
_id_1E83( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    if ( var_6 )
        var_10 = ( _id_44D7( var_6 ) - var_7 ) / sin( 50 ) + 13000;
    else
        var_10 = ( _id_44D7( var_6 ) - var_7 ) / sin( 45 ) + 11000;
...
_id_9080( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    ...
    if ( var_10.team == "allies" )
    {
        ...
        playfxontag( level._effect["fighter_trail"], var_11, "TAG_TRAIL_FX" );
    ...
    if ( var_16 )
    {
        var_10._id_620D = spawnplane( "script_model", var_3 );
    ...
    if ( isdefined( var_1 ) )
    {
        ...
        playfxontagforclients( common_scripts\utility::_id_44F5( "fighter_flying_1P" ), var_14, "tag_origin", var_1 );
...
{
    var_2 = self.origin + rotatevector( var_0, self.angles );
...
_id_27EB( var_0 )
{
    ...
    var_1 = self.origin + rotatevector( ( 3500, 750, 500 ), self.angles );
    ...
    playfxontagforclients( common_scripts\utility::_id_44F5( "fighter_clouds_1P" ), var_2, "tag_origin", var_0 );
