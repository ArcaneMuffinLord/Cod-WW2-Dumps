...
_id_3662()
{
    ...
    var_1 = sortbydistance( var_1, var_2 );
    var_8 = 0;
    ...
    {
        if ( distancesquared( self.origin, var_16.origin ) < var_4 && abs( self.origin[2] - var_16.origin[2] ) < 90 )
...
_id_9529( var_0 )
{
    ...
    var_4 = spawnfx( common_scripts\utility::_id_44F5( var_3 ), var_2 );
    triggerfx( var_4 );
...
mini_stunning_burst_execute( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7 )
{
    ...
    var_9 = sortbydistance( _id_0547::_id_408F(), var_0, var_2 );
    var_10 = 0;
...
mini_stunning_burst_state_run_manage_fx()
{
    ...
    for (;;)
    {
        playfxontag( var_1, var_0, "J_Spine4" );
        wait 0.35;
    }
}
