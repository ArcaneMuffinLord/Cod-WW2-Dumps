...
actionnotifymessage( var_0 )
{
    ...
    {
        var_2 = tablelookuprownum( get_splash_table(), 0, var_0.name );
        var_3 = common_scripts\utility::stringtofloat( tablelookupbyrow( get_splash_table(), var_2, 4 ) );
...
lowermessagethink()
{
    ...
    if ( ( level.splitscreen || self _meth_82D0() && !isai( self ) ) && !_func_3BA() )
    {
        var_1 = var_1 - 40;
...
_id_8C19( var_0, var_1 )
{
    ...
    var_2 = tablelookuprownum( get_splash_table(), 0, var_0 );
