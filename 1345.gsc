...
_id_52AA()
{
    ...
    for ( var_7 = 0; var_7 < var_6; var_7++ )
    {
        ...
        level._id_2FEA[var_8] = float( var_9 );
        level._id_2FEB[var_8] = float( var_10 );
...
_id_4597( var_0, var_1, var_2, var_3 )
{
    ...
    if ( ( var_0 & var_0 - 1 ) > 0 )
    {
        if ( var_2 < 1 )
        {
            ...
            for ( var_7 = 4; var_7 > 0; var_7-- )
            {
                ...
                {
                    if ( randomfloat( 1.0 ) > _id_20AF( var_11 ) * var_3 )
                        var_4 = var_4 | var_11;
                }
            }
        }
    ...
    {
        if ( randomfloat( 1.0 ) > _id_20AF( var_0 ) * var_3 )
            var_4 = var_0;
    }
    ...
    if ( isalive( self ) && ( !maps\mp\agents\_scripted_agent_anim_util::_id_57E2() || var_3 >= 1 ) && self._id_0BA4 != "traverse" && _id_0547::_id_4B2C() )
    {
        ...
        if ( var_7 != 0 )
        {
            ...
            if ( level._id_2775 < 9999 || self._id_2FDA || ( var_7 & 12 ) == 0 || ( var_7 & 16 ) != 0 || ( self._id_6250 & 3 ) != 0 )
            {
                ...
                {
                    if ( _id_0547::_id_5731() )
                        earthquakes( randomfloatrange( 0.15, 0.35 ), 1, self.origin, 200 );
...
detachlimbsupdatemodelqueue( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    var_6 = floor( level.mutilate_detach_limb_queue / 2 ) * 0.05;
...
_id_903D( var_0, var_1, var_2 )
{
    ...
    if ( var_2 && isdefined( var_8 ) )
    {
        ...
        var_7.angles = var_6;
        var_9 = ( 0, 0, randomfloatrange( 1000, 2000 ) );
        var_10 = var_1 * randomfloatrange( 500, 1000 );
        var_11 = ( randomfloatrange( -2000, 2000 ), randomfloatrange( -2000, 2000 ), randomfloatrange( -2000, 2000 ) );
    ...
    if ( isdefined( var_18 ) )
    {
        ...
        var_23 = vectornormalize( vectorcross( var_22, var_21 ) );

        if ( lengthsquared( var_23 ) < 0.5 )
            var_23 = anglestoright( var_19 );

        var_24 = vectorcross( var_23, var_22 );
...
_id_AC26( var_0, var_1 )
{
    ...
    if ( self._id_4B6E || self._id_4B5A )
    {
        ...
        var_7 = var_0;
        var_8 = var_7[0] * 10000 * randomfloat( 1 );
        var_9 = var_7[1] * 10000 * randomfloat( 1 );
        var_10 = var_7[2] * 6000 * randomfloat( 1 );
