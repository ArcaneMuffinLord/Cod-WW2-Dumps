...
_id_3662()
{
    ...
    if ( _id_0547::_id_4BA7( "specialty_class_survivalist_zm" ) )
    {
        ...
        _id_0547::_id_7454( int( min( var_0, 3 ) ) );
    }
...
_id_17BB()
{
    ...
    while ( self._id_569F )
    {
        foreach ( var_1 in _id_0547::_id_408F() )
        {
            ...
            {
                playfxontagforclients( level._effect["zmb_moon_zmb_blind"], var_1, "J_Head", self );
                var_1._id_5689 = 1;
            }
        }
...
_id_2F9E()
{
    if ( common_scripts\utility::_id_562E( self._id_569F ) )
    {
        ...
        foreach ( var_1 in _id_0547::_id_408F() )
            stopfxontag( level._effect["zmb_moon_zmb_blind"], var_1, "J_Head" );
