...
_id_A207()
{
    ...
    if ( level._id_53C6 )
        var_0 = getnodesinradiussorted( self.origin, 10000, 50, 2000, "Path" );
    else
        var_0 = getnodesinradiussorted( self.origin, 500, 50, 128, "Path" );
...
_id_8F96( var_0, var_1, var_2, var_3 )
{
    ...
    if ( ishairrunning() )
        playfxontag( level._id_3F1E, self, "tag_origin" );
}
...
_id_8F27( var_0 )
{
    foreach ( var_2 in var_0 )
    {
        ...
        foreach ( var_5 in level.players )
        {
            ...
            var_7 = var_5.origin;
            var_8 = sighttracepassed( var_6, var_7, 0, var_5 );
