...
_id_47F2( var_0 )
{
    ...
    var_2 = 1;
    var_3 = abs( distance( level._id_34D5.origin, level._id_A4AC[var_0][level._id_A4AC[var_0].size - 1].origin ) );
...
{
    var_2 = 1;
    var_3 = abs( distance( level._id_34D5.origin, level._id_78AD[var_1]["player_view_pos"] ) );
    var_2 = var_2 * ( var_3 / 1200 );
    var_2 = max( var_2, 0.1 );
    var_4 = var_2;
