...
getrankformmr( var_0 )
{
    if ( !isdefined( level.ranktablecache ) )
    {
        ...
        {
            var_3 = tablelookupbyrow( "mp/rankedplaytable.csv", var_2, 1 );
            var_4 = tablelookupbyrow( "mp/rankedplaytable.csv", var_2, 2 );
            level.ranktablecache[var_2] = [ float( var_3 ), float( var_4 ) ];
        }
    }
