    ...
    for (;;)
    {
        if ( self._id_3876 == "[A]" )
        {
            ...
            for (;;)
            {
                ...
                if ( isstring( var_3 ) && var_3 == "elevator_called" && self._id_64D2 != _id_4128() )
                {
                    self._id_3876 = "[B]";
                    break;
                }
...
_id_35C7( var_0 )
{
    ...
    var_4 = abs( distance( self._id_3532["floor" + var_0 + "_pos"], var_1.origin ) );
    var_5 = var_4 / var_3;
    ...
    foreach ( var_1 in level._id_35B9 )
    {
        ...
        foreach ( var_12, var_6 in level._id_35D1 )
        {
            foreach ( var_11, var_8 in var_6 _id_4271() )
            {
                ...
                if ( abs( distance( var_2, var_9 ) ) <= level._id_35B8 )
                {
                    if ( abs( distance( var_3, var_10 ) ) <= level._id_35B7 )
                    {
