...
_id_5963()
{
    ...
    self._id_5962 = getent( "civilian_jet_flyto", "targetname" );
...
_id_5967()
{
    ...
    if ( getdvar( "jet_flyby_timer" ) != "" )
        ...
        level._id_2305 = ( 0.25 + randomfloatrange( 0.3, 0.7 ) ) * 60 * var_1;
...
_id_5961()
{
    ...
    foreach ( var_7 in var_3 )
        playfxontag( self._id_595B, var_7, "tag_origin" );

    foreach ( var_11 in var_4 )
    {
        if ( isdefined( var_11.color ) && var_11.color == "blink" )
        {
            playfxontag( self._id_595C, var_11, "tag_origin" );
            continue;
        }

        if ( isdefined( var_11.color ) && var_11.color == "red" )
        {
            playfxontag( self._id_595E, var_11, "tag_origin" );
            continue;
        }

        playfxontag( self._id_595D, var_11, "tag_origin" );
    }
...
_id_A403()
{
    ...
    self._id_A5B1 = getent( self.target, "targetname" );
    var_0 = getent( self._id_A5B1.target, "targetname" );
    ...
    if ( isdefined( var_3.target ) )
        self._id_A5A7 = getent( var_3.target, "targetname" ).origin;
            ...
            if ( var_2 )
            {
                if ( !self._id_5D7C )
                {
                    ...
                    foreach ( var_7 in var_1 )
                    {
                        ...
                        playfxontag( level._id_6C6B, var_7._id_5D2F, "tag_origin" );
                    }
                }
...
_id_6F8E( var_0 )
{
    ...
    {
        var_1 = getent( self._id_2660.target, "targetname" );
...
_id_9FB9()
{
    ...
    if ( isdefined( self.target ) )
    {
        ...
        {
            self._id_A241 = getent( self.target, "targetname" );
...
_id_9FB7()
{
    ...
    playfxontag( level._id_1BB0["tv_explode"], self, "tag_fx" );
