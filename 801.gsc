...
_id_10D3()
{
    if ( isarray( level._id_80CD[self._id_0EC4] ) )
    {
...
_id_8381( var_0 )
{
    ...
    var_1 = sortbydistance( var_1, self.origin, 3000 );
    var_1 = common_scripts\utility::_id_0FA0( var_1 );
    var_2 = var_1[randomintrange( 0, int( var_1.size / 2 ) )];
...
_id_2169( var_0 )
{
    var_1 = level._id_24F8[tolower( var_0 )];
...
_id_48D9()
{
    ...
    else if ( !isdefined( self._id_48DA ) && self._id_01D0 != "none" )
    {
        ...
        self detach( getweaponmodel( self._id_01D0 ), "tag_weapon_right" );
    }
}
...
_id_48D8()
{
    ...
    else if ( isdefined( self._id_48DA ) )
    {
        ...
        self attach( getweaponmodel( self._id_01D0 ), "tag_weapon_right" );
...
_id_3E2F( var_0, var_1, var_2 )
{
    ...
    self._id_01D0 = var_0;
    self._id_1D83 = weaponclipsize( self._id_01D0 );
...
_id_5C93( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    {
        var_11 = float( gettime() - var_6 ) / float( var_7 - var_6 );
        var_11 = 0.5 - cos( var_11 * 180 ) * 0.5;
        var_12 = var_3.origin;
        ...
        var_14 = vectorlerp( var_2, var_13, var_11 );
        var_10 = var_10 + var_14 * var_5;
        self.origin = vectorlerp( var_10, var_12, var_11 );

        if ( isdefined( var_4 ) )
            self.angles = anglelerp( var_8, var_3 _meth_8181( var_4 ), var_11 );
    ...
    foreach ( var_7 in level._id_08C7 )
    {
        if ( isdefined( var_7 ) && isdefined( var_7._id_378F ) )
        {
            ...
            if ( _func_296( var_0 ) && _func_296( var_1 ) )
                var_17 = sighttracepassed( var_11, var_12, 0, undefined );
...
_id_723A( var_0, var_1, var_2 )
{
    ...
    if ( sighttracepassed( var_5, var_6, 1, level.player, var_0 ) )
    {
        var_0._id_7452 = 1;
        return 1;
    }
    ...
    if ( sighttracepassed( var_5, var_7, 1, level.player, var_0 ) )
    {
        var_0._id_7452 = 1;
        return 1;
    }
    ...
    if ( sighttracepassed( var_5, var_8, 1, level.player, var_0 ) )
    {
        var_0._id_7452 = 1;
        return 1;
    }
...
_id_8CAD()
{
    ...
    setslowmotion( level._id_8CAB._id_90EB, level._id_8CAB._id_90EF, level._id_8CAB._id_5C9C );
}
...
_id_8CAE()
{
    ...
    setslowmotion( level._id_8CAB._id_90EF, level._id_8CAB._id_90EB, level._id_8CAB._id_5C9D );
}
...
_id_8530( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_1 ) )
    {
        ...
        while ( abs( var_0 - self._id_64BA ) > abs( var_6 * 1.1 ) )
        {
...
_id_8531( var_0, var_1 )
{
    ...
    if ( isdefined( var_1 ) )
    {
        ...
        while ( abs( var_0 - self._id_64DF ) > abs( var_5 * 1.1 ) )
        {
...
_id_27C6( var_0 )
{
    ...
    var_1._id_111A = 0.0;
    var_1._id_1121 = 0.0;
    level._id_A565[tolower( var_0 )] = var_1;
    return var_1;
}
...
_id_43CB( var_0 )
{
    ...
    var_1 = level._id_A565[tolower( var_0 )];

    if ( _id_A251() && isdefined( var_1 ) && isdefined( var_1._id_4BD4 ) )
        var_1 = level._id_A565[tolower( var_1._id_4BD4 )];
...
_id_279B( var_0 )
{
    ...
    var_1 = spawnstruct();
    var_1.name = var_0;
    level._id_3DA7[tolower( var_0 )] = var_1;
    return var_1;
}
...
_id_419B( var_0 )
{
    ...
    var_1 = level._id_3DA7[tolower( var_0 )];
    return var_1;
}
...
_id_3DA8( var_0, var_1 )
{
    ...
    var_2 = level._id_3DA7[tolower( var_0 )];

    if ( !isdefined( var_2 ) )
        var_2 = level._id_A565[tolower( var_0 )];

    if ( isdefined( var_2 ) && isdefined( var_2._id_4BD4 ) && _id_A251() )
    {
        if ( isdefined( level._id_3DA7[tolower( var_2._id_4BD4 )] ) )
            var_2 = level._id_3DA7[tolower( var_2._id_4BD4 )];
        else if ( isdefined( level._id_A565 ) )
            var_2 = level._id_A565[tolower( var_2._id_4BD4 )];
    }
...
_id_096D( var_0 )
{
    if ( isdefined( var_0 ) )
        ...
        self._id_7001 = getent( self.target, "targetname" );
...
_id_8B30( var_0, var_1, var_2 )
{
    ...
    var_4 = var_3 - var_0;
    var_5 = length( var_4 );
    var_6 = asin( clamp( var_2 / var_5, 0, 1 ) );

    if ( vectordot( vectornormalize( var_4 ), vectornormalize( var_1 - var_0 ) ) > cos( var_6 ) )
        return 1;
...
_id_45B2( var_0 )
{
    ...
    return getnode( var_0, "script_noteworthy" );
}
...
_id_44C5( var_0 )
{
    ...
    return getent( var_0, "script_noteworthy" );
}
...
_id_9438( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    for (;;)
    {
        ...
        {
            var_12 = vectornormalize( anglestoforward( sortbydistance( level._id_3DD2, var_0._id_00AD )[0].angles ) + vectornormalize( var_0.origin - level.player.origin ) );
...
_id_2311( var_0, var_1, var_2, var_3 )
{
    ...
    else if ( var_4[2] > 0 )
    {
        ...
        if ( lengthsquared( var_4 ) > var_2 * var_2 )
...
_id_1E36( var_0, var_1, var_2, var_3 )
{
    ...
    var_8 = squared( cos( var_2 * -1.0 ) );
    var_9 = tan( var_2 * -1.0 );
    var_10 = sqrt( var_0 * var_6 / ( 2 * var_8 * ( var_5 - var_7 * var_9 ) ) );

    if ( common_scripts\utility::_id_55BF( var_10 ) )
        return undefined;

    var_11 = rotatevector( ( 1, 0, 0 ), ( var_2, vectortoyaw( var_4 ), 0 ) );
...
_id_1801( var_0, var_1, var_2 )
{
    ...
    else if ( var_2 )
    {
        ...
        var_6 = sortbydistance( var_6, level.player.origin, 2000 );
        ...
        foreach ( var_8 in var_6 )
        {
            ...
            {
                if ( isdefined( var_8._id_01D0 ) && weapontype( var_8._id_01D0 ) == "bullet" )
                {
                    var_8 _meth_81E8();
                    break;
                }
