    ...
    for (;;)
    {
        ...
        switch ( var_2 )
        {
            ...
            case "ready":
                ...
                var_1 = spawnfx( common_scripts\utility::_id_44F5( "trap_ready" ), var_0.origin );
                triggerfx( var_1 );
                break;
            case "active":
                if ( isdefined( var_1 ) )
                ...
                var_1 = spawnfx( common_scripts\utility::_id_44F5( "trap_not_ready" ), var_0.origin );
                triggerfx( var_1 );
                break;
            default:
                break;
...
_id_9CC7( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    foreach ( var_7 in var_5 )
    {
        ...
        if ( 1 && ( isdefined( var_3 ) || isdefined( var_4 ) ) )
        {
            ...
            {
                var_12 = tablelookupbyrow( "mp/zombieCustomTrapInteract.csv", var_11, 1 );

                if ( var_8 && var_12 == var_3 )
                {
                    var_7._id_4DAF["hint_ready_ref"] = int( tablelookupbyrow( "mp/zombieCustomTrapInteract.csv", var_11, 0 ) );
                    var_8 = 0;
                }
                else if ( var_9 && var_12 == var_4 )
                {
                    var_7._id_4DAF["hint_cooldown_ref"] = int( tablelookupbyrow( "mp/zombieCustomTrapInteract.csv", var_11, 0 ) );
                    var_9 = 0;
                }
    ...
    for (;;)
    {
        ...
        if ( isdefined( var_0._id_8260 ) )
        {
            if ( _func_30D( var_0._id_8260 ) )
                var_1._id_6081 = squared( int( var_0._id_8260 ) );
        }
...
_id_9CD7( var_0 )
{
    ...
    for (;;)
    {
        ...
        self waittill( "active" );
        var_1._id_57E4 = 0;
        playfxontag( common_scripts\utility::_id_44F5( "chompy_lights" ), var_1, "tag_body" );
        ...
        killfxontag( common_scripts\utility::_id_44F5( "chompy_lights" ), var_1, "tag_body" );
...
_id_9CF4( var_0 )
{
    ...
    for (;;)
    {
        ...
        foreach ( var_5 in _func_2D1() )
        {
            ...
            var_5._id_66D8 = gettime() + randomintrange( 1, 5 ) * 50;
...
_id_9CDA( var_0, var_1, var_2 )
{
    ...
    var_1._id_66D2 = gettime() + randomintrange( 1000, 3000 );
    ...
    switch ( var_0 )
    {
        case "hit":
            ...
            foreach ( var_6 in level.players )
            {
                ...
                {
                    var_8 = distance2d( self._id_1167.origin, var_6.origin );
        ...
        switch ( var_1 )
        {
            ...
            case "enable_jumpon":
                ...
                foreach ( var_8 in var_0._id_116C )
                    var_8._id_66D2 = gettime() + randomintrange( 0, 2000 );
...
_id_9CE8( var_0 )
{
    ...
    if ( !common_scripts\utility::_id_562E( var_0._id_22DE ) )
        playfxontag( common_scripts\utility::_id_44F5( "chompy_churn" ), var_0, "tag_body" );

    var_0._id_22DE = 1;
    wait 5;
    var_0._id_22DE = 0;
    stopfxontag( common_scripts\utility::_id_44F5( "chompy_churn" ), var_0, "tag_body" );
}
