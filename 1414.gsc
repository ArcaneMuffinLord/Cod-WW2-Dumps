...
_id_0F21( var_0, var_1 )
{
    ...
    var_5 = 0;
    var_6 = 0;
    var_7 = weaponclipsize( var_4, self );
    ...
    if ( isdefined( var_1._id_0DBB ) )
    {
        ...
        var_9 = weaponmaxammo( var_4, self );
...
_id_0791( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    if ( ( var_0 == "none" || var_1 == "none" ) && stricmp( var_0, var_1 ) != 0 )
        return 0;
    ...
    if ( var_2 )
        return stricmp( var_6["weapon"], var_7["weapon"] ) == 0;
    else
    {
...
_id_50FA( var_0, var_1 )
{
    ...
    if ( var_3 >= 150 )
    {
        ...
        var_5 = getgroundposition( self.origin + var_4, 16 );
...
_id_43F1( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    foreach ( var_8 in var_4 )
    {
        ...
        if ( _func_211( var_12, var_11 ) > var_10 * var_10 || abs( var_11[2] - var_12[2] ) > var_9 * 0.5 )
            continue;
