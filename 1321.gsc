...
_id_8A0E()
{
    ...
    level._id_1FFC = getent( var_0[0].target, "targetname" );
...
_id_3493( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    ...
    var_7 = var_0.origin + ( randomintrange( -3, 3 ), randomfloatrange( -3, 3 ), -5 );
...
_id_2E45( var_0, var_1 )
{
    ...
    if ( var_0.visualteam == "allies" )
        playfxontag( common_scripts\utility::_id_44F5( "care_package_allies_beacon" ), var_0, "TAG_FX" );
    else
        playfxontag( common_scripts\utility::_id_44F5( "care_package_axis_beacon" ), var_0, "TAG_FX" );
...
_id_2752( var_0, var_1 )
{
    ...
    if ( isdefined( self._id_0117 ) && abs( self.origin[2] - self._id_0117.origin[2] ) > 4000 )
    {
        _id_2D30();
        return;
    }
...
_id_275D()
{
    var_0 = getnodesinradiussorted( self.origin, 300, 0, 300 );
...
_id_27D3( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    ...
    if ( var_7.visualteam == "any" )
    {
        ...
        playfxontag( common_scripts\utility::_id_44F5( "care_package_axis_beacon" ), var_7, "TAG_FX" );
    ...
    else
    {
        ...
        if ( var_7.visualteam == "axis" )
            ...
            playfxontag( common_scripts\utility::_id_44F5( "care_package_allies_beacon" ), var_7, "TAG_FX" );
    }
...
_id_5A2E( var_0 )
{
    ...
    for (;;)
    {
        ...
        if ( length( var_4 ) > 0.01 )
        {
            ...
            if ( var_3 < 1 )
            {
                var_7 = vectorlerp( var_1, var_6, var_3 );
                var_3 = var_3 + 0.05;
            }
            else
                var_7 = var_6;
...
_id_275A( var_0 )
{
    if ( _func_367() )
    {
        if ( self.origin[2] >= 90 )
        {
            ...
            setomnvar( "ui_fge_carepackages_remaining", level._id_1FFD.size );
            _id_2D30( 1, 1, 1 );
        }
        else
        {
            ...
            if ( isdefined( level._id_320F ) )
                self._id_320E = spawnfx( level._id_320F, self.origin );
    ...
    else
    {
        if ( level.teambased || isdefined( self._id_0117 ) )
        {
            ...
            if ( !level.teambased && isdefined( self._id_0117 ) )
                objective_playerteam( var_3, self._id_0117 getentitynumber() );
        ...
        if ( isdefined( self._id_0117 ) )
        {
            ...
            if ( !level.teambased && isdefined( self._id_0117 ) )
                objective_playerenemyteam( var_3, self._id_0117 getentitynumber() );
            else
                objective_team( var_3, level._id_6C63[self.team] );
...
_id_A7A0( var_0 )
{
    ...
    while ( isdefined( var_0 ) && maps\mp\_utility::isreallyalive( var_0 ) && !var_0 _meth_8346() && var_1 == var_0.origin && var_0 usebuttonpressed() )
    {
        var_3 = gettime() - var_2;
...
_id_5A5F( var_0 )
{
    ...
    for (;;)
    {
        ...
        if ( _func_367() )
        {
            level._id_2758++;
            common_scripts\utility::_id_0F93( level._id_1FFD, self );
            setomnvar( "ui_fge_carepackages_secured", level._id_2758 );
            setomnvar( "ui_fge_carepackages_remaining", level._id_1FFD.size );
...
_id_27DF( var_0, var_1 )
{
    ...
    var_2 _meth_805B();
    waitframe();
    physicsexplosionsphere( var_0, 100, 80, 0.6 );
    wait 2;
    var_2 delete();
}
