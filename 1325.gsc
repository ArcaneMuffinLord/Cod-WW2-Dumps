...
_id_1E13( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8 )
{
    ...
    if ( maps\mp\_utility::isbulletdamage( var_3 ) )
    {
        ...
        if ( isplayer( var_1 ) && var_1 maps\mp\_utility::_hasperk( "specialty_paint_pro" ) && !maps\mp\_utility::iskillstreakweapon( var_4 ) && ( isplayer( var_0 ) || isagent( var_0 ) ) )
        {
    ...
    else if ( isexplosivedamagemod( var_3 ) || var_3 == "MOD_GAS" )
    {
        if ( !isdefined( var_1 ) )
            return var_2;
        ...
        if ( maps\mp\_utility::getweaponclass( var_4 ) == "weapon_projectile" && weaponclass( var_4 ) == "rocketlauncher" && isplayer( var_1 ) && weaponinheritsperks( var_4 ) && var_1 maps\mp\_utility::_hasperk( "specialty_class_launched" ) )
        ...
        else if ( isplayer( var_1 ) && weaponinheritsperks( var_4 ) && ( var_1 maps\mp\_utility::_hasexperimentalbtperk( "specialty_explosivedamage" ) && var_0 maps\mp\_utility::_hasperk( "specialty_blastshield2" ) && var_0 maps\mp\_utility::_hasexperimentalbtperk( "specialty_reducedexplosivefallprotection" ) ) )
            var_9 = var_9 + var_2 * level.clumsydamagemod;
        else if ( isplayer( var_1 ) && weaponinheritsperks( var_4 ) && ( var_1 maps\mp\_utility::_hasexperimentalbtperk( "specialty_explosivedamage" ) && var_0 maps\mp\_utility::_hasperk( "specialty_blastshield2" ) ) )
            var_9 = var_9 + 0;
        else if ( isplayer( var_1 ) && weaponinheritsperks( var_4 ) && ( var_1 maps\mp\_utility::_hasexperimentalbtperk( "specialty_explosivedamage" ) && var_0 maps\mp\_utility::_hasexperimentalbtperk( "specialty_reducedexplosivefallprotection" ) ) )
            var_9 = var_9 + ( var_2 * level._id_395D + var_2 * level.clumsydamagemod );
        else if ( isplayer( var_1 ) && weaponinheritsperks( var_4 ) && var_1 maps\mp\_utility::_hasexperimentalbtperk( "specialty_explosivedamage" ) )
