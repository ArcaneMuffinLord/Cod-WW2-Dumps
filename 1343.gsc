        ...
        if ( isdefined( self._id_8301 ) && isdefined( self._id_8301[0] ) )
        {
            ...
            if ( _id_0547::_id_5565( var_5, "animated_zmb_door_bunker_entrance_2" ) )
            {
                foreach ( var_7 in self._id_64C5 )
                {
                    ...
                    {
                        var_7 linkto( self._id_8301[0], "door_R" );
                        continue;
                    }

                    if ( var_7._id_8260 == "door_l" )
                        var_7 linkto( self._id_8301[0], "door_L" );
                }
            }
        }
...
_id_82F2()
{
    ...
    switch ( var_6 )
    {
        case "animated_zmb_door_bunker":
            var_3 = getanimlength( %salt_mine_door_02_open );
            var_4 = 1.2;
            break;
        case "animated_zmb_salt_mine_door":
            var_3 = getanimlength( %salt_mine_door_01_open );
            var_4 = 3.23333;
            break;
        case "animated_zmb_gate_electric_01_snow":
        case "animated_zmb_gate_electric_01":
            var_3 = getanimlength( %s2_zmb_electric_gate_open );
            var_4 = 0.8;
            break;
        case "animated_zmb_elec_gate_barn_01":
            var_3 = getanimlength( %s2_zmb_elec_gate_barn_01_open );
            var_4 = 0.8;
            break;
        case "animated_zmb_gate_01":
            var_3 = getanimlength( %zmb_gate_01_open );
            var_4 = 0.9;
            break;
        ...
        case "animated_zmb_door_bunker_entrance_2":
            var_3 = getanimlength( %s2_zmb_bumker_gate_open );
            var_4 = 14.0;
            var_5 = 7.5;
            break;
        ...
        case "animated_zbr_drop_pod":
            ...
            var_3 = getanimlength( %s2_zom_drop_pod_open );
            var_4 = 0.5;
            break;
        case "animated_zbr_ger_mil_door":
            self._id_8301[0] _meth_83FA( "light", "green", 0 );
            var_3 = getanimlength( %s2_zom_ger_mil_door_open );
            var_4 = 0.5;
            break;
        case "animated_zbr_zep_interior_bar_gate_01":
            self._id_8301[0] _meth_83FA( "light", "green", 0 );
            var_3 = getanimlength( %s2_zom_zep_bar_gate_open );
            var_4 = 0.5;
            break;
        case "animated_zmf_basalt_door":
            var_3 = getanimlength( %s2_zmf_basalt_door_open );
            var_4 = 0.9;
            break;
        case "animated_zmf_basalt_door_single_first":
        case "animated_zmf_basalt_door_single":
            var_3 = getanimlength( %s2_zmf_basalt_door_blockers_open );
            var_4 = 0.9;
            break;
        default:
    }
...
_id_7F60()
{
    ...
    for (;;)
    {
        ...
        wait( var_0 );
        earthquakes( 0.2, 0.5, self._id_9CFE.origin, 500 );
        wait 0.1;
        var_10 = 1.0;
