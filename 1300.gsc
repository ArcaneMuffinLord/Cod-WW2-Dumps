...
_id_8620( var_0 )
{
    ...
    level._id_0B80 = getent( var_1[0].target, "targetname" );
...
_id_275A( var_0 )
{
    ...
    if ( self.team == "any" )
    {
        ...
        objective_icon( var_1, var_2 );
        objective_team( var_1, "none" );
        self._id_698E = var_1;
    }
    else
    {
        if ( level.teambased || isdefined( self._id_0117 ) )
        {
            ...
            if ( !level.teambased && isdefined( self._id_0117 ) )
                objective_playerteam( var_1, self._id_0117 getentitynumber() );
            else
                objective_team( var_1, self.team );
        ...
        if ( isdefined( self._id_0117 ) )
        {
            ...
            objective_position( var_1, self.origin );
            objective_state( var_1, "active" );
            objective_icon( var_1, "compass_objpoint_ammo_enemy" );

            if ( !level.teambased && isdefined( self._id_0117 ) )
                objective_playerenemyteam( var_1, self._id_0117 getentitynumber() );
            else
                objective_team( var_1, level._id_6C63[self.team] );
...
_id_A6F8( var_0 )
{
    ...
    while ( isdefined( var_0 ) && maps\mp\_utility::isreallyalive( var_0 ) && !var_0 _meth_8346() && var_2 == var_0.origin && var_0 usebuttonpressed() )
    {
        var_4 = gettime() - var_3;
