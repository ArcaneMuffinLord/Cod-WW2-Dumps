...
monitorpuckcolor( var_0 )
{
    ...
    for (;;)
    {
        ...
        {
            var_6 = int( floor( var_5 / 100 ) );

            if ( var_6 == self getentitynumber() )
            {
                var_7 = var_5 % 100;
                var_8 = tablelookupbyrow( var_1, var_7 - 1, var_2 );
...
_id_1CA8( var_0 )
{
    ...
    if ( isdefined( var_1 ) && self._id_1E99._id_A4A8 != "first_person" )
    {
        ...
        {
            playfxontagforclients( common_scripts\utility::_id_44F5( "broadcaster_followed_player" ), var_1, "tag_origin", self );
    ...
    foreach ( var_2 in level.broadcasters )
    {
        if ( isdefined( var_2._id_1E99 ) && isdefined( var_2._id_1E99._id_77AC ) && var_2._id_1E99._id_77AC )
        {
            ...
            if ( var_0.team == "allies" && common_scripts\utility::_id_3F6F( var_4 ) )
                playfxontagforclients( common_scripts\utility::_id_44F5( var_4 ), var_0, "tag_origin", var_2 );
            else if ( var_0.team == "axis" && common_scripts\utility::_id_3F6F( var_5 ) )
                playfxontagforclients( common_scripts\utility::_id_44F5( var_5 ), var_0, "tag_origin", var_2 );
...
_id_1C9D()
{
    ...
    for (;;)
    {
        ...
        var_3 = int( floor( var_2 / 10000 ) );
        var_4 = int( floor( var_2 % 10000 / 100 ) );
...
_id_1C9C()
{
    ...
    for (;;)
    {
        ...
        var_1 = getomnvar( "ui_broadcaster_client_num" );
...
_id_A0E9( var_0, var_1 )
{
    ...
    if ( isdefined( var_0 ) && var_0 != var_2 )
    {
        ...
        var_3 = tablelookuprownum( var_5, var_6, var_7 );
    }
    else
        var_3 = 0;
...
_id_A0E8( var_0 )
{
    ...
    if ( isdefined( var_2 ) )
    {
        ...
        if ( isdefined( var_6 ) && var_6 != var_5 )
        {
            ...
            var_7 = tablelookuprownum( var_4, 1, var_8 );
        }
        else
            var_7 = var_5;
...
_id_1C99( var_0 )
{
    ...
    self _meth_8270( self getxuid(), "first_person" );
...
_id_1C8D( var_0, var_1 )
{
    ...
    for (;;)
    {
        ...
        {
            var_11 = 1.25;
            var_12 = min( var_10 * var_11, 1.0 );
            var_12 = 0.5 * ( 1.0 - cos( var_12 * 180.0 ) );
            var_13 = var_9 - self.origin;
            var_14 = axistoangles( var_13, vectorcross( var_13, ( 0, 0, 1 ) ), ( 0, 0, 1 ) );
            self.angles = anglelerp( var_7, var_14, var_12 );
        ...
        var_10 = 0.5 * ( 1.0 - cos( var_10 * 180.0 ) );
        var_5 = anglestoforward( var_4.angles );
...
_id_1C8F( var_0, var_1, var_2, var_3 )
{
    ...
    for (;;)
    {
        ...
        var_10 = 3;
        var_11 = min( var_9 * var_10, 1.0 );
        var_11 = 0.5 * ( 1.0 - cos( var_11 * 180.0 ) );
        self.angles = anglelerp( var_7, var_3, var_11 );
        var_9 = 0.5 * ( 1.0 - cos( var_9 * 180.0 ) );
...
_id_1C8E( var_0, var_1, var_2, var_3 )
{
    ...
    for (;;)
    {
        ...
        var_7 = sin( var_7 * 90.0 );
        self.origin = vectorlerp( var_11, var_9, var_7 );
        waitframe();
    }
}
...
_id_1C9B()
{
    var_0 = getentarray();
    var_1 = 0;
    setomnvar( "lighting_state", var_1 );
