...
_id_27CA()
{
    var_0 = getent( "1v1_clip_spawn1", "targetname" );

    if ( isdefined( var_0 ) )
        var_0 delete();

    var_1 = getent( "1v1_clip_spawn2", "targetname" );

    if ( isdefined( var_1 ) )
        var_1 delete();

    var_2 = getent( "1v1_clip_spawn3", "targetname" );

    if ( isdefined( var_2 ) )
        var_2 delete();

    var_3 = getent( "1v1_clip_spawn4", "targetname" );

    if ( isdefined( var_3 ) )
        var_3 delete();

    var_4 = getent( "1v1_clip_cover6", "targetname" );

    if ( isdefined( var_4 ) )
        var_4 delete();

    var_5 = getent( "1v1_clip_cover5", "targetname" );

    if ( isdefined( var_5 ) )
        var_5 delete();

    var_6 = getent( "1v1_clip_cover3", "targetname" );

    if ( isdefined( var_6 ) )
        var_6 delete();

    var_7 = getent( "1v1_clip_cover11", "targetname" );

    if ( isdefined( var_7 ) )
        var_7 delete();

    var_8 = getent( "1v1_clip_cover12", "targetname" );

    if ( isdefined( var_8 ) )
        var_8 delete();

    var_9 = getent( "1v1_clip_cover13", "targetname" );

    if ( isdefined( var_9 ) )
        var_9 delete();

    var_10 = getent( "1v1_clip_cover7", "targetname" );

    if ( isdefined( var_10 ) )
        var_10 delete();

    var_11 = getent( "1v1_clip_cover2", "targetname" );

    if ( isdefined( var_11 ) )
        var_11 delete();

    var_12 = getent( "1v1_clip_generic", "targetname" );
...
getcurrentgungameweapon( var_0, var_1 )
{
    ...
    var_1 = int( min( var_1, var_2.size ) );
    return var_2[var_1];
}
...
_id_4AA8( var_0, var_1, var_2, var_3 )
{
        ...
        case "win":
            if ( isdefined( var_3 ) && var_3 )
            {
                if ( isdefined( self.previousforfeitopponents ) )
                {
                    ...
                    {
                        if ( isdefined( var_7 ) && var_7 == self._id_0F58.xuid )
                        {
                            var_5 = 1;
                            break;
                        }
                ...
                self.previousforfeitopponents = common_scripts\utility::_id_0F6F( self.previousforfeitopponents, self._id_0F58.xuid );
            }
            ...
            if ( isdefined( var_2 ) && var_2 )
                _id_0468::_id_0A1C( "win", self._id_0F58.xuid, 1 );
            else
                _id_0468::_id_0A1C( "win", self._id_0F58.xuid );
    ...
    if ( var_0 == "win" )
    {
        ...
        setomnvar( "ui_one_v_one_champion_clientNum", var_1.curchampclientnum );
...
_id_92B7()
{
    ...
    self._id_252A[1] endon( "disconnect" );
    self._id_9A04 = 0;
    setomnvar( "ui_hub_1v1_timer", gettime() + 60000 );
...
_id_6FB8( var_0, var_1 )
{
    if ( var_0._id_2922._id_252A.size == 2 )
    {
        ...
        if ( var_0 == var_0._id_2922._id_252A[0] )
        {
            ...
            var_2 = sortbydistance( var_0._id_2922._id_0F59, var_0._id_2922._id_252A[1].origin, 3000 );
        }
        else if ( var_0 == var_0._id_2922._id_252A[1] )
        {
            ...
            var_2 = sortbydistance( var_0._id_2922._id_0F59, var_0._id_2922._id_252A[0].origin, 3000 );
        }
...
{
    level endon( "game_ended" );
    level._id_6B2B = getent( "trigger_onevone", "targetname" );
