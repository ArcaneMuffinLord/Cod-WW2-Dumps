...
init()
{
    ...
    level._id_8C74 = float( getdvarint( "skill_recent_sosc", 1000 ) ) / 1000.0;
    level._id_8C76 = getdvarint( "skill_sos_max_weight", 5 );
    level._id_8C77 = float( getdvarint( "skill_sos_tanh_scale", 1000 ) ) / 1000.0;
    level._id_8C75 = float( getdvarint( "skill_sos_default_rating", 500 ) ) / 1000.0;
...
_id_0684( var_0 )
{
    return 0.398942 * exp( var_0 * var_0 * 0.5 * -1.0 );
}
...
_id_0683( var_0 )
{
    ...
    var_3 = var_2 * exp( var_1 * var_1 * -1 - 1.26551 + var_2 * ( 1.00002 + var_2 * ( 0.374092 + var_2 * ( 0.0967842 + var_2 * ( -0.186288 + var_2 * ( 0.278868 + var_2 * ( -1.1352 + var_2 * ( 1.48852 + var_2 * ( -0.822152 + var_2 * 0.170873 ) ) ) ) ) ) ) ) );
...
_id_0738()
{
    ...
    if ( var_10 == 0.0 )
        var_10 = min( 1.0, max( 0.8596 + abs( var_3._id_1704 ) * -0.18397, 0.05 ) );
    ...
    foreach ( var_22, var_15 in level._id_8F29 )
    {
        ...
        if ( var_15._id_1705 )
            ...
            var_17 = var_17 + min( max( abs( var_15._id_1704 ) * -0.18397 + 0.8596, 0.05 ), 1.0 );
    ...
    var_27 = var_26;
    var_28 = min( var_3._id_1709, level._id_8C76 );
