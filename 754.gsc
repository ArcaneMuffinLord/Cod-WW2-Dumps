...
_id_7A39( var_0, var_1, var_2, var_3 )
{
    ...
    for ( var_5 = 0; var_5 < var_3; var_5++ )
        var_4 = var_4 + randomfloatrange( var_0, var_1 );
    ...
    if ( abs( var_7 - var_6 ) < var_8 * 0.2 )
    {
        var_6 = _id_02EF::_id_8086( var_6, var_0, var_1, var_1 - randomfloatrange( 0, var_8 * 0.35 ), var_0 + randomfloatrange( 0, var_8 * 0.35 ) );
