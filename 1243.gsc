...
_id_52B9()
{
    ...
    level._id_3C40 = getent( "trigger_firing_range", "targetname" );
    ...
    level._id_3C3E = getent( "firing_range_icon", "targetname" );
...
_id_9A80( var_0 )
{
    ...
    if ( var_0 )
    {
        ...
        playfxontagforclients( var_3, self, "j_head", self );
...
_id_8A48()
{
    ...
    foreach ( var_3 in level._id_7AB2 )
    {
        ...
        var_3._id_3D77 = [];
        var_8 = sortbydistance( level._id_7AB3, var_3.origin );
    ...
    var_8 = sortbydistance( level._id_7AB3, var_0.origin );
    ...
    var_8 = sortbydistance( level._id_7AB6, var_0.origin );
    ...
    var_8 = sortbydistance( level._id_7AB5, var_0.origin );
...
_id_36E9( var_0 )
{
    ...
    for ( var_1 = 0; var_1 < 5; var_1++ )
    {
        ...
        var_2 _meth_8272( var_2.origin, ( 0, randomfloat( 17500 ) + 10000, 0 ) );
        level._id_6894++;
    }
...
_id_4AD6( var_0 )
{
    ...
    var_1 = common_scripts\utility::_id_9AAD( common_scripts\utility::_id_7F03( distance2d( self.origin, self._id_8F10.origin ) / 10, 0 ) );
    ...
    for (;;)
    {
        switch ( var_0 )
        {
            case "up":
                ...
                {
                    var_1 = common_scripts\utility::_id_9AAD( common_scripts\utility::_id_7F03( distance2d( self.origin, self._id_8F10.origin + ( 50, 0, 0 ) ) / 10, 0 ) );
...
_id_47A9( var_0, var_1 )
{
    ...
    for (;;)
    {
        ...
        if ( getdvarint( "weapon_plant_fire_using_reserve_ammo" ) == 1 && var_2 == "weapon_change" )
        {
            foreach ( var_5 in var_3 )
            {
                if ( _id_04CB::_id_574C( var_5 ) )
                {
                    ...
                    if ( var_6 == 0 && var_7 == 0 )
                        self setweaponammostock( var_5, weaponstartammo( var_5 ) );
                }
            }
        ...
        {
            if ( var_5 != "none" )
                self setweaponammostock( var_5, weaponstartammo( var_5 ) - self getweaponammoclip( var_5 ) );
        }
    }
}
    ...
    if ( isdefined( var_0 ) )
    {
        ...
        if ( isdefined( level._id_2D6D ) && ( !isdefined( var_1 ) || !var_1 ) )
        {
            if ( var_0 == "win" )
            {
                ...
                _id_0468::_id_0A26( "win", self._id_8B24.xuid );
            }
            else if ( var_0 == "loss" )
            {
                self [[ level._id_2D6D ]]( 1 );
                _id_0468::_id_0A26( "lose", self._id_8B24.xuid );
            }
