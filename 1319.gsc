...
_id_7031( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    while ( var_11 <= var_10 )
    {
        ...
        var_9 = !var_9;
        var_19 = magicbullet( _id_443C( var_0, var_2 ), var_18, var_17, 3.0, var_18[2], var_2 );
...
_id_909F( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9 )
{
    ...
    if ( var_18 )
    {
        var_19 = 1;
        var_20 = 0;
        var_14._id_620D = spawnplane( "script_model", var_3 );
...
_id_2818()
{
    self._id_11C7 = 1000;
    self._id_11C5 = 1000;
    self._id_11C9 = missile_createattractorent( self, self._id_11C7, self._id_11C5 );
}

_id_2DD3()
{
    if ( isdefined( self._id_11C9 ) )
        missile_deleteattractor( self._id_11C9 );
}
...
_id_7041()
{
    self endon( "airstrike_complete" );
    waitframe();
    playfxontag( common_scripts\utility::_id_44F5( "airstrike_engine" ), self, "tag_engine_right" );
    playfxontag( common_scripts\utility::_id_44F5( "airstrike_engine" ), self, "tag_engine_left" );
    playfxontag( common_scripts\utility::_id_44F5( "airstrike_wingtip" ), self, "tag_right_wingtip" );
    playfxontag( common_scripts\utility::_id_44F5( "airstrike_wingtip" ), self, "tag_left_wingtip" );
}
