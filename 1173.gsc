...
updatelowermessage()
{
    ...
    else
    {
        ...
        if ( var_0._id_8B91 )
        {
            self.lowermessage fadeovertime( min( var_0._id_39CF, 60 ) );
...
printonteam_( var_0, var_1, var_2 )
{
...
rankingenabled()
{
    ...
    return level.rankedmatch && !self._id_A25B || _func_367() && !isprivatematch() && !issplitscreen() && !_func_2A4();
}

privatematch()
{
    return !level.onlinegame || isprivatematch();
}
...
_id_4723( var_0 )
{
    return getpossibleweaponattachments( var_0 );
}
...
_id_4538( var_0 )
{
    return tablelookupistring( "mp/killstreakTable.csv", 1, var_0, 10 );
}
...
_id_8653( var_0 )
{
    ...
    level._id_6030 = getmatchrulesdata( "commonOption", "allowCustomClasses" );
    level._id_297A = getmatchrulesdata( "commonOption", "classPickCount" );
    ...
    level._id_212F = getmatchrulesdata( "commonOption", "chatterDisabled" );
    level._id_0F05 = getmatchrulesdata( "commonOption", "announcerDisabled" );
    level._id_6034 = getmatchrulesdata( "commonOption", "switchTeamDisabled" );
    level._id_4867 = getmatchrulesdata( "commonOption", "grenadeGracePeriod" );
...
{
    var_2 = [];
    var_2["loadoutDivision"] = getmatchrulesdata( "defaultClasses", var_0, "defaultClass", var_1, "class", "division" );
    var_2["loadoutPrimaryWeaponStruct"] = _id_473C( getmatchrulesdata( "defaultClasses", var_0, "defaultClass", var_1, "class", "weaponSetups", 0, "weapon" ), 0 );

    for ( var_3 = 0; var_3 < 6; var_3++ )
        var_2["loadoutPrimaryAttachmentsGUID"][var_3] = getmatchrulesdata( "defaultClasses", var_0, "defaultClass", var_1, "class", "weaponSetups", 0, "attachment", var_3 );

    var_2["loadoutPrimaryCamoGUID"] = getmatchrulesdata( "defaultClasses", var_0, "defaultClass", var_1, "class", "weaponSetups", 0, "camo" );
    var_2["loadoutPrimaryCamo2GUID"] = getmatchrulesdata( "defaultClasses", var_0, "defaultClass", var_1, "class", "weaponSetups", 0, "camo2" );
    var_2["loadoutPrimaryReticleGUID"] = getmatchrulesdata( "defaultClasses", var_0, "defaultClass", var_1, "class", "weaponSetups", 0, "reticle" );
    var_2["loadoutPrimaryPaintjobId"] = getmatchrulesdata( "defaultClasses", var_0, "defaultClass", var_1, "class", "weaponSetups", 0, "paintjob" );
    var_2["loadoutPrimaryCharmGUID"] = getmatchrulesdata( "defaultClasses", var_0, "defaultClass", var_1, "class", "weaponSetups", 0, "charm" );
    var_2["loadoutSecondaryWeaponStruct"] = _id_473C( getmatchrulesdata( "defaultClasses", var_0, "defaultClass", var_1, "class", "weaponSetups", 1, "weapon" ), 0 );

    for ( var_3 = 0; var_3 < 6; var_3++ )
        var_2["loadoutSecondaryAttachmentsGUID"][var_3] = getmatchrulesdata( "defaultClasses", var_0, "defaultClass", var_1, "class", "weaponSetups", 1, "attachment", var_3 );

    var_2["loadoutSecondaryCamoGUID"] = getmatchrulesdata( "defaultClasses", var_0, "defaultClass", var_1, "class", "weaponSetups", 1, "camo" );
    var_2["loadoutSecondaryCamo2GUID"] = getmatchrulesdata( "defaultClasses", var_0, "defaultClass", var_1, "class", "weaponSetups", 1, "camo2" );
    var_2["loadoutSecondaryReticleGUID"] = getmatchrulesdata( "defaultClasses", var_0, "defaultClass", var_1, "class", "weaponSetups", 1, "reticle" );
    var_2["loadoutSecondaryPaintjobId"] = getmatchrulesdata( "defaultClasses", var_0, "defaultClass", var_1, "class", "weaponSetups", 1, "paintjob" );
    var_2["loadoutSecondaryCharmGUID"] = getmatchrulesdata( "defaultClasses", var_0, "defaultClass", var_1, "class", "weaponSetups", 1, "charm" );
    var_2["loadoutEquipmentStruct"] = _id_44CE( getmatchrulesdata( "defaultClasses", var_0, "defaultClass", var_1, "class", "equipmentSetups", 0, "equipment" ), 0 );
    var_2["loadoutEquipmentNumExtra"] = getmatchrulesdata( "defaultClasses", var_0, "defaultClass", var_1, "class", "equipmentSetups", 0, "numExtra" );
    var_2["loadoutOffhandStruct"] = _id_44CE( getmatchrulesdata( "defaultClasses", var_0, "defaultClass", var_1, "class", "equipmentSetups", 1, "equipment" ), 0 );
    var_2["loadoutOffhandNumExtra"] = getmatchrulesdata( "defaultClasses", var_0, "defaultClass", var_1, "class", "equipmentSetups", 1, "numExtra" );

    for ( var_3 = 0; var_3 < 9; var_3++ )
        var_2["loadoutPerksGUID"][var_3] = getmatchrulesdata( "defaultClasses", var_0, "defaultClass", var_1, "class", "perkSlots", var_3 );

    for ( var_3 = 0; var_3 < 4; var_3++ )
        var_2["loadoutKillstreaksGUID"][var_3] = getmatchrulesdata( "defaultClasses", var_0, "defaultClass", var_1, "class", "assaultStreaks", var_3, "streak" );

    var_2["loadoutJuggernaut"] = getmatchrulesdata( "defaultClasses", var_0, "defaultClass", var_1, "juggernaut" );
    return var_2;
}
...
_id_5A7F( var_0 )
{
    ...
    foreach ( var_3 in var_1 )
    {
        if ( isdefined( var_3._id_00E8 ) && var_3._id_00E8 )
            var_3 thread maps\mp\gametypes\_damage::_id_2EEF( randomintrange( 1, 3 ) );
    }
}
...
_id_566A( var_0 )
{
    if ( isagent( var_0 ) && var_0._id_0A4A == 1 )
        return 1;
...
_id_5666( var_0 )
{
    if ( isagent( var_0 ) && var_0._id_0A42 == 1 )
        return 1;
...
{
    if ( isdefined( var_0 ) && isdefined( var_1 ) && isagent( var_0 ) && isdefined( var_0._id_0A4B ) && var_0._id_0A4B == "leprechauns" )
        return 0;
    else if ( isdefined( var_0 ) && isdefined( var_1 ) && isagent( var_0 ) && isdefined( var_0._id_0A4B ) && var_0._id_0A4B == "mp_zombie_generic" )
        return 0;
    else if ( isdefined( var_0 ) && isdefined( var_1 ) && isagent( var_1 ) && isdefined( var_1._id_0A4B ) && var_1._id_0A4B == "paratroopers" && isdefined( var_1._id_0117 ) && var_1._id_0117 == var_0 )
        return 1;
...
_id_073C( var_0 )
{
    if ( isagent( var_0 ) && ( !isdefined( var_0._id_565F ) || !var_0._id_565F ) )
        return undefined;
...
_id_71F5( var_0, var_1 )
{
    ...
    if ( var_1 == 0 )
        self scriptmodelplayanim( self._id_8109 );
    else
...
_id_863F( var_0, var_1, var_2, var_3 )
{
    ...
    var_0 _id_04D1::set3dicon( "broadcaster", var_1, var_2, var_3 );
}
...
{
    if ( isdefined( var_3 ) && var_3 )
        var_4 = getvehiclenode( var_0, "script_noteworthy" );
    else
...
_id_A1CE()
{
    ...
    for (;;)
    {
        ...
        if ( isdefined( var_1 ) && _func_211( var_1.origin, self.origin ) > pow( getdvarfloat( "2098" ), 2 ) )
            var_1 = undefined;
...
_id_863E( var_0, var_1, var_2, var_3 )
{
    ...
    setomnvar( "ui_broadcaster_announcement", var_0 );
}
