...
_id_3216( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    ...
    {
        var_15 = distance2d( var_14.origin, var_1 );
    ...
    if ( var_17 )
    {
        var_18 = spawnplane( "script_model", var_1 );
        var_19 = spawnplane( "script_model", var_1 );
    ...
    for ( var_10 = 0; var_10 < var_21; var_10++ )
    {
        ...
        var_31 = magicbullet( var_29, var_28, var_27, var_30, _id_4578(), var_2, getdiveheightformap() );
...
_id_46E0( var_0 )
{
    switch ( var_0 )
    {
        case "missile_strike":
            return 1.0;
        case "mortar_strike":
            return randomfloatrange( 0.2, 1.0 );
        case "v2_rocket":
            return 0.0;
    }
}
        ...
        switch ( var_0 )
        {
            case "missile_strike":
                if ( var_1 && isdefined( level._id_79C2._id_80B0 ) && isdefined( level._id_79C2._id_80B0._id_624A ) )
                    return int( round( 18 * level._id_79C2._id_80B0._id_624A ) );
                else
                    return 18;
            case "mortar_strike":
                return 1;
