...
_id_3662()
{
    ...
    if ( _id_0547::_id_4BA7( "specialty_class_improvised_def_zm" ) )
    {
        ...
        _id_0547::_id_7454( int( min( var_6, 3 ) ) );
    }
...
handlezombietauntfx( var_0, var_1, var_2, var_3 )
{
    ...
    for (;;)
    {
        ...
        playfxontag( common_scripts\utility::_id_44F5( var_1 ), var_0, var_2 );
...
_id_6B73( var_0 )
{
    if ( isdefined( var_0 ) && isai( var_0 ) && common_scripts\utility::_id_562E( self._id_983B ) && _id_0547::_id_4BA7( "specialty_class_hit_em_hard_zm" ) )
    {
