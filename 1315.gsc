...
{
    if ( level._id_53C6 )
        var_0 = getnodesinradiussorted( self.origin, 1000, 0, 2000, "Path" );
    else
        var_0 = getnodesinradiussorted( self.origin, 700, 0, 128, "Path" );
    ...
    for ( var_8 = []; var_7 >= 0 && var_6 < var_5; var_7-- )
    {
        ...
        {
            if ( distance2d( self._id_6E68[var_7].origin, var_8[var_10].origin ) < 200 )
                var_9 = 0;
        }
...
_id_1132( var_0, var_1 )
{
    ...
    if ( isagent( self ) || isplayer( self ) && ( !isdefined( self.playerparachutedamageenabled ) && 0 || isdefined( self.playerparachutedamageenabled ) && self.playerparachutedamageenabled ) )
    {
...
_id_64B8( var_0 )
{
    ...
    for (;;)
    {
        ...
        if ( isalive( var_5 ) && isdefined( var_5 ) && isplayer( var_5 ) && ( !isdefined( var_5.playerparachutemovementenabled ) && 1 || isdefined( var_5.playerparachutemovementenabled ) && var_5.playerparachutemovementenabled ) )
        {
            ...
            if ( abs( var_9[0] ) > 0.5 || abs( var_9[1] ) > 0.5 )
            {
                var_10 = ( var_9[0], -1 * var_9[1], 0 );
                var_10 = var_10 * 6.6675;
                var_1 = rotatevector( var_10, var_5.angles );
...
_id_2605( var_0 )
{
    ...
    self endon( "paratrooper_released" );
    self endon( "disconnect" );
    var_1 = playerphysicstrace( self.origin, ( self.origin[0], self.origin[1], self.origin[2] - 2700 ) );
    ...
    for (;;)
    {
        ...
        {
            var_2 = getgroundposition( self.origin, 8, 100, 0.0, 1 );
...
_id_8FE1( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    ...
    var_11 = var_7 + ( 0, 0, 25 );
    var_12 = var_7;
    var_13 = playerphysicstrace( var_11, var_12 );
    ...
    if ( isdefined( self._id_0A43 ) )
    {
        if ( self._id_0A43 == "follow_code_and_dev_dvar" )
            self [[ level.bot_funcs["bot_set_difficulty"] ]]( self _meth_836D(), 1 );
        else
            self [[ level.bot_funcs["bot_set_difficulty"] ]]( var_5 );
    }
    else
        self [[ level.bot_funcs["bot_set_difficulty"] ]]( self _meth_836D() );
...
{
    if ( isdefined( self._id_6E4B ) && !isplayer( var_1 ) && !isagent( var_1 ) && var_3 == "MOD_FALLING" )
        var_1 = self._id_6E4B;
...
verify_player_paratrooper_position( var_0 )
{
    ...
    {
        if ( distance2d( level.paratrooper_pos[var_1], var_0 ) < 80 )
        {
...
_id_988F( var_0, var_1, var_2, var_3 )
{
    ...
    var_9 = combineangles( var_3, var_8 );
    var_10 = combineangles( var_0.angles, var_9 );
    var_11 = undefined;

    if ( isdefined( var_1 ) )
    {
        var_12 = var_0 gettagorigin( var_1 ) - var_5;
        var_11 = rotatevector( var_12, var_7 );
    }
    else
        var_11 = ( 0, 0, 0 );

    var_13 = rotatevector( var_11, var_10 );
...
_id_0DDE( var_0 )
{
    var_1 = ( angleclamp180( var_0[0] ), angleclamp180( var_0[1] ), angleclamp180( var_0[2] ) );
    return var_1;
}
