...
_id_1E6E( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8 )
{
    ...
    if ( level._id_32CF < level._id_6082 )
    {
        ...
        if ( isvalidmatchdataenumvalue( "MeansOfDeath", var_3 ) )
            setmatchdata( "downs", self._id_32CE, "means_of_death", var_3 );

        if ( isdefined( var_1._id_0A4B ) && isvalidmatchdataenumvalue( "ZombieType", var_1._id_0A4B ) )
...
_id_0F50( var_0 )
{
    ...
    foreach ( var_3 in var_1 )
    {
        ...
        if ( isalliedsentient( var_3, var_0 ) && common_scripts\utility::_id_562E( var_3.shouldnotpreventlaststand ) )
            continue;
