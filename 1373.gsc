...
_id_1769()
{
    ...
    for (;;)
    {
        ...
        if ( var_7 )
            wait( randomfloatrange( 10.0, 30.0 ) );
...
_id_8FAA( var_0 )
{
    ...
    wait 0.1;
    physicsexplosionsphere( self._id_AA2A, 48, 16, 1, 0 );
    glassradiusdamage( self._id_AA2A, 48, 100, 50 );
    earthquakes( 0.5, 1.5, self._id_78CB.origin, self._id_78CB.radius * 2 );
    playrumbleonposition( "zombie_birds_rumble", self._id_78CB.origin );
}
...
_id_1763( var_0, var_1 )
{
    ...
    if ( isdefined( var_1 ) )
    {
        ...
        var_8 = var_8 + randomfloatrange( 0 - var_4, var_4 );

        if ( isendstr( var_0._id_8260, "_v1" ) || isendstr( var_0._id_8260, "_v3" ) )
        {
            var_9 = 0 - var_3;
            var_10 = 0;
        }
        ...
        var_11 = transformmove( self.origin, self.angles + ( 0, var_8, 0 ), self.origin, self.angles, var_0.origin, var_0.angles );
...
{
    self endon( "birds_command" );
    wait( randomfloatrange( 15.0, 45.0 ) );
    self notify( "birds_command", "never_mind" );
}
