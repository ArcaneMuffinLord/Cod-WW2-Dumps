...
_id_85BE()
{
    ...
    foreach ( var_3 in var_0 )
    {
        if ( issubstr( var_3.model, "flak38" ) )
        {
            ...
            var_4 = sortbydistance( var_1, var_3.origin );
            var_3._id_15C9 = [];
    ...
    level._id_3CDF = 0;
    level._id_7043 = [];
    level._id_702F = getent( "plane_care_package_start", "targetname" );
    level._id_702E = getent( "plane_care_package_end", "targetname" );
...
_id_63BD()
{
    ...
    for (;;)
    {
        ...
        var_0 = randomintrange( var_0 - var_1, var_0 + var_1 );
        wait( var_0 );
...
_id_4ADF()
{
    ...
    setomnvar( "ui_fge_planes_remaining", level._id_7043.size );
    thread _id_4D4C();
    wait 10;
...
eventtimekeeper()
{
    ...
    {
        setomnvar( "ui_fge_timeRemaining", var_0 );
        wait 1;
    }
}
...
_id_4AB3( var_0 )
{
    ...
    setomnvar( "ui_fge_carepackages_remaining", level._id_1FFD.size - 1 );
...
{
    level endon( "game_ended" );
    var_1 = spawn( "script_model", self.origin + ( randomintrange( -3, 3 ), randomfloatrange( -3, 3 ), -20 ) );
    var_1.angles = ( 0, 0, 0 );
    var_1._id_28D5 = 0;
    var_1._id_A22B = 0;
    var_1.team = "any";
    ...
    playfxontag( common_scripts\utility::_id_44F5( "care_package_allies_beacon" ), var_1, "TAG_FX" );
    ...
    var_2._id_3A1C = randomintrange( 5, 15 );
...
{
    var_0 = 600;
    var_1 = getvehiclenodearray( "plane_start_node", "targetname" );
    var_2 = randomint( var_1.size );

    for ( var_3 = 0; var_3 < 12; var_2 = var_6 )
    {
        var_4 = var_1[var_2];
        var_5 = getvehiclenodearray( var_4.script_exploder, "script_linkname" );
    ...
    for (;;)
    {
        ...
        foreach ( var_2 in level._id_7043 )
        {
            if ( var_2.firing && !var_0 )
            {
                ...
                stopfxontag( var_3, var_2, "tag_muzzle_fx_1" );
                stopfxontag( var_3, var_2, "tag_muzzle_fx_2" );
                var_2.firing = 0;
            }
            ...
            if ( !var_2.firing && var_0 )
            {
                var_3 = common_scripts\utility::_id_44F5( "hub_plane_tracer" );
                waitframe();
                playfxontag( var_3, var_2, "tag_muzzle_fx_1" );
                waitframe();
                playfxontag( var_3, var_2, "tag_muzzle_fx_2" );
                var_2.firing = 1;
            }
        }
...
_id_3BD4()
{
    ...
    for (;;)
    {
        ...
        if ( isdefined( self._id_9823 ) && !isdefined( self._id_9823._id_5AFA ) )
        {
            ...
            playfxontag( level._effect["care_package_hit"], self._id_9823, "tag_origin" );

            if ( self._id_9823._id_2748 <= 11 )
                playfxontag( level._effect["fire_small"], self._id_9823, "tag_origin" );
...
_id_5F15()
{
    ...
    stopfxontag( var_0, self, "tag_muzzle_fx_1" );
    stopfxontag( var_0, self, "tag_muzzle_fx_2" );
