...
init()
{
    ...
    {
        var_3 = tablelookupbyrow( "mp/zombieKlausActionTable.csv", var_2, 1 );
        var_4 = strtok( tablelookupbyrow( "mp/zombieKlausActionTable.csv", var_2, 2 ), " " );
...
_id_1CCD( var_0 )
{
    ...
    foreach ( var_3 in var_1 )
    {
        ...
        var_3 _meth_805B();
        playfxontag( level._effect["gk_raven_hc_ee_uber_attached"], var_3, "tag_origin" );
...
_id_5725( var_0 )
{
    ...
    var_10 = pointonsegmentnearesttopoint( var_4, var_5, var_6 );
