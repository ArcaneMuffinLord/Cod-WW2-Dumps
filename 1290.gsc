...
_id_485C()
{
    ...
    else
    {
        ...
        earthquakes( 0.4, 0.75, var_2, 256 );
    }
...
_id_0FD9()
{
    ...
    earthquakes( 0.7, 0.5, self.origin, 800 );
...
{
    playrumbleonposition( "grenade_rumble", var_0 );
    earthquakes( 0.6, 0.6, var_0, 2000 );
...
_id_0B94( var_0 )
{
    ...
    earthquakes( 0.7, 0.75, var_0, 1000 );
