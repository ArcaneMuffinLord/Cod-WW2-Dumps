...
_id_8BE4()
{
    ...
    foreach ( var_3 in var_0 )
    {
        ...
        playfxontagforclients( common_scripts\utility::_id_44F5( "tutorial_path" ), var_4, "tag_origin", self );
    }
...
_id_7FAD( var_0 )
{
    ...
    wait 2.55;
    var_1 _meth_82B1( var_1.origin + rotatevector( ( 1000, 0, 0 ), var_1.angles ), 5.7 );
    wait 5.7;
    var_1 delete();
}
