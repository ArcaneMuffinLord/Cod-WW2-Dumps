...
_id_7B96( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9 )
{
    ...
    var_22 = getent( var_16["raven_uber_trap_deposit"]._id_3E3C.target, "targetname" );
    var_23 = getent( var_16["raven_uber_trap_deposit"]._id_3E3C.target, "targetname" );
    var_24 = getent( var_5, "targetname" );
    var_25 = getent( var_23.target, "targetname" );
    var_25 _meth_805C();
    ...
    var_16["attack_positions"] = getent( var_25.target, "targetname" );
    var_31 = spawnstruct();
    ...
    var_32 = getent( "rnd_forge_machine_parts", "targetname" );
...
_id_902C( var_0, var_1 )
{
    ...
    playfxontag( level._effect[var_1 + "_uber"], var_2, "tag_origin" );
    return var_2;
}
...
_id_7A8A( var_0 )
{
    if ( !0 )
    {
        ...
        while ( !var_1 )
        {
            ...
            var_4 = getent( var_0["fuse_pickup"].target, "targetname" );
    ...
    var_5 = getent( var_0["fuse_pickup"].target, "targetname" );
...
_id_7A87( var_0 )
{
    ...
    var_0["cover_model"] thread _id_1806();
    var_1 = getent( var_0["fuse_pickup"].target, "targetname" );
...
_id_7A89( var_0 )
{
    level endon( "raven up skip" );
    var_1 = 0;
    var_2 = getent( "raven_blood_challenge_lights_start", "targetname" );
    var_3 = spawn( "script_model", var_2.origin );
    var_3 setmodel( "tag_origin" );
    var_2 _meth_82C3( 1 );
    var_2 maps\mp\mp_zombie_nest_ee_util::_id_A725( "teslagun_zm" );
    playfxontag( common_scripts\utility::_id_44F5( "temp_hc_challenge_indicator_lights" ), var_3, "tag_origin" );
    ...
    stopfxontag( common_scripts\utility::_id_44F5( "temp_hc_challenge_indicator_lights" ), var_3, "tag_origin" );
    var_6 = getent( var_0["fuse_pickup"].target, "targetname" );
    var_2.origin = var_6.origin;
    var_7 = getent( var_0["fuse_pickup"].target, "targetname" );
...
_id_A6C1( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    while ( var_12 < var_10 )
    {
        ...
        if ( common_scripts\utility::_id_562E( var_11 ) )
        {
            ...
            triggerfx( self._id_9FE5._id_65E3 );
