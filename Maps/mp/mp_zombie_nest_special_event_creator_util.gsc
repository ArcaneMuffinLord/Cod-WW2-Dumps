...
_id_410B( var_0 )
{
    ...
    {
        if ( var_1[var_2]._id_68A2 <= 4 && abs( var_1[var_2].origin[2] - self.origin[2] ) < 256 )
            return var_1[var_2];
    }
...
_id_8A06( var_0, var_1 )
{
    ...
    var_0 _meth_805B();
    setomnvar( var_0._id_3012, var_0 getentitynumber() );
    setomnvar( var_0._id_3013, 1.0 );
}
...
_id_11B4( var_0 )
{
    foreach ( var_2 in var_0 )
    {
        ...
        setomnvar( var_2._id_3013, var_3 );
    }
}
