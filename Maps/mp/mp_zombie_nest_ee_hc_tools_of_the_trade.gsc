...
_id_52EC()
{
    ...
    var_2 = getent( "nest_ee_hc_com_door_trig", "targetname" );
    level._id_6874 = 0;
...
_id_80D6()
{
    ...
    for ( var_1 = 0; var_1 < var_0.size; var_1++ )
    {
        ...
        self._id_3B9C[var_1]._id_65DB linkto( self._id_801E, "dial_0" + ( var_1 + 1 ) );
    }
...
_id_7E67()
{
    ...
    var_1 = getent( "nest_hc_sword_door_trig", "targetname" );
