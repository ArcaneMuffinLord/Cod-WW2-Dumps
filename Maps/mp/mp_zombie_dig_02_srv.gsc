...
{
    _id_0547::_id_A78B();
    var_0 = getent( "blood_fount_NE", "targetname" );
    var_0.is_activated = 0;
    var_1 = getent( "blood_fount_SE", "targetname" );
    var_1.is_activated = 0;
    var_2 = getent( "blood_fount_SW", "targetname" );
    var_2.is_activated = 0;
    var_3 = getent( "blood_fount_NW", "targetname" );
...
srv_basalt_init()
{
    ...
    var_6 = getent( "srv_pap_fuse_spawn_loc", "targetname" );
