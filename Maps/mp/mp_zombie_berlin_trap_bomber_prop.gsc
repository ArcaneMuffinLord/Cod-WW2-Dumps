...
{
    var_1 = getent( "zmb_trap_bomber_engine_mdl", "script_noteworthy" );
    var_2 = getent( "propeller_center_fx_trap", "script_noteworthy" );
    var_1 _id_0378::_id_8D74( "start_trap_prop", 0.5 );
    var_3 = getent( "propeller_damage", "script_noteworthy" );
...
toss_ragdoll( var_0, var_1 )
{
    ...
    var_6 = spawnfx( level._effect["zmb_ber_blood_impact_prop"], var_2, var_3 );
    triggerfx( var_6 );
    wait 0.2;
    var_6 delete();
}
