...
_id_7E3C( var_0, var_1 )
{
    ...
    var_2 = getent( "nest_hc_record_drawer", "targetname" );
...
_id_171D( var_0 )
{
    ...
    var_23 = getent( "firewell_grab_test", "targetname" );
    var_24 = getent( var_23.target, "targetname" );
...
_id_7A50( var_0 )
{
    ...
    for ( var_3 = 0; var_3 < var_2.size; var_3++ )
    {
        ...
        for ( var_5 = pow( 10, var_2.size - var_3 ); var_0 >= var_5 / 10; var_4++ )
...
_id_7EEC( var_0 )
{
    ...
    var_1 = 0;
    var_2 = getglass( "window_shatter_toyshop" );
...
_id_52EE()
{
    ...
    var_2 = getent( "nest_ee_hc_arm_trig", "targetname" );
    ...
    var_4["reward_pickup"] = getent( "nest_hc_record_spawn", "targetname" );
    return var_4;
}
