...
_id_5300()
{
    ...
    setdynamicdvar( "scr_prop_roundlimit", var_0 );
    ...
    setdynamicdvar( "scr_prop_winlimit", var_1 );
...
propwhistle()
{
    ...
    for (;;)
    {
        if ( var_0 + var_1 - var_4 < gettime() )
        {
            ...
            {
                if ( var_3 * 2 + getteamplayersalive( game["defenders"] ) * 2500 >= maps\mp\gametypes\_gamelogic::_id_46E5() - var_5 )
                {
                    if ( useprophudserver() )
...
gametyperoundendscoresetomnvar( var_0, var_1, var_2, var_3, var_4 )
{
    if ( common_scripts\utility::_id_562E( var_3 ) && isdefined( level.proptiebreaker ) )
    {
        ...
        else if ( level.proptiebreaker == "time" )
        {
            ...
            var_7 = int( round( var_5 ) );
            var_8 = int( round( var_6 ) );
