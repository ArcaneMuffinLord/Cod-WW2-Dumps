...
configure_formation_spawn()
{
    ...
    for ( var_7 = 0; var_7 < 5; var_7++ )
    {
        if ( level.dogfightformationspawnrandomyaw > 0 )
            var_6 = level.dogfightformationspawnbaseyaw + randomfloatrange( -1 * level.dogfightformationspawnrandomyaw, level.dogfightformationspawnrandomyaw );
    ...
    for ( var_7 = 1; var_7 < 9; var_7++ )
    {
        ...
        level.formation_nodes_offset[var_7] = rotatevector( var_10, var_9 );
    }
}
...
spawn_client_fighter_fx( var_0 )
{
    ...
    if ( isplayer( var_1 ) && !isbot( var_1 ) )
        playfxontagforclients( level._effect["mp_raid_bomber_throttle_fighter"], var_0, "TAG_BODY", var_1 );
}
...
common_damage_state_fx_update_watcher( var_0, var_1 )
{
    ...
    for (;;)
    {
            ...
            if ( !var_0._id_552B )
            {
                ...
                if ( isdefined( var_0.vfx_in ) )
                {
                    foreach ( var_7 in var_0.vfx_tag )
                        playfxontag( var_0.vfx_in, var_2, var_7 );
        ...
        else if ( var_0._id_552B )
        {
            ...
            {
                foreach ( var_7 in var_0.vfx_tag )
                    playfxontag( var_0.vfx_out, var_2, var_7 );
            }
...
fighter_get_crash_animation( var_0, var_1 )
{
    ...
    {
        var_11 = getmovedelta( fighter_get_crash_anim_ref( var_10 ), 0, 1 );
        var_12 = rotatevector( var_11, var_0.angles );
        var_13 = var_1 + var_12;
        ...
        {
            var_11 = getmovedelta( fighter_get_crash_anim_ref( var_10 ), 0, var_22 * var_20 );
            var_12 = rotatevector( var_11, var_0.angles );
            var_23 = var_1 + var_12;
...
dogfightshowboundaryoverlay()
{
    ...
    {
        self._id_1B68 = newclienthudelem( self );
        self._id_1B68.x = 0;
        self._id_1B68.y = 0;
...
createvehicleinternal( var_0, var_1, var_2 )
{
    ...
    if ( common_scripts\utility::_id_562E( var_0.use_original_classname ) )
        ...
        var_4 = spawnvehicle( var_0.model, var_3, var_0._id_01C8, var_0.origin, var_0.angles, var_2 );
    else
        var_4 = spawnvehicle( var_0.model, var_3, var_0._id_01C8, var_0.origin, var_0.angles );
...
_id_4A31( var_0, var_1 )
{
    ...
    var_2 = 0;
    var_3 = randomintrange( 20, 40 );
    var_4 = var_3 + randomintrange( 10, 20 );
    var_5 = [];
    var_6 = 0;
    var_7 = 8;
    var_8 = 3;
    ...
    while ( isdefined( self ) )
    {
        ...
        if ( var_19 )
            var_20 = randomfloatrange( 0.0025, 0.005 ) * common_scripts\utility::_id_98E7( common_scripts\utility::_id_24A6(), 1.0, -1.0 );
...
{
    var_2 = vectornormalize( ( randomfloatrange( -1.0, 1.0 ), randomfloatrange( -1.0, 1.0 ), 0 ) );
    var_3 = var_0 + var_1 * var_2;
    var_4 = get_spawn_height( 0 ) * 0.5;
    var_3 = var_3 + ( 0, 0, randomfloatrange( var_4 * -1, var_4 ) );
    return var_3;
}
...
get_formation_spawn_origin_angles( var_0 )
{
    ...
    if ( level.dogfightformationspawnstruct._id_00BD > 0 )
    {
        ...
        var_3 = ( 0, 0, randomfloatrange( -1 * var_4, var_4 ) );
    }
...
is_spawn_targeted( var_0 )
{
    foreach ( var_2 in level.players )
    {
        ...
        if ( bullettracepassed( var_0, var_2.origin, 0, self ) )
            return 1;
    }
...
get_random_spawn_origin_angles()
{
    ...
    var_4 = randomfloatrange( get_spawn_radius( 1 ), get_spawn_radius( 0 ) );
    ...
    for ( var_5 = 0; var_5 < 5; var_5++ )
    {
        ...
        var_2 = ( angleclamp180( var_2[0] ), angleclamp180( var_2[1] ), angleclamp180( var_2[2] ) );
...
spawner_fog_enable()
{
    var_0 = getent( level.dogfightalliesspawner, "targetname" );
    var_0 _meth_8400();

    if ( level.teambased )
    {
        var_1 = getent( level.dogfightaxisspawner, "targetname" );
        var_1 _meth_8400();
    }
}
...
get_plane_vertical_soft_boundary_percent()
{
    ...
    {
        var_1 = get_dogfight_boundary_center( 1 );
        var_2 = abs( self.origin[2] - var_1[2] );
...
watch_boundary( var_0 )
{
    ...
    if ( !common_scripts\utility::within_fov( var_0.origin, var_0.angles, var_5, cos( 30 ) ) && !isdefined( level.hostmigrationtimer ) )
    {
    ...
    for (;;)
    {
        ...
        if ( var_0 is_plane_outside_soft_boundary() )
        {
            ...
            if ( common_scripts\utility::_id_562E( var_7 ) && var_3 <= gettime() )
            {
                ...
                var_11 = atan2( var_10[1], var_10[0] );
                var_8 = undefined;
                ...
                if ( isdefined( var_4 ) )
                    stopfxontag( get_flak_fx_for_direction( var_4 ), var_0, "tag_origin" );

                playfxontag( get_flak_fx_for_direction( var_8 ), var_0, "tag_origin" );
                var_4 = var_8;
                var_3 = gettime() + randomintrange( 600, 800 );
            }
...
fighter_death( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    ...
    if ( isdefined( var_13 ) )
    {
        ...
        if ( var_16 )
        {
            ...
            var_18 = getanimlength( var_17 ) + var_15;
...
bot_planeshootthink( var_0 )
{
    ...
    for (;;)
    {
        ...
        var_13 = var_0.angles;
        var_14 = angleclamp180( var_12[1] - var_13[1] );
        var_15 = angleclamp180( var_12[0] - var_13[0] );

        if ( abs( var_14 ) < 30 && abs( var_15 ) < 30 )
...
bot_planeflythink( var_0 )
{
    ...
    for (;;)
    {
        ...
        if ( isagent( var_1 ) && isdefined( var_4 ) )
            var_9 = 0;
