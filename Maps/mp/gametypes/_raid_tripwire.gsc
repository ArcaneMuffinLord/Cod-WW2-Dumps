    ...
    for (;;)
    {
        ...
        if ( !self _meth_83DD() && !self _meth_83B8() )
        {
            if ( is_normal_a_wall( var_13, var_14, 20 ) )
            {
                ...
                var_0.angles = combineangles( vectortoangles( var_13 ), ( 0, 0, 0 ) );
                var_0.origin = var_14;
                var_15 = rotatevector( var_4, var_0.angles );
                ...
                else if ( var_0.angles[0] != 0.0 )
                {
                    ...
                    var_17 = rotatevector( var_4, var_16 );
                    var_18 = var_2 - var_17;
                    var_1.origin = var_18;
                }
                else
                ...
                if ( !var_21 )
                {
                    ...
                    var_20 = sqrt( squared( var_20[0] ) + squared( var_20[1] ) );
                }
...
is_normal_a_wall( var_0, var_1, var_2 )
{
    ...
    var_3 = 0;
    var_4 = asin( vectornormalize( var_0 )[2] );
...
tripwire_place_anywhere_handler( var_0 )
{
    ...
    var_2 _meth_805B();
    wait 0.03;
    playfxontag( level._effect["trip_wire_dust_on_bomb_plant"], var_1, "TAG_ORIGIN" );
...
tripwire_place_anywhere_placed_handler( var_0, var_1, var_2 )
{
    ...
    var_10 = axistoangles( var_8, var_9, var_7 );
    var_6.angles = var_10;
...
tripwire_trigger_wire( var_0, var_1 )
{
    ...
    while ( !isdefined( var_2 ) && !isdefined( var_2.team ) || isdefined( var_2 ) && !isstring( var_2 ) && isdefined( var_2.team ) && var_2.team == var_3 || isstring( var_2 ) && var_2 != "explode" )
