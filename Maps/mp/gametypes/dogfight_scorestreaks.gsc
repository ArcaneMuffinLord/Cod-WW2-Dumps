        ...
        if ( level._id_3CE1 < 30 )
        {
            ...
            if ( isdefined( var_2 ) )
            {
                if ( getdvarint( "dogfightFlakDamageWeightEnabled", 1 ) )
                {
                    ...
                    var_10 = ( randomfloatrange( -500, 500 ) + var_2.origin[0], randomfloatrange( -500, 500 ) + var_2.origin[1], randomfloatrange( -500, 500 ) + var_2.origin[2] );
            }
            else
            {
                ...
                if ( getdvarint( "dogfightFlakDamageWeightEnabled", 1 ) )
                {
                    ...
                    var_14 = var_13 - var_0;
                    var_10 = ( randomfloatrange( -18000, 18000 ) + var_11[0], randomfloatrange( -18000, 18000 ) + var_11[1], var_0 + randomfloat( 1.0 ) * var_14 );
                }
                else
                    var_10 = ( randomfloatrange( -18000, 18000 ) + var_11[0], randomfloatrange( -18000, 18000 ) + var_11[1], randomfloatrange( -8000, 8000 ) + var_11[2] );
            }

            level._id_3CE1++;
            thread dogfight_flakexplosioneffects( var_10, 1 );
            var_15 = dogfight_flakgettimescale( var_3.size );
            wait( randomfloatrange( 0.1 * var_15, 0.3 * var_15 ) );
            continue;
        }
...
dogfight_flakexplosioneffects( var_0, var_1 )
{
    ...
    var_2 _meth_805B();
    waitframe();
    playfxontag( common_scripts\utility::_id_44F5( "flak_gun_explosion" ), var_2, "tag_origin" );
...
dogfight_flakgetnearfighterexplosionlocation( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    ...
    var_9 = ( 0, randomfloatrange( -1 * var_6, var_6 ), 0 );
    var_8 = rotatevector( var_8, var_9 );
    var_10 = randomfloatrange( var_2, var_3 );
    ...
    for (;;)
    {
        ...
        if ( isdefined( var_3 ) )
        {
            ...
            if ( getdvarint( "dogfightFlakDamageWeightEnabled", 1 ) )
            {
                ...
                var_10 = ( randomfloatrange( -100, 100 ) + var_3.origin[0], randomfloatrange( -100, 100 ) + var_3.origin[1], randomfloatrange( -100, 100 ) + var_3.origin[2] );

            thread dogfight_flakexplosioneffects( var_10, 0 );
            var_11 = 0;

            if ( isagent( var_3.occupied_player ) )
                var_11 = randomfloatrange( 450, 500 ) * 10;
            else
                var_11 = randomfloatrange( 75, 110 ) * 10;
            ...
            if ( 1 )
            {
                ...
                earthquakes( 0.7, 0.5, var_3.origin, 800, var_3.occupied_player );
            }
        }

        var_13 = dogfight_flakgettimescale( var_2.size );
        wait( randomfloatrange( 0.5 * var_13, 1.5 * var_13 ) );
    }
}
...
destroy_remaining_agents()
{
    ...
    {
        if ( isagent( var_2.occupied_player ) )
            var_2 _meth_8059( randomfloatrange( 450, 500 ) * 10, var_2.origin, self, undefined, "MOD_UNKNOWN", "killstreak_flak_gun_raids" );
    }
}
