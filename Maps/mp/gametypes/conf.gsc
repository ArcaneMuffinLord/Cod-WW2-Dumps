...
_id_903E( var_0, var_1 )
{
    ...
    else
    {
        ...
        objective_add( level._id_31F9[var_0.guid]._id_6989, "invisible", ( 0, 0, 0 ) );
        level._id_31F9[var_0.guid]._id_6988 = _id_04D1::_id_45A9();
        objective_add( level._id_31F9[var_0.guid]._id_6988, "invisible", ( 0, 0, 0 ) );
    ...
    objective_icon( level._id_31F9[var_0.guid]._id_6989, "waypoint_dogtags" );
    objective_position( level._id_31F9[var_0.guid]._id_6989, var_5 );
    objective_state( level._id_31F9[var_0.guid]._id_6989, "active" );
    objective_playerenemyteam( level._id_31F9[var_0.guid]._id_6989, var_0 getentitynumber() );
    objective_icon( level._id_31F9[var_0.guid]._id_6988, "waypoint_dogtags_friendlys" );
    objective_position( level._id_31F9[var_0.guid]._id_6988, var_5 );
    objective_state( level._id_31F9[var_0.guid]._id_6988, "active" );
    objective_playerteam( level._id_31F9[var_0.guid]._id_6988, var_0 getentitynumber() );
    ...
    for (;;)
    {
        ...
        foreach ( var_3 in level.players )
        {
            ...
            if ( var_0._id_A496 == var_3.team && var_3 == var_0._id_1180 )
                objective_state( var_0._id_6989, "invisible" );
        }
    }
}
...
_id_7D6F()
{
    ...
    objective_state( self._id_6989, "invisible" );
    objective_state( self._id_6988, "invisible" );
}
