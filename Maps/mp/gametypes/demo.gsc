...
_id_5300()
{
    ...
    var_0 = getmatchrulesdata( "demoData", "roundSwitch" );
    setdynamicdvar( "scr_demo_roundswitch", var_0 );
...
_id_6BAF()
{
    ...
    setomnvar( "ui_war_attacker_team", maps\mp\_utility::_id_46D4( game["attackers"] ) );
...
_id_18FD()
{
    ...
    for ( var_1 = 0; var_1 < var_0.size; var_1++ )
    {
        ...
        if ( game["status"] == "overtime" )
        {
            ...
            var_11 _id_04D1::set3dicon( "friendly", "waypoint_target" + var_12 );
        }
        else
        {
            var_11 _id_04D1::set2dicon( "friendly", "waypoint_defend" + var_12 );
            var_11 _id_04D1::set3dicon( "friendly", "waypoint_defend" + var_12 );
        }

        var_11 _id_04D1::set2dicon( "enemy", "waypoint_target" + var_12 );
        var_11 _id_04D1::set3dicon( "enemy", "waypoint_target" + var_12 );
        ...
        var_11._id_18D5 = getent( var_3[0].target, "targetname" );
...
_id_18F9( var_0, var_1 )
{
    ...
    if ( maps\mp\_utility::gethalftime() && game["status"] != "halftime" )
        setgameendtime( gettime() + ( int( maps\mp\gametypes\_gamelogic::_id_46E5() ) - int( maps\mp\_utility::gettimelimit() * 60 * 1000 * 0.5 ) ), 1 );
    else
    ...
    var_10 _id_04D1::set3dicon( "friendly", "waypoint_defuse" + var_3 );
    var_10 _id_04D1::set3dicon( "enemy", "waypoint_defend" + var_3 );
    var_10.label = var_3;
    ...
    var_15 = randomfloat( 360 );
    var_16 = var_13 + ( 0, 0, 50 );
    var_17 = spawnfx( level._effect[var_14], var_16 + ( 0, 0, 50 ), ( 0, 0, 1 ), ( cos( var_15 ), sin( var_15 ), 0 ) );
    triggerfx( var_17 );
    physicsexplosionsphere( var_16, 200, 100, 3 );
    playrumbleonposition( "grenade_rumble", var_13 );
    earthquakes( 0.75, 2.0, var_13, 2000 );
