...
_id_7B85()
{
    ...
    for (;;)
    {
        if ( maps\mp\_utility::isreallyalive( self ) && self.team != "spectator" && ( isdefined( self.primaryweapon ) && weapontype( self.primaryweapon ) != "melee" && self getammocount( self.primaryweapon ) == 0 || isdefined( self.lethalweapon ) && self getammocount( self.lethalweapon ) == 0 ) )
        {
            wait 2;
            self notify( "reload" );
            wait 1;
...
setgunsfinal()
{
    ...
    {
        var_3 = tablelookupbyrow( "mp/attachmentcombos_mtx12.csv", 0, var_2 );
        var_0[var_3] = var_2;
    }
...
buildrandomweapontable()
{
    ...
    {
        var_2 = tablelookupbyrow( "mp/gunGameTable.csv", var_1, 0 );
        ...
        var_3["weaponName"] = tablelookupbyrow( "mp/gunGameTable.csv", var_1, 1 );
        var_3["minAttachments"] = int( tablelookupbyrow( "mp/gunGameTable.csv", var_1, 5 ) );
        var_3["maxAttachments"] = int( tablelookupbyrow( "mp/gunGameTable.csv", var_1, 6 ) );
        var_3["forcedAttachments"] = tablelookupbyrow( "mp/gunGameTable.csv", var_1, 2 );
        var_3["forcedAttachments"] = strtok( var_3["forcedAttachments"], "+" );
        var_3["banOptic"] = 1 == int( tablelookupbyrow( "mp/gunGameTable.csv", var_1, 4 ) );
        var_3["forceAltMode"] = 1 == int( tablelookupbyrow( "mp/gunGameTable.csv", var_1, 3 ) );
        var_3["division"] = int( tablelookupbyrow( "mp/gunGameTable.csv", var_1, 7 ) );
        var_3["allowedVariants"] = tablelookupbyrow( "mp/gunGameTable.csv", var_1, 8 );
        var_3["allowedVariants"] = strtok( var_3["allowedVariants"], "+" );
        var_3["forcedLethal"] = tablelookupbyrow( "mp/gunGameTable.csv", var_1, 9 );
...
getrandomweaponfromcategory( var_0, var_1 )
{
    ...
    if ( isdefined( var_2 ) && var_2.size > 0 )
    {
        ...
        if ( level.gun_weaponattachments )
        {
            ...
            var_10 = randomintrange( var_3["minAttachments"], var_3["maxAttachments"] + 1 );
...
getattachmentsforweapon( var_0, var_1, var_2, var_3 )
{
    ...
    var_5 = getpossibleweaponattachments( var_4 );
