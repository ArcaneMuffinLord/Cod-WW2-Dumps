...
_id_6B62( var_0 )
{
    ...
    _id_04D1::set3dicon( "friendly", "waypoint_escort", undefined, 1 );
...
_id_18FD()
{
    ...
    if ( !level._id_6510 )
    {
        ...
        level._id_832F _id_04D1::set3dicon( "friendly", "waypoint_bomb", undefined, 1 );
    ...
    for ( var_3 = 0; var_3 < var_2.size; var_3++ )
    {
        ...
        var_4 _id_04D1::set3dicon( "friendly", "waypoint_defend" + var_5, undefined, 1 );
        var_4 _id_04D1::set2dicon( "enemy", "waypoint_target" + var_5 );
        var_4 _id_04D1::set3dicon( "enemy", "waypoint_target" + var_5, undefined, 1 );
        ...
        var_4._id_18D5 = getent( var_1[0].target, "targetname" );
...
_id_6ABC( var_0 )
{
    ...
    if ( _id_04D1::_id_56FB( var_0.pers["team"] ) )
    {
        ...
        if ( isdefined( level._id_8330 ) )
        {
            ...
            stopfxontag( common_scripts\utility::_id_44F5( "search_dstry_bomb_arming_light" ), level._id_8330, "tag_fx" );
        }
    }
    else
    {
...
_id_18F9( var_0, var_1 )
{
    ...
    playfxontag( common_scripts\utility::_id_44F5( "search_dstry_bomb_arming_light" ), level._id_8330, "tag_fx" );
    var_0 _id_04D1::_id_0C30( "none" );
    var_0 _id_04D1::_id_8A60( "none" );
    var_6 = var_0 _id_04D1::_id_454C();
    setomnvar( "ui_bomb" + var_6 + "_state", 1 );
    ...
    var_9 _id_04D1::set3dicon( "friendly", "waypoint_defuse" + var_6, undefined, 1 );
    var_9 _id_04D1::set3dicon( "enemy", "waypoint_defend" + var_6, undefined, 1 );
    var_9.label = var_6;
    ...
    level._id_18EE = 1;
    setomnvar( "ui_broadcaster_game_mode_status_1", 0 );
    setomnvar( "ui_bomb" + var_6 + "_state", 2 );
    ...
    else
    {
        ...
        var_15 = spawnfx( level._effect[var_13], var_11, ( 0, 0, 1 ), ( cos( var_14 ), sin( var_14 ), 0 ) );
        triggerfx( var_15 );
        physicsexplosionsphere( var_11, 200, 100, 3 );
        playrumbleonposition( "grenade_rumble", var_10 );
        earthquakes( 0.75, 2.0, var_10, 2000 );
...
_id_190B( var_0 )
{
    ...
    setomnvar( "ui_bomb" + var_0 + "_timer_endtime", var_1 );
...
_id_4ACC( var_0, var_1 )
{
    ...
    setomnvar( "ui_bomb" + var_0 + "_timer_endtime", 0 );
    var_2 = maps\mp\gametypes\_hostmigration::_id_A782();

    if ( var_2 > 0 )
        setomnvar( "ui_bomb" + var_0 + "_timer_endtime", var_1 + var_2 );
}
...
_id_6AEF( var_0 )
{
    ...
    _id_04D1::set3dicon( "friendly", "waypoint_bomb", undefined, 1 );
...
_id_6BC3( var_0 )
{
    ...
    if ( _id_5742( var_0 ) && isdefined( self ) && isdefined( self._id_6DB2 ) && getteamplayersalive( maps\mp\_utility::getotherteam( self._id_6DB2 ) ) > 0 )
