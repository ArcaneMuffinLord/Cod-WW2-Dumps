...
_id_5300()
{
    ...
    var_0 = max( 1, var_0 );
    setdynamicdvar( "scr_relic_num_balls", var_0 );
...
updateallplayersstatusomnvars()
{
    ...
    {
        if ( !isdefined( var_5 ) || isbot( var_5 ) || isagent( var_5 ) )
            continue;
...
_id_152A()
{
    foreach ( var_2, var_1 in level._id_152B )
    {
        ...
        var_1._id_A223 _id_04D1::set3dicon( "friendly", "waypoint_ball_defend" );
        var_1._id_A223 _id_04D1::set3dicon( "enemy", "waypoint_ball_goal" );
...
_id_1528()
{
    foreach ( var_2, var_1 in level._id_152B )
    {
        var_1._id_80A4["friendly"] = spawnfx( common_scripts\utility::_id_44F5( "ball_goal_activated_blue" ), var_1.origin, ( 1, 0, 0 ) );
        var_1._id_80A4["enemy"] = spawnfx( common_scripts\utility::_id_44F5( "ball_goal_activated_red" ), var_1.origin, ( 1, 0, 0 ) );

        if ( var_2 == "allies" )
        {
            var_1._id_80A4["broadcaster"] = spawnfx( common_scripts\utility::_id_44F5( "ball_goal_activated_orange" ), var_1.origin, ( 1, 0, 0 ) );
            continue;
        }

        var_1._id_80A4["broadcaster"] = spawnfx( common_scripts\utility::_id_44F5( "ball_goal_activated_yellow" ), var_1.origin, ( 1, 0, 0 ) );
    }
...
_id_155D()
{
    ...
    _id_04D1::set3dicon( "friendly", "waypoint_ball" );
    _id_04D1::set3dicon( "enemy", "waypoint_ball" );
...
_id_155C()
{
    ...
    _id_04D1::set3dicon( "friendly", "waypoint_ball_friendly" );
    _id_04D1::set3dicon( "enemy", "waypoint_ball_enemy" );
...
_id_1522()
{
    if ( !_id_1521() )
    {
        ...
        playfxontag( common_scripts\utility::_id_44F5( "ball_trail" ), var_0, "tag_weapon" );
        playfxontag( common_scripts\utility::_id_44F5( "ball_vm" ), var_0, "tag_weapon" );
        self._id_1521 = 1;
    }
}
...
_id_1523( var_0 )
{
    if ( _id_1521() )
    {
        ...
        playfxontagforclients( common_scripts\utility::_id_44F5( "ball_trail" ), var_1, "tag_weapon", var_0 );
        playfxontagforclients( common_scripts\utility::_id_44F5( "ball_vm" ), var_1, "tag_weapon", var_0 );
    }
}
...
_id_1524()
{
    ...
    {
        var_0 = self._id_A582[0];
        stopfxontag( common_scripts\utility::_id_44F5( "ball_trail" ), var_0, "tag_weapon" );
        stopfxontag( common_scripts\utility::_id_44F5( "ball_vm" ), var_0, "tag_weapon" );
    }
...
_id_153C( var_0, var_1, var_2 )
{
    ...
    var_5 = var_4 * 1000;
    self._id_776C = magicgrenademanual( "gamemode_ball", self._id_A582[0].origin, var_5, 30, var_0, 1, 1 );
...
_id_1545( var_0 )
{
    ...
    if ( var_1 >= var_2 )
    {
        setomnvar( "ui_broadcaster_game_mode_status_1", var_3 );
        setomnvar( "ui_broadcaster_game_mode_status_2", -1 );
        var_4 = getomnvar( "ui_broadcaster_game_mode_status_3" );
    ...
    setomnvar( "ui_broadcaster_game_mode_status_1", int( var_1 ) );
    setomnvar( "ui_broadcaster_game_mode_status_2", -1 );
...
_id_1559( var_0 )
{
    ...
    if ( isdefined( self._id_5B7E ) )
        setomnvar( "ui_broadcaster_game_mode_status_2", self._id_5B7E getentitynumber() );
    else
        setomnvar( "ui_broadcaster_game_mode_status_2", -1 );
...
_id_154A( var_0 )
{
    ...
    triggerfx( var_0._id_80A4["friendly"] );
    triggerfx( var_0._id_80A4["enemy"] );
    triggerfx( var_0._id_80A4["broadcaster"] );
}
...
_id_1535( var_0 )
{
    ...
    setgameendtime( gettime() + int( maps\mp\gametypes\_gamelogic::_id_46E5() ), 1 );
    ...
    if ( !isai( var_0 ) && !istestclient( var_0 ) )
    {
        ...
        playfxontagforclients( var_5, var_0, "j_head", var_0 );
        var_6 = self._id_A582[0];
        playfxontagforclients( common_scripts\utility::_id_44F5( "ball_vm" ), var_6, "tag_weapon", var_0 );
    }
    ...
    var_0._id_0112 = 1;
    setomnvar( "ui_broadcaster_game_mode_status_1", -1 );
    setomnvar( "ui_broadcaster_game_mode_status_2", self.carrier getentitynumber() );
...
_id_7389( var_0 )
{
    ...
    for (;;)
    {
        ...
        if ( !self _meth_801D() )
        {
            ...
            {
                if ( sighttracepassed( var_4, var_7._id_6EA8, 0, self, var_7 ) )
                {
                    var_2 = var_7;
                    break;
                }
...
_id_1509()
{
    ...
    foreach ( var_6 in var_4 )
    {
        ...
        {
            var_7 = distance2d( level.previoussoulcaptureorigin, var_6.origin );
...
{
    playfxontag( level._effect["ball_download"], var_0, "tag_weapon" );
    common_scripts\utility::waittill_notify_or_timeout( "pickup_object", var_1 );
    stopfxontag( level._effect["ball_download"], var_0, "tag_weapon" );
    self._id_80AA = 0;
}
...
_id_1520( var_0 )
{
    ...
    self._id_487A = playerphysicstrace( var_1, var_2 );
}
...
_id_1519( var_0 )
{
    ...
    {
        var_17 = 2;
        var_18 = getnodesinradius( var_16.origin, 2000, 700, 1200 );
        ...
        for ( var_20 = 0; var_19 < var_17 && var_20 < var_18.size; var_20++ )
        {
            ...
            {
                if ( distance2d( var_14[var_23], var_21 ) < 700 )
                    var_22 = 0;
            }

            if ( var_22 && distance2d( var_13, var_21 ) > 800 )
            {
                _id_1508( var_21 );
                var_19++;
                var_13 = var_21;
