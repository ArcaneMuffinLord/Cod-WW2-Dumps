...
_id_742A()
{
    ...
    for (;;)
    {
        if ( self _meth_8346() )
        {
            ...
            {
                var_0 = distance2d( self._id_5BA3, self.origin );
...
_id_A14A()
{
    ...
    if ( isdefined( self.characterclientindex ) )
        setomnvar( "ui_zm_points_" + self.characterclientindex, var_4 );
...
_id_6BA4( var_0 )
{
    ...
    if ( _id_0547::_id_5767( self ) )
    {
        ...
        if ( isplayer( self ) )
        {
            ...
            setomnvar( var_2, 1 );
            setomnvar( "ui_zm_points_" + self.characterclientindex, self._id_62D6 );
...
_id_A90F()
{
    ...
    for (;;)
    {
        ...
        var_0 = int( max( min( level._id_A980, 9999 ), 1 ) );
        setomnvar( "ui_zm_round_number", var_0 );
...
_id_63DA()
{
    ...
    while ( var_0 < var_2 )
    {
        ...
        if ( var_0 < var_2 )
        {
            ...
            iprintlnbold( var_3 + " vote to open Safe Haven" );
        }
    }
    ...
    {
        var_3 = _id_4240( var_0, var_1, var_2 );
        iprintlnbold( var_3 + " vote to close Safe Haven" );
        level waittill( "safe_haven_trigger_ratio", var_0, var_1 );
    }
...
_id_7FCB()
{
    ...
    for (;;)
    {
        ...
        var_4 = ceil( var_3 / 5 ) * 5;

        if ( var_4 > 0 )
            iprintlnbold( "Safe House Closes: " + var_4 );
...
_id_1E38( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10 )
{
    ...
    if ( _id_0547::_id_580B( var_5 ) )
        var_11 = "none";
    else if ( isagent( self ) && isdefined( self.is_fellow_human ) && self.is_fellow_human )
        var_11 = "none";
    else
    {
        ...
        if ( var_2 < self.health )
        {
            ...
            else if ( self._id_0A4B == "zombie_exploder" )
            {
                ...
                if ( common_scripts\utility::_id_562E( self.sgvip ) && common_scripts\utility::_id_562E( self._id_392C ) && _id_0547::_id_5565( var_10, tolower( "TAG_WEAPON" ) ) )
                    var_11 = "minor";
            }
...
_id_62AF( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9 )
{
    ...
    if ( isdefined( level._id_2C9F ) && common_scripts\utility::_id_562E( var_0._id_56C2 ) && isai( var_2 ) && !_func_2BF( var_2 ) )
    ...
    if ( isplayer( var_0 ) )
    {
        ...
        if ( issubstr( var_5, "bazooka_zm" ) || issubstr( var_5, "panzerschreck_zm" ) || issubstr( var_5, "fliegerfaust" ) || issubstr( var_5, "tesla_gun" ) || _id_0547::_id_585C( var_5 ) || isplayer( var_2 ) && var_2 == var_0 && isexplosivedamagemod( var_4 ) )
        {
        ...
        if ( isai( var_2 ) && var_2 _id_0547::_id_AC70() )
            return 0;
    ...
    if ( isai( var_0 ) && !isplayer( var_0 ) && ( !isdefined( var_2 ) || !isai( var_2 ) && !isplayer( var_2 ) ) )
    {
    ...
    {
        if ( !_func_2BF( var_2 ) && isalliedsentient( var_0, var_2 ) )
            return 0;
    ...
    if ( isdefined( var_2 ) && isplayer( var_2 ) && isai( var_0 ) && !isplayer( var_0 ) )
    {
        ...
        if ( common_scripts\utility::_id_562E( var_0.zmdemigod ) )
            var_10 = min( var_10, var_0.health - 1 );
    ...
    if ( isplayer( var_0 ) )
    {
        ...
        if ( isdefined( var_2 ) && isai( var_2 ) && _func_2BF( var_2 ) )
        {
            var_0._id_5C14 = gettime();
    ...
    else if ( isai( var_0 ) && _func_2BF( var_0 ) )
...
_id_62B0( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( _id_0547::_id_585C( var_1 ) || _id_0546::_id_56E6( var_1 ) )
    {
        if ( issubstr( var_1, "throwingknife" ) )
            ...
            var_2 = common_scripts\utility::_id_98E7( level._id_A980 > 0, level._id_A980, 1 ) * var_10 * randomintrange( 100, 200 );
...
_id_A1A0()
{
    ...
    level._id_6F4A = _id_4600();
    level._id_2958 = 0;
    level._id_609C = min( 500, level._id_A980 * 50 );
    _id_1E54();
...
_id_7FC6( var_0 )
{
    ...
    while ( var_0 > 0 )
    {
        ...
        setomnvar( "ui_zm_round_countdown", var_0 );
        var_0--;
        wait 1;
...
_id_7FC8( var_0 )
{
    ...
    setomnvar( "ui_zm_round_start", level._id_7F23 * 1000 );

    if ( isdefined( level.zmb_round_over_override ) )
        [[ level.zmb_round_over_override ]]( var_0 );
    else
        setomnvar( "ui_zm_round_number", int( min( var_0, 9999 ) ) );

    setomnvar( "ui_zm_round_type", _id_0547::_id_466A( level._id_7F2A ) );
...
_id_281C( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( isdefined( var_6 ) )
    {
        ...
        playfxontag( var_9.fx, var_9._id_A582[0], var_9._id_3F81 );
        playfxontag( level._effect["pickup_base"], var_9._id_A582[0], var_9._id_3F81 );
    }
    else
    {
        var_13 = ( 0, 0, 2000 );
...
_id_6FD5()
{
    ...
    for (;;)
    {
        if ( isdefined( self.fx ) )
            killfxontag( self.fx, self._id_A582[0], self._id_3F81 );
        ...
        if ( isdefined( self.fx ) )
            playfxontag( self.fx, self._id_A582[0], self._id_3F81 );
        else if ( isdefined( self._id_A582 ) && isdefined( self._id_A582[0] ) )
...
_id_7CED( var_0 )
{
    ...
    {
        stopfxontag( var_0.fx, var_0._id_A582[0], var_0._id_3F81 );
        stopfxontag( level._effect["pickup_base"], var_0._id_A582[0], var_0._id_3F81 );
    }
...
_id_685F( var_0, var_1 )
{
    ...
    earthquakes( 0.35, 0.95, var_0.origin, 128 );
...
_id_08B2( var_0, var_1 )
{
    ...
    var_5 = sortbydistance( var_5, var_0 );
...
_id_6865( var_0 )
{
    ...
    if ( !maps\mp\agents\humanoid\_humanoid_util::_id_56BC() )
    {
        ...
        var_3 = angleclamp180( var_2 - self.angles[1] );

        if ( abs( var_3 ) < 45 )
            var_1 = "pain_knockback_front";
        else if ( abs( var_3 ) > 135 )
...
_id_329C( var_0, var_1 )
{
    ...
    setomnvar( var_0, gettime() + var_2 * 1000 );
    wait( var_2 );
    var_3 = _id_054A::_id_0633();

    if ( isdefined( var_3 ) && var_3 > 0 )
    {
        setomnvar( var_0, gettime() + var_3 * 1000 );
        wait( var_3 );
    }
}
...
_id_746B()
{
    ...
    foreach ( var_3 in level.players )
    {
        var_3.hacky_vote_ui = newclienthudelem( var_3 );
...
_id_73CD( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10 )
{
    if ( _id_0547::_id_AC4C() )
    {
        ...
        if ( isdefined( var_1 ) )
        {
            ...
            var_12 = var_1.origin;
            var_13 = acos( clamp( vectordot( anglestoforward( var_2.angles ), vectornormalize( common_scripts\utility::_id_3D5D( var_1.origin - var_2.origin ) ) ), -1, 1 ) );
        }
...
_id_4AE1()
{
    ...
    for (;;)
    {
        foreach ( var_3 in level.players )
        {
            ...
            var_5 = var_4 && !sighttracepassed( var_3 geteye(), self geteye(), 0, undefined );
