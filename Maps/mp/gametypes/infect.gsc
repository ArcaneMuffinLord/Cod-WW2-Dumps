...
_id_5300()
{
    ...
    level._id_6032 = getmatchrulesdata( "infectData", "numInitialInfected" );
...
_id_A12F()
{
    ...
    if ( self.pers["team"] == "axis" )
    {
        ...
        if ( !isai( self ) && !istestclient( self ) )
        {
            ...
            playfxontagforclients( var_0, self, "j_head", self );
        }
...
getrandomnodenearsurvivor()
{
    ...
    {
        var_0 = getnodesinradius( var_2.origin, 800, 0, 1000, "Path" );
    ...
    var_0 = getnodesinradius( ( 0, 0, 0 ), 10000, 0, 10000, "Path" );
    var_7 = undefined;
...
_id_6BB6()
{
    ...
    foreach ( var_1 in level.players )
    {
        ...
        {
            if ( !isai( var_1 ) && !istestclient( var_1 ) )
            {
                var_2 = undefined;
...
_id_A175()
{
    ...
    setteamscore( "allies", level._id_5116["allies"] );
    level._id_5116["axis"] = _id_46D7( "axis" );
    game["teamScores"]["axis"] = level._id_5116["axis"];
    setteamscore( "axis", level._id_5116["axis"] );
}
