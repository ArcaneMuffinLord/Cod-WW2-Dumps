...
_id_86E1( var_0 )
{
    ...
    if ( !level._id_6B1F )
    {
        if ( weapontype( maps\mp\_utility::_id_4737( level._id_6B15["loadoutPrimaryWeaponStruct"] ) ) == "melee" )
...
_id_4413( var_0, var_1, var_2 )
{
    ...
    return int( min( var_3 + var_4 - var_2, var_1 ) );
}
...
_id_6B7B( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9 )
{
    ...
    if ( isdefined( level._id_6B1E ) && var_1 != level._id_6B1E )
        level._id_09B7 = min( level._id_606F, level._id_09B7 + level._id_3992 );
...
_id_6FBC( var_0, var_1 )
{
    ...
    if ( isdefined( level._id_6B29 ) && isdefined( level._id_6B2A ) )
    {
        ...
        else if ( level.players.size >= 2 && isdefined( level._id_6B27 ) && level._id_6B27.size > 1 && isdefined( level._id_6B28 ) && level._id_6B28.size > 1 )
        {
            ...
            if ( var_0 == level.players[0] )
            {
                var_5 = distance2d( level._id_6B29.origin, level.players[1].origin );
                var_6 = distance2d( level._id_6B2A.origin, level.players[1].origin );
            }
            else
            {
                var_5 = distance2d( level._id_6B29.origin, level.players[0].origin );
                var_6 = distance2d( level._id_6B2A.origin, level.players[0].origin );
            }
