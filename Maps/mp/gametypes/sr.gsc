...
_id_903E( var_0, var_1 )
{
    ...
    if ( var_0.team == "axis" )
    {
        objective_icon( level._id_31F9[var_0.guid]._id_698B, "waypoint_dogtags_friendlys" );
        objective_team( level._id_31F9[var_0.guid]._id_698B, "axis" );
        objective_icon( level._id_31F9[var_0.guid]._id_698A, "waypoint_dogtags" );
        objective_team( level._id_31F9[var_0.guid]._id_698A, "allies" );
    }
    else
    {
        objective_icon( level._id_31F9[var_0.guid]._id_698A, "waypoint_dogtags_friendlys" );
        objective_team( level._id_31F9[var_0.guid]._id_698A, "allies" );
        objective_icon( level._id_31F9[var_0.guid]._id_698B, "waypoint_dogtags" );
        objective_team( level._id_31F9[var_0.guid]._id_698B, "axis" );
    }

    objective_position( level._id_31F9[var_0.guid]._id_698A, var_2 );
    objective_position( level._id_31F9[var_0.guid]._id_698B, var_2 );
    objective_state( level._id_31F9[var_0.guid]._id_698A, "active" );
    objective_state( level._id_31F9[var_0.guid]._id_698B, "active" );
...
_id_7D6F()
{
    ...
    objective_state( self._id_698A, "invisible" );
    objective_state( self._id_698B, "invisible" );
}
