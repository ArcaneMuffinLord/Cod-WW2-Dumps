...
{
    var_0 = self;
    var_0._id_24A7 = getent( var_0.target, "targetname" );
...
_id_52E1()
{
    ...
    var_5 = getent( "pilot_light_trigger", "targetname" );
...
{
    level endon( "power_sz2" );
    var_0 = getent( "generator_sign_dialogue", "targetname" );
...
{
    level endon( "power_sz2" );
    var_0 = getent( "fuel_tank_dialogue", "targetname" );
...
_id_2E89()
{
    ...
    var_0 = getent( "trig_see_forge", "targetname" );
...
_id_2E95()
{
    ...
    var_0 = getent( "trig_see_med_office", "targetname" );
...
_id_2E93()
{
    ...
    var_0 = getent( "trig_enter_klaus_office", "targetname" );
...
_id_AC91()
{
    var_0 = 60 * randomfloatrange( 1, 2 );
    level._id_6F18 = 0;

    for (;;)
    {
        wait( var_0 );
        var_0 = 60 * randomfloatrange( 1, 10 );
...
_id_3540()
{
    foreach ( var_1 in level.players )
    {
        ...
        for ( var_5 = 0; var_5 < var_4; var_5++ )
        {
            ...
            var_10 = var_7 * var_9 * 3 + randomfloat( 0.2 );
        ...
        if ( isdefined( var_2 ) )
        {
            var_11 = vectornormalize( vectornormalize( var_1.origin - getglassorigin( var_2 ) ) + common_scripts\utility::_id_7A5F( 0.3 ) );
            destroyglass( var_2, var_11 );
        }
    }
}
...
{
    earthquakes( 0.3, var_0, var_1.origin, 850, var_1 );
...
_id_6E18()
{
    var_0 = getent( "move_cart_button_console", "targetname" );
    playfxontag( level._effect["zmb_com_room_fire_panel"], var_0, "tag_origin" );
    wait 18;
    stopfxontag( level._effect["zmb_com_room_fire_panel"], var_0, "tag_origin" );
}
...
_id_347A()
{
    var_0 = getent( "disable_clocktower_jumpscare", "targetname" );
...
_id_4D47()
{
    ...
    var_1 = getent( "first_door_lock", "targetname" );
