...
_id_4595( var_0 )
{
    if ( isdefined( self._id_0088 ) )
    {
        ...
        if ( abs( self.origin[2] - self._id_0088.origin[2] ) < self._id_A85C && _func_211( self._id_0088.origin, self.origin ) < self._id_11AD )
            return "pursuit";
...
_id_A7F7()
{
    ...
    if ( abs( self.origin[2] - self._id_0088.origin[2] ) <= self._id_A85C || self _meth_8393( self._id_0088 ) )
    {
...
_id_3B95()
{
    ...
    var_3 = getclosestnodeinsight( self._id_0117.origin );
