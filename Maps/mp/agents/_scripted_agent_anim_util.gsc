...
_id_5DE0( var_0, var_1, var_2 )
{
    var_3 = [];
    var_3["table"] = var_0;
    var_3["actions"] = strtok( tablelookupbyrow( var_1, var_2, 0 ), " " );
    var_3["state"] = tablelookupbyrow( var_1, var_2, 1 );
    var_3["flags"] = strtok( tablelookupbyrow( var_1, var_2, 2 ), " " );
    var_3["anims"] = strtok( tablelookupbyrow( var_1, var_2, 3 ), " " );
    var_3["dismember_states"] = strtok( tablelookupbyrow( var_1, var_2, 4 ), " " );
    var_3["zombie_subtypes"] = strtok( tablelookupbyrow( var_1, var_2, 5 ), " " );
    var_3["source_project"] = tablelookupbyrow( var_1, var_2, 6 );
    var_3["script_var"] = tablelookupbyrow( var_1, var_2, 7 );
    var_3["move_style"] = tablelookupbyrow( var_1, var_2, 8 );
    var_3["move_speed"] = tablelookupbyrow( var_1, var_2, 9 );
    return var_3;
}
...
_id_A79E( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( isdefined( var_2 ) && isdefined( var_3 ) )
        var_7 = getanimlength( self _meth_83D8( var_2, var_3 ) );
...
_id_5ED7( var_0, var_1, var_2 )
{
    for (;;)
    {
        ...
        var_4 = getanimlength( self _meth_83D8( var_0, var_3 ) ) * ( 1.0 / var_1 );
...
_id_4416( var_0, var_1 )
{
    ...
    if ( var_0 < 0 )
        return int( ceil( ( 180 + var_0 - var_4 ) / var_3 ) );
    else
        return int( floor( ( 180 + var_0 + var_4 ) / var_3 ) );
}
...
_id_441C( var_0, var_1, var_2 )
{
    ...
    if ( abs( var_6 ) > 0.001 && var_4 != 0 && var_6 * var_4 > 0 )
        var_8 = var_4 / var_6;
...
getnotetracktimeinsecs( var_0, var_1, var_2 )
{
    ...
    return var_3 * getanimlength( var_0 );
}
