...
_id_0C6D()
{
    ...
    for (;;)
    {
        ...
        if ( float( self._id_0117.health ) / self._id_0117.maxhealth < 0.5 && gettime() > var_1 )
        {
            var_2 = getnodesinradiussorted( self._id_0117.origin, 256, 0 );
...
_id_0A5E()
{
    ...
    foreach ( var_4 in var_0 )
    {
        ...
        if ( var_4 == var_1 )
            ...
            var_5 = weaponclipsize( var_4, self );
