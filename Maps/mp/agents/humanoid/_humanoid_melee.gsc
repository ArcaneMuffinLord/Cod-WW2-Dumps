...
_id_5753( var_0 )
{
    ...
    if ( isdefined( var_0.classname ) && var_0.classname == "misc_turret" && isdefined( var_0._id_0B40 ) )
        var_3 = physicstrace( var_1, var_2, var_0._id_0B40 );
    else
...
_id_3107( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7 )
{
    ...
    foreach ( var_13 in [ "hit", "attack", "zombie_melee" ] )
        var_11 = common_scripts\utility::_id_0F73( var_11, getnotetracktimes( var_9, var_13 ) );
    ...
    for ( var_16 = 0; var_16 < var_11.size; var_16++ )
    {
        ...
        if ( var_16 == 0 && var_6 )
        {
            var_20 = getnotetracktimes( var_9, "lunge_start" );
            ...
            if ( self._id_5F44 )
            {
                ...
                var_23 = getmovedelta( var_9, var_18, var_17 );
    ...
    for (;;)
    {
        ...
        if ( self _meth_85DF() )
        {
            ...
            if ( var_11 > 1 )
            {
                ...
                var_14 = acos( clamp( vectordot( var_13, var_12 ), -1, 1 ) );
