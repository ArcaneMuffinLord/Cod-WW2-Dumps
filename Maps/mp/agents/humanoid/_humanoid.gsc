...
_id_8A27()
{
    ...
    self._id_60E1 = 40;
    self._id_60F0 = 60;
    self._id_60F1 = squared( self._id_60F0 );
...
_id_6DFD( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    if ( !var_8 )
        ...
        self.angles = ( 0, vectortoyaw( var_0.origin - self.origin ), 0 );
...
_id_60EA( var_0, var_1, var_2 )
{
    ...
    for ( var_4 = 0; var_4 < var_2; var_4 = var_4 + 0.05 )
    {
        ...
        var_6 = combineangles( var_0.angles, ( 0, 180, 0 ) );
        var_7 = 1;
        var_8 = vectorlerp( self.origin, var_5, var_7 );
        var_9 = anglelerp( self.angles, var_6, var_7 );
