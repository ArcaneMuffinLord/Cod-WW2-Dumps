...
_id_45DC( var_0 )
{
    ...
    else if ( isplayer( var_0 ) && ( var_0 _meth_83B8() || var_0 _meth_83B9() ) )
    {
        ...
        {
            var_0._id_73F0 = getgroundposition( var_0.origin, 15 );
    ...
    if ( isdefined( var_0 ) )
    {
        ...
        for ( var_5 = undefined; !isdefined( var_4 ) && var_3 <= 1500; var_3 = var_3 + 500 )
        {
            ...
            if ( isdefined( level._id_663D ) )
                var_6 = getnodesinradiussorted( self._id_3043._id_4883, var_3, var_2, level._id_663D );
            else
                var_6 = getnodesinradiussorted( self._id_3043._id_4883, var_3, var_2 );
...
_id_5F4E( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    ...
    self._id_5F49 = var_6;
    self._id_5F4F = var_2;
    self._id_5F50 = squared( self._id_5F4F );
...
_id_5C5B( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    ...
    self._id_5C4E = var_2;
    self._id_5C57 = var_3;
    self._id_5C58 = squared( self._id_5C57 );
    self._id_5C59 = var_4;
    self._id_5C5A = squared( self._id_5C59 );
    self._id_5C54 = var_6;
    self._id_5C4D = var_5;
    self._id_5C55 = 0;
    self._id_5C56 = 0;
...
_id_8318( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10 )
{
    ...
    if ( isdefined( var_12 ) && var_12 > 0 )
    {
        ...
        if ( !isdefined( var_3 ) )
            ...
            var_14 = float( var_10["timeOffset"] );
...
_id_70C9( var_0 )
{
    ...
    if ( self._id_1919 != "no_boost_fx" )
        playfxontag( var_0, self, self._id_1919 );
}
...
_id_AA52( var_0 )
{
    ...
    if ( !var_1 && ( isplayer( var_0 ) || isagent( var_0 ) ) )
    {
