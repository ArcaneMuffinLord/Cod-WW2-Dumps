...
_id_86D0( var_0, var_1, var_2 )
{
    ...
    var_5 = angleclamp180( var_0 - self.angles[1] );
...
_id_220E( var_0, var_1, var_2 )
{
    ...
    var_9 = getangledelta( var_8 );
    var_10 = ( 0, angleclamp180( var_4[1] - var_9 ), 0 );
...
_id_A69C()
{
    ...
    while ( isalive( self ) )
    {
        ...
        if ( randomfloat( 1.0 ) < self._id_313A )
        {
...
_id_A6A9()
{
    ...
    for (;;)
    {
        ...
        if ( issentient( self._id_28D2 ) && !self _meth_8393( self._id_28D2 ) || !maps\mp\_utility::_id_3B8E( self, self._id_28D2, 25 ) )
            continue;
...
_id_92E9()
{
    ...
    var_8 = angleclamp180( var_3[1] - self.angles[1] );
    ...
    var_12 = getmovedelta( var_11 );
    var_13 = rotatevector( var_12, self.angles ) + self.origin;
    ...
    if ( abs( var_10 - int( var_9 * 0.5 ) ) <= 1 )
        self _meth_839B( "face angle abs", ( 0, angleclamp180( var_3[1] - var_14[1] ), 0 ) );
    else
        self _meth_839B( "face angle abs", self.angles );

    self._id_92EA = gettime() * 0.001 + getanimlength( var_11 );
