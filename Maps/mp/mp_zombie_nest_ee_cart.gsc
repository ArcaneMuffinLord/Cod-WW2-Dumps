...
_id_7863()
{
    if ( 1 )
    {
        var_0 = getent( "ww_part_01_model", "targetname" );
...
_id_7864()
{
    if ( 1 )
    {
        var_0 = getent( "ww_part_02_model", "targetname" );
        var_1 = _id_0557::_id_782F( undefined, var_0 );
        _id_0557::_id_781D( "4 cart", var_1 );
    }
...
_id_52DE()
{
    ...
    thread _id_2EAD();
    level._id_3571 = getent( "ee_shard", "targetname" );
    ...
    var_5 = spawnstruct();
    var_5._id_1DD3 = getent( "move_cart_button_model", "targetname" );
    var_5._id_2590 = getent( "move_cart_button_console", "targetname" );
    var_5._id_92A1 = getent( "move_shroud_trig", "targetname" );
...
_id_2023( var_0 )
{
    ...
    triggerfx( level._id_3571._id_7E93 );
...
_id_2EAD()
{
    ...
    var_0 = getent( "ww_creation_station_dialogue", "targetname" );
...
_id_2E7B()
{
    ...
    var_1 = getent( "cart_dialog_trig", "targetname" );
    var_1._id_0CA5 = 0;
