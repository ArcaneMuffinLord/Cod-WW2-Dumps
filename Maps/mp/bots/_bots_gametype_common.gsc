...
_id_194F( var_0, var_1, var_2, var_3 )
{
    ...
    foreach ( var_10, var_8 in var_0 )
    {
        ...
        {
            var_0[var_10]._id_6638 = getclosestnodeinsight( var_0[var_10].origin );
...
_id_19DF( var_0, var_1, var_2 )
{
    ...
    foreach ( var_5 in level.players )
    {
        ...
        {
            if ( var_5 _id_19E4() || distancesquared( var_1, var_5.origin ) > squared( var_2 ) )
...
_id_19E0( var_0, var_1, var_2 )
{
    ...
    foreach ( var_5 in level.players )
    {
        if ( !isai( var_5 ) && isdefined( var_5.team ) && var_5.team == var_0 )
        {
            if ( var_5 _id_19E5() || distancesquared( var_1, var_5.origin ) <= squared( var_2 ) )
                var_3 = common_scripts\utility::_id_0F6F( var_3, var_5 );
        }
    }
...
_id_19E7()
{
    ...
    if ( var_4 == "active" )
    {
        if ( var_0.size >= var_2 )
        {
            ...
            {
                if ( isai( var_7 ) && level._id_1A92[var_7._id_6F7D] == "stationary" && var_7 _id_195B() )
                {
    ...
    else if ( var_4 == "stationary" )
    {
        if ( var_1.size >= var_3 )
        {
            ...
            {
                if ( isai( var_10 ) && level._id_1A92[var_10._id_6F7D] == "active" && var_10 _id_195A() )
                {
        ...
        if ( gettime() > var_1 )
        {
            ...
            foreach ( var_3 in var_0 )
            {
                ...
                if ( var_4.size > var_6 )
                {
                    ...
                    {
                        if ( isai( var_11 ) && var_11 _id_195B() )
                        {
                ...
                if ( var_5.size > var_7 )
                {
                    ...
                    {
                        if ( isai( var_16 ) && var_16 _id_195A() )
                        {
...
_id_1E4B( var_0 )
{
    ...
    {
        var_1._id_61B1 = ( min( var_3.origin[0], var_1._id_61B1[0] ), min( var_3.origin[1], var_1._id_61B1[1] ), min( var_3.origin[2], var_1._id_61B1[2] ) );
...
_id_41FB( var_0, var_1 )
{
    ...
    foreach ( var_4 in level._id_6E97 )
    {
        ...
        {
            if ( !isdefined( var_1 ) || var_1 && isai( var_4 ) && isdefined( var_4._id_7ECA ) )
                var_2[var_2.size] = var_4;
        }
    }
