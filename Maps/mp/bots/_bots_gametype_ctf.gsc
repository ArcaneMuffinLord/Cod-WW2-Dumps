    ...
    for (;;)
    {
        ...
        if ( self._id_7ECA == "attacker" )
        {
            if ( _id_1991() )
                ...
                var_2 = distancesquared( self.origin, level._id_9853[level._id_6C63[self.team]]._id_28D4 ) < squared( _id_4195() );
        }
        ...
        if ( _id_1991() )
        {
            ...
            {
                _id_23B2();
                var_3 = getnodesinradius( level._id_1FC6[self.team]._id_28D4, 900, 0, 300 );
