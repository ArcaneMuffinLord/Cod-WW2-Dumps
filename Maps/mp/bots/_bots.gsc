...
main()
{
    ...
    level._id_14F6 = ::badplace_cylinder;
    level._id_14F7 = ::badplace_delete;
...
_id_19F5()
{
    foreach ( var_1 in level.players )
    {
        if ( !isai( var_1 ) && var_1 _meth_829E() )
...
_id_1AFD()
{
    ...
    for (;;)
    {
        maps\mp\bots\_bots_util::bot_set_difficulty( self _meth_836D() );
...
_id_1AB1( var_0 )
{
    ...
    var_1["rank"] = randomintrange( level._id_1ABA[var_0][0], level._id_1ABA[var_0][1] + 1 );
    var_1["prestige"] = randomintrange( level._id_1AB9[var_0][0], level._id_1AB9[var_0][1] + 1 );
    return var_1;
}
...
_id_2733( var_0 )
{
    ...
    else
    {
        ...
        if ( isdefined( var_5 ) && !var_5 _meth_8389() && isdefined( var_7 ) && abs( var_5.origin[2] - var_6[2] ) < 30 )
        {
...
_id_1AE9( var_0 )
{
    if ( maps\mp\bots\_bots_util::_id_19F8( 0.66 ) )
    {
        ...
        {
            if ( nodesvisible( var_1, var_0._id_663A[0], 1 ) )
            {
...
_id_1A52()
{
    ...
    for ( var_2 = 0; var_2 < level.players.size; var_2++ )
    {
        ...
        if ( isdefined( var_3 ) && isdefined( self.team ) && isdefined( var_3.team ) && !isalliedsentient( self, var_3 ) )
        {
            ...
            if ( isai( var_3 ) && !isdefined( var_3._id_1AF1 ) )
                var_1 = var_3;
        }
    }
...
_id_6348()
{
    ...
    level._id_1AEC = getent( "smoke_grenade_sight_clip_small", "targetname" );

    if ( !isdefined( level._id_1AEC ) )
        return;

    level._id_1AEB = getent( "smoke_grenade_sight_clip_medium", "targetname" );

    if ( !isdefined( level._id_1AEB ) )
        return;

    level._id_1AEA = getent( "smoke_grenade_sight_clip_large", "targetname" );
