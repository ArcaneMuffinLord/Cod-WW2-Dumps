...
_id_2734( var_0 )
{
    if ( isagent( self ) && !isdefined( var_0._id_1B7B ) )
        return 0;
...
_id_1AC0()
{
    ...
    if ( !isdefined( level._id_52CA ) && !level._id_6510 )
    {
        ...
        level._id_52CB = getclosestnodeinsight( level._id_832F._id_28D4 );
    }
    ...
    if ( self.team == var_0 && !isdefined( level._id_1F1B ) )
    {
        ...
        if ( var_2 )
        {
            ...
            badplace_cylinder( "bomb", var_7 / 1000, level._id_832F._id_28D4, 75, 300, var_0 );
        }
    }
    ...
    for (;;)
    {
        ...
        if ( self.team == var_0 )
        {
            if ( !level._id_6510 && isdefined( level._id_1F1B ) && gettime() < level._id_1F1B && !isdefined( level._id_832F.carrier ) )
            {
                ...
                {
                    var_8 = getclosestnodeinsight( level._id_832F._id_28D4 );
        ...
        {
            if ( distancesquared( self.origin, level._id_8330.origin ) > squared( level._id_7790 * 2 ) )
            {
...
_id_10F8()
{
    ...
    if ( !self._id_568D && !level._id_6510 )
    {
        ...
        if ( self._id_10F7 >= 2 )
        {
            var_1 = getnodesinradiussorted( level._id_832F._id_28D4, 512, 0 );
            var_2 = undefined;
...
_id_23CF()
{
    ...
    if ( isdefined( level._id_10F6 ) )
    {
        if ( level._id_115F == "rush" )
        {
            ...
            if ( isai( level._id_10F6 ) && isdefined( level._id_10F6._id_1912 ) )
...
_id_42B6( var_0 )
{
    ...
    {
        if ( isai( var_4 ) && isdefined( var_4._id_7ECA ) && var_4._id_7ECA == "defender" )
        {
...
_id_3DE4( var_0, var_1, var_2 )
{
    foreach ( var_4 in var_0 )
    {
        if ( isdefined( var_2 ) )
        {
            var_4 thread _id_1AD8( var_1, randomfloatrange( 0.0, var_2 ) );
            continue;
        }
...
_id_1ABD()
{
    ...
    for (;;)
    {
        if ( isdefined( level._id_832F ) && isdefined( level._id_832F.carrier ) && !isai( level._id_832F.carrier ) )
        ...
        if ( !level._id_18F9 )
        {
            ...
            {
                var_5 = getclosestnodeinsight( level._id_832F._id_28D4 );
                ...
                if ( isdefined( var_5 ) )
                {
                    ...
                    foreach ( var_9 in var_7 )
                    {
                        ...
                        if ( var_11 > 0 && var_9._id_7ECA != "camp_bomb" && isdefined( var_10 ) && nodesvisible( var_5, var_10, 1 ) )
                        {
                            ...
                            {
                                if ( var_11 >= 2 || distancesquared( var_9.origin, level._id_832F._id_28D4 ) < squared( 700 ) )
                                {
                                    var_6 = 1;
                                    break;
                                }
                ...
                foreach ( var_3 in var_30 )
                {
                    if ( isdefined( var_3._id_7ECA ) )
                    {
                        ...
                        if ( var_3._id_7ECA != "defend_planted_bomb" )
                            var_3 thread _id_1AD8( "defend_planted_bomb", randomfloatrange( 0.0, 3.0 ) );
                    }
                }
            }
        }
