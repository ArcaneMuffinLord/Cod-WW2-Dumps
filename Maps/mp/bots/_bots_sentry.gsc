...
_id_1ACE( var_0 )
{
    ...
    {
        if ( distance2d( self.origin, var_0._id_68FB._id_010D.origin ) < 400 )
        {
...
_id_1AC9( var_0, var_1, var_2, var_3 )
{
    ...
    if ( isdefined( var_7 ) )
    {
        ...
        if ( var_1 != var_7.origin && var_2 != "hide_nonlethal" )
            var_4._id_AAE8 = vectortoyaw( var_1 - var_7.origin );
        else
...
_id_1AC4( var_0 )
{
    ...
    if ( isdefined( var_2 ) )
    {
        ...
        if ( !var_2._id_1F2F )
        {
            ...
            {
                var_11 = playerphysicstrace( var_0._id_68FB._id_010D.origin, var_0._id_68FB._id_010D.origin + anglestoforward( ( 0, var_10 + 180, 0 ) ) * 100 );
                var_12 = distance2d( var_11, var_0._id_68FB._id_010D.origin );
