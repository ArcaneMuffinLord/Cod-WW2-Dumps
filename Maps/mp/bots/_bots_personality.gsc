    ...
    if ( !maps\mp\bots\_bots_strategy::_id_1A14() && !maps\mp\bots\_bots_util::_id_1A36() )
    {
        ...
        if ( var_1 )
        {
            ...
            if ( isdefined( self._id_1A7B ) && var_2 < var_4 * var_4 )
            {
                ...
                botflagmemoryevents( 0, gettime() - self._id_1A7C, 1, self._id_1A7B, var_4, "kill", var_5, self );
                botflagmemoryevents( 0, gettime() - self._id_1A7C, 1, self._id_1A7B, var_4, "death", var_5, self );
...
_id_23AB()
{
    ...
    self._id_0D38 = randomintrange( 20000, 30000 );
    self._id_0D39 = -1;
}
...
_id_3B68()
{
    ...
    if ( !isdefined( var_15 ) || !self botgetdifficulty( var_15 ) )
        return 0;
...
_id_3B64( var_0, var_1 )
{
    ...
    var_5 = getnodesinradius( self._id_753C, var_4, 0, 1000 );
    var_6 = undefined;
    ...
    if ( !isdefined( var_6 ) || !self botgetdifficulty( var_6 ) )
        return 0;
