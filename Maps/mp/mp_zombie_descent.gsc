...
toggle_active()
{
    ...
    for (;;)
    {
        ...
        foreach ( var_2 in var_0.player_exclusion_zones )
        {
            ...
            {
                if ( distance2d( var_4.origin, var_2.origin ) < var_2.radius && abs( var_4.origin[2] - var_2.origin[2] ) < var_2._id_00BD )
                {
...
give_all_boss_battle_perks()
{
    ...
    {
        if ( weapontype( var_1[var_2] ) != "melee" )
...
init_blood_plates()
{
    ...
    foreach ( var_3 in var_0 )
    {
        ...
        if ( isdefined( var_3._id_8260 ) && var_3._id_8260 == "plate_trial_room" )
        {
            ...
            var_4 = var_1;
            var_4 = sortbydistance( var_4, var_3.origin, 150 );
        ...
        foreach ( var_4 in var_2 )
        {
            switch ( var_4._id_0165 )
            {
                ...
                case "trig_damage_check":
                    ...
                    var_1._id_8303 = distance2d( var_5, var_6 );
                default:
                    break;
            }
        }
...
text_log_player_near_or_looking( var_0, var_1 )
{
    ...
    if ( !sighttracepassed( var_0.origin, var_1.origin, 0, var_1, var_0 ) )
        return 0;
...
trap_archives_spikes_handle_damage()
{
    ...
    while ( self._id_565F )
    {
        ...
        {
            var_7 = spawnfx( common_scripts\utility::_id_44F5( "spikeTrap" ), var_1[var_6].origin, anglestoforward( var_1[var_6].angles ) );
            triggerfx( var_7 );
...
{
    var_2 = spawnstruct();
    var_2.origin = _func_2E1( var_0.origin + pow( -1, !common_scripts\utility::_id_562E( var_1 ) ) * 32 * vectornormalize( anglestoright( var_0.angles ) ) );
