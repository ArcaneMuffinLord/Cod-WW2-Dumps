...
_id_738B( var_0 )
{
    ...
    if ( _id_734C() )
    {
        ...
        var_3 = -12;
        var_4 = var_2[1] * var_3;
        var_0._id_3A08 = angleclamp( var_0._id_3A08 + var_4 );
...
_id_0902( var_0 )
{
    ...
    level._id_13B8[var_1].xuid = var_0;
    level._id_13B8[var_1]._id_9A1A = 0;
    return var_1;
}
...
_id_7E92( var_0, var_1 )
{
    ...
    var_3 = angleclamp( var_2 - var_0._id_942C );
    var_4 = getdvarfloat( "ui_mouse_char_rot", 0 );

    if ( var_4 != 0 )
    {
        var_0._id_6469 = angleclamp( var_0._id_6469 + var_4 );
        setdynamicdvar( "ui_mouse_char_rot", 0 );
    }

    var_5 = maps\mp\hub_vl_camera::_id_4590( var_0, var_3, var_1 );
    var_5 = var_5 * -1;
    var_6 = angleclamp( var_0._id_942A + var_5 + var_0._id_6469 );
    var_7 = ( 0, var_6, 0 );
...
_id_73F8( var_0 )
{
    ...
    var_2 = angleclamp( var_1 - var_0._id_942C );
