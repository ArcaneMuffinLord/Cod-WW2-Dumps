    ...
    if ( !common_scripts\utility::_id_3C77( "flag_all_paintings_revealed" ) )
    {
        ...
        else
        {
            if ( !common_scripts\utility::_id_3C77( "flag_both_hints_seen" ) && !common_scripts\utility::_id_3C77( "flag_player_has_head" ) )
            {
                if ( 1 )
                {
                    var_0 = getent( "paintings_hint_head_jar", "targetname" );
...
_id_8A24()
{
    ...
    var_0 = getent( "head_hint_trig", "targetname" );

    if ( !isdefined( var_0 ) )
        return;

    var_0._id_5877 = getent( "paintings_hint_head_jar", "targetname" );
...
{
    level endon( "flag_both_hints_seen" );
    var_0 = getent( "painting_hint_trig", "targetname" );

    if ( !isdefined( var_0 ) )
        return;

    var_0._id_6DEE = getent( "paintings_hint_painting", "targetname" );
    var_0 _meth_8177( 1 );
...
_id_8A46()
{
    level._id_357F = getent( "sonic_amp_confirm_code_trig", "targetname" );
    level._id_357F common_scripts\utility::_id_9D9F();
    level._id_357F._id_0CAB = getent( "sonic_amp_control", "targetname" );
    ...
    for (;;)
    {
            ...
            foreach ( var_7 in var_5 )
            {
                ...
                foreach ( var_10 in var_8 )
                {
                    if ( var_10.classname == "script_model" )
                        playfxontag( level._effect["zmb_vog_code_correct"], var_10, "Flute" );
                }
            }
        ...
        else
        {
            ...
            foreach ( var_7 in var_5 )
            {
                ...
                {
                    if ( var_10.classname == "script_model" )
                        playfxontag( level._effect["zmb_vog_code_incorrect"], var_10, "Flute" );
                }
            }
...
_id_A185( var_0 )
{
    ...
    self._id_0DBE scriptmodelplayanim( _func_286( var_3 ) );
    wait( var_4 );
}
