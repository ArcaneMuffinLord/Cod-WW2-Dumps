...
quest_step_find_radio()
{
    ...
    var_0 = getent( "quest_trig_find_radio", "targetname" );
...
{
    var_0 = getent( "radio_tuner_right", "targetname" );
    var_1 = 0;
...
flare_box_init()
{
    var_0 = getent( "flare_crate_closed", "script_noteworthy" );
    var_1 = getent( "flare_crate_interact_trig", "targetname" );
    var_2 = getent( "trig_dmg_flare_lock", "script_noteworthy" );
    var_3 = getent( "trig_dmg_flare_crate", "script_noteworthy" );
    var_4 = 0;
    var_5 = 0;
    ...
    for (;;)
    {
        ...
        var_6 = getent( "origin_flare_crate_fx", "targetname" );
...
flare_box_highlight( var_0 )
{
    if ( 1 )
    {
        ...
        {
            var_1 = getent( "flare_crate_closed", "script_noteworthy" );
...
setup_airship_anchors()
{
    ...
    var_0 = getent( "origin_anchor_base_a", "script_noteworthy" );
    var_0 _meth_805C();
}
...
quest_step_airship_anchors()
{
    ...
    foreach ( var_3 in var_0 )
    {
        ...
        triggerfx( var_3.tether_ambient_effects );
        ...
        switch ( var_3._id_8260 )
        {
            case "airship_tether_refuge":
                var_3.damage_trig = getent( "airship_anchor_trig_refuge", "script_noteworthy" );
            ...
            case "airship_tether_underbelly":
                var_3.damage_trig = getent( "airship_anchor_trig_underbelly", "script_noteworthy" );
            ...
            case "airship_tether_courtyard":
                var_3.damage_trig = getent( "airship_anchor_trig_courtyard", "script_noteworthy" );
            ...
            case "airship_tether_museum":
                var_3.damage_trig = getent( "airship_anchor_trig_museum", "script_noteworthy" );
...
airship_anchor_soul_bucket( var_0, var_1 )
{
    level endon( var_1 );
    level waittill( "airship_anchor_courtyard_impact" );
    var_2 = getent( "origin_anchor_base_a", "script_noteworthy" );
    ...
    if ( !common_scripts\utility::_id_3C77( "flag_airship_anchor_c_reeled" ) )
    {
        ...
        iprintlnbold( "soul collection for " + var_1 + " end" );
...
airship_anchor_wonderweapon_collection( var_0, var_1, var_2 )
{
    ...
    if ( !common_scripts\utility::_id_3C77( var_2 ) )
    {
        ...
        var_3 = getent( "origin_anchor_base_a", "script_noteworthy" );
...
airship_anchor_charge_soul_bucket_animation( var_0 )
{
    ...
    var_1 = getanimlength( %s2_zom_zep_tether_scene_ring_up );
    var_2 = var_1 * var_0;
...
{
    var_0 = getent( "quest_trig_enter_dropcage", "targetname" );
...
quest_drop_pod_init()
{
    var_0 = getent( "drop_pod_model", "script_noteworthy" );
    var_0 _meth_805C();
    var_0 _meth_82C2();
    var_1 = getent( "dropcage_push_trigger", "targetname" );
    var_1 enablelinkto();
    var_1 linktosynchronizedparent( var_0 );
    var_2 = getent( "pod_underneath_clip", "targetname" );
    var_2 _meth_82B4( -742, 0.05 );
    waitframe();
    var_2 linktosynchronizedparent( var_0 );
    var_2 _meth_82C2();
    var_2 _meth_8060();
    var_3 = getent( "drop_pod_cable", "script_noteworthy" );
    var_3 _meth_805C();
    var_0.lightfx = _func_2A8( common_scripts\utility::_id_44F5( "zmb_drop_pod_light" ), var_0, "tag_origin" );
    var_0.lightfx _meth_805C();
    var_4 = getent( "trig_dmg_drop_pod_winch", "script_noteworthy" );
    var_4 enablelinkto();
    var_4 linktosynchronizedparent( var_0 );
    var_4 _meth_805C();
    var_5 = getent( "clip_wpn_drop_pod_winch", "script_noteworthy" );
    var_5 _meth_805C();
    var_5 linktosynchronizedparent( var_0 );
    var_6 = getent( "clip_drop_pod_closed", "script_noteworthy" );
    var_6 _meth_805C();
    var_6 _meth_82C2();
    var_6 linktosynchronizedparent( var_0 );
    var_7 = getent( "clip_drop_pod", "script_noteworthy" );
    var_7 _meth_805C();
    var_7 _meth_82C2();
    var_7 linktosynchronizedparent( var_0 );
    var_8 = getent( "org_tp_plaza", "script_noteworthy" );
    ...
    var_13 = getent( "clip_drop_pod_nav_blocker", "script_noteworthy" );
    var_13 _meth_82B4( -128, 0.05 );
    waitframe();
    var_13 _meth_82C2();
    var_13 _meth_8060();
    var_14 = getent( "clip_door", "script_noteworthy" );
    var_14 _meth_82B4( -128, 0.05 );
    waitframe();
    var_14 _meth_82C2();
    var_14 _meth_8060();
    var_15 = getent( "model_airship_drop_pod", "script_noteworthy" );
    var_15.airpodlightfx = _func_2A8( common_scripts\utility::_id_44F5( "zmb_drop_pod_light" ), var_15, "tag_origin" );
    triggerfx( var_15.airpodlightfx );
...
quest_drop_pod_show_pod()
{
    ...
    var_0 _meth_805B();
    var_0 _meth_82C1();
    var_1 = getent( "drop_pod_cable", "script_noteworthy" );
    var_1 _meth_805B();
    var_0.lightfx _meth_805B();
    var_2 = getent( "clip_drop_pod", "script_noteworthy" );
    var_2 _meth_805B();
    var_2 _meth_82C1();
    var_3 = getent( "trig_dmg_drop_pod_winch", "script_noteworthy" );
    var_4 = getent( "clip_wpn_drop_pod_winch", "script_noteworthy" );
    var_3 _meth_805B();
    var_4 _meth_805B();
    var_5 = getent( "org_drop_pod_winch_vfx", "script_noteworthy" );
    var_6 = spawn( "script_model", var_5.origin );
    var_6 setmodel( "tag_origin" );
    var_6 linktosynchronizedparent( var_0 );
    playfxontag( level._effect["zmb_ber_droppod_roof"], var_6, "Tag_Origin" );
}
...
quest_drop_pod_movement()
{
    ...
    var_4 = getent( "drop_pod_model", "script_noteworthy" );
    var_5 = getent( "clip_drop_pod_closed", "script_noteworthy" );
    var_6 = 0;
...
{
    var_0 = getent( "drop_pod_model", "script_noteworthy" );
    var_1 = getent( "clip_drop_pod_closed", "script_noteworthy" );
    var_1 _meth_805C();
    var_1 _meth_82C2();
...
{
    level endon( _id_0557::_id_7838( "quest_bring_down_airship", "step_raise_dropcage" ) );
    var_0 = getent( "trig_dmg_drop_pod_winch", "script_noteworthy" );
...
quest_drop_pod_teleport_to_airship()
{
    ...
    var_0 = getent( "clip_door", "script_noteworthy" );
    var_0 delete();
    thread airship_audiolog_init();
    var_1 = getent( "org_tp_plaza", "script_noteworthy" );
    var_2 = getent( "org_tp_airship", "script_noteworthy" );
...
{
    var_0 = getent( "drop_pod_model", "script_noteworthy" );
    var_1 = getent( "model_airship_drop_pod", "script_noteworthy" );
    var_0.lightfx _meth_805C();
...
{
    var_0 = getent( "drop_pod_model", "script_noteworthy" );
    var_1 = getent( "debug_drop_pod_tp", "script_noteworthy" );
    var_1 linktosynchronizedparent( var_0 );
    var_1 _meth_82C2();
    var_1 _meth_805C();
}
...
debug_drop_pod_position()
{
    ...
    foreach ( var_3 in level.players )
    {
        for (;;)
        {
            ...
            iprintlnbold( var_3.relative_position );
            wait 0.5;
        }
    }
}
...
debug_drop_pod_position_airship()
{
    level waittill( "drop_pod_reached_airship" );
    var_0 = getent( "drop_pod_model", "script_noteworthy" );
    var_1 = getent( "org_tp_airship", "script_noteworthy" );
...
quest_wunderbuss_collect_battery()
{
    ...
    foreach ( var_10 in var_8 )
    {
        switch ( var_10._id_0165 )
        {
            case "wunderbuss_trig_battery":
                var_6 = getent( var_10.targetname, "targetname" );
                break;
            case "wunderbuss_battery_vfx_org":
                ...
                playfxontag( level._effect["red_dot_light"], var_7, "tag_origin" );
                break;
        }
    }
    ...
    killfxontag( level._effect["red_dot_light"], var_7, "tag_origin" );
}
...
quest_wunderbuss_access_smuggler_den()
{
    ...
    var_0 = getent( "wunderbuss_trig_smuggler_door", "script_noteworthy" );
    var_1 = getent( "wunderbuss_smuggler_door_battery", "script_noteworthy" );
    var_1 _meth_805C();
...
quest_wunderbuss_build_weapon()
{
    ...
    var_0 = getent( "wunderbuss_weapon_complete", "script_noteworthy" );
    var_0 _meth_805B();
...
quest_wunderbuss_init_bench()
{
    ...
    var_5 = getent( "wunderbuss_weapon_base", "script_noteworthy" );
    var_5 _meth_805B();
    wait 2;
    level thread common_scripts\_exploder::_id_088E( 219 );
}
...
quest_wunderbuss_escape_smuggler_den()
{
    ...
    var_0 = getent( "wunderbuss_trig_dmg_smuggler_door", "script_noteworthy" );
    var_0 _meth_80B0( var_0 _meth_85A0() | 256 );
    var_1 = 0;
    var_2 = 10;
...
{
    level endon( "flag_quest_wunderbuss_escape_smugglers_den" );
    var_0 = getent( "zone_smuggler_den", "script_noteworthy" );
    var_1 = [];
...
{
    var_0 = getent( "straub_airship_idle_anim_org", "targetname" );
...
quest_step_overload_straubs_electroschnell_complete()
{
    ...
    var_4 = getent( "straub_airship_idle_anim_org", "targetname" );
...
escape_airship_init()
{
    var_0 = getent( "clip_airship_drop_pod_closed", "script_noteworthy" );
    var_0 _meth_82C2();
    waitframe();
    var_0 _meth_8060();
}
...
escape_airship_logic()
{
    ...
    var_0 = getent( "airship_lab_door_left", "targetname" );
...
escape_airship_drop_pod_wait_for_all_players()
{
    ...
    var_10 = getent( "model_airship_drop_pod", "script_noteworthy" );
    var_11 = getanimlength( %s2_zmb_drop_pod_close_front_quick );
    var_10 scriptmodelplayanim( "s2_zmb_drop_pod_close_front_quick", "airship_drop_pod_close_doors" );
    _id_0378::_id_8D74( "inside_droppod_submix_strt" );
    var_12 = getent( "clip_airship_drop_pod_closed", "script_noteworthy" );
    var_12 _meth_82C1();
    wait( var_11 );
...
escape_airship_player_in_drop_pod_check()
{
    ...
    var_0 = getent( "vol_airship_drop_pod_area", "script_noteworthy" );
...
escape_airship_drop_pod_move()
{
    ...
    var_0 = getent( "airship_interior_launch_door", "script_noteworthy" );
    var_0 _meth_805C();
    var_1 = getent( "model_airship_drop_pod", "script_noteworthy" );
    var_1 _id_0378::_id_8D74( "droppod_escape_fire" );
    var_2 = getentarray( "airship_drop_pod_body", "targetname" );
    var_3 = getent( "org_tp_airship", "script_noteworthy" );
...
escape_airship_teleport_to_surface()
{
    var_0 = getent( "org_tp_plaza", "script_noteworthy" );
    var_1 = getent( "org_tp_airship", "script_noteworthy" );
    waitframe();
...
escape_plaza_drop_pod_move()
{
    ...
    var_0 = getent( "clip_drop_pod_closed", "script_noteworthy" );
    var_0 _meth_82C2();
...
{
    wait 1;
    var_0 = getent( "airship_node_03_03", "targetname" );
    var_0 notify( "hack_interact" );
    var_0 = getent( "airship_node_01_02", "targetname" );
    var_0 notify( "hack_interact" );
    var_0 = getent( "airship_node_02_01", "targetname" );
    var_0 notify( "hack_interact" );
    var_0 = getent( "airship_node_05_02", "targetname" );
    var_0 notify( "hack_interact" );
    var_0 = getent( "airship_node_04_01", "targetname" );
    var_0 notify( "hack_interact" );
    wait 5;
    var_1 = getent( "airship_node_03_05", "targetname" );
...
boss_spawn()
{
    ...
    var_1 = getent( "trigger_leaving_airship_boss", "script_noteworthy" );
    var_2 = 0;
...
bob_stun_zombies_nearby( var_0 )
{
    ...
    var_5 = sortbydistance( _id_0547::_id_408F(), var_1, var_2 );
    var_6 = 1;
...
quest_pap_init()
{
    ...
    var_0 = getent( "pap_machine_fake", "script_noteworthy" );
...
{
    var_1 = getent( "trigger_dmg_elevator_shaft", "script_noteworthy" );
    var_2 = getent( "trigger_dmg_elevator_bottom_doors", "script_noteworthy" );
    ...
    var_5 = getent( "pap_electric_box_door_1", "script_noteworthy" );
    var_6 = getent( "pap_electric_box_door_2", "script_noteworthy" );
    var_1 thread trigger_electric_box_hit( var_3, var_5 );
    var_2 thread trigger_electric_box_hit( var_4, var_6 );
    var_7 = getent( "script_pap_elevator_mover", "script_noteworthy" );
    var_8 = getent( "script_pap_elevator_geo", "script_noteworthy" );
    ...
    var_10 = getent( "pap_elevator_doors", "script_noteworthy" );
    var_11 = getent( "pap_elevator_clip", "script_noteworthy" );
...
{
    var_0 = 0;
    var_1 = getent( "jumpscare_sewer_board_geo", "script_noteworthy" );
    var_2 = getent( "jumpscare_sewer_board_geo_after", "script_noteworthy" );
    var_3 = getent( "jumpscare_sewer_board_trigger", "script_noteworthy" );
    var_4 = getent( "jumpscare_sewer_board_clip", "script_noteworthy" );
    var_2 _meth_805C();
...
js_dancer()
{
    var_0 = getent( "dancer_js", "targetname" );
    var_1 = getent( "dancer_js_trig", "targetname" );
    var_2 = common_scripts\utility::_id_46B5( "dancer_js_struct", "targetname" );
    var_3 = getent( "bonus_ee_audiolog_dancer_pickup_model", "targetname" );
    ...
    while ( !var_6 )
    {
        foreach ( var_8 in level.players )
        {
            ...
            var_10 = common_scripts\utility::within_fov( var_8 geteye(), var_8 _meth_8566(), var_2.origin, cos( 25 ) );
...
bonus_ee_audiolog_dancer_init()
{
    ...
    var_0 = getent( "bonus_ee_audiolog_dancer_painting", "script_noteworthy" );
    var_1 = getent( "bonus_ee_audiolog_dancer_painting_trig", "script_noteworthy" );
    var_2 = getent( "bonus_ee_audiolog_dancer_record", "script_noteworthy" );
    var_3 = getent( "bonus_ee_audiolog_dancer_record_trig_use", "script_noteworthy" );
    var_4 = getent( "bonus_ee_audiolog_dancer_phono_trig_use", "script_noteworthy" );
    var_5 = getent( "bonus_ee_audiolog_dancer_phono_trig_dmg", "script_noteworthy" );
    var_6 = getent( "trigger_dancer_jump_scare_audiolog_collect", "script_noteworthy" );
    var_7 = [];
...
the_classic_logic()
{
    var_0 = getent( "classic_trig_use_touch_mirror_one", "script_noteworthy" );
    ...
    var_1 = getent( "classic_trig_use_touch_mirror_two", "script_noteworthy" );
    ...
    var_2 = getent( "classic_trig_use_touch_mirror_three", "script_noteworthy" );
...
{
    var_1 = spawnfx( common_scripts\utility::_id_44F5( "moneyCloud" ), var_0 );
    triggerfx( var_1 );
    wait 3;
    var_1 delete();
}
...
bell_race_init()
{
    ...
    foreach ( var_2 in var_0 )
    {
        ...
        {
            level.bell_race_log_trig = getent( var_2.target, "targetname" );
...
bell_race_logic()
{
    ...
    {
        var_0 = getent( "bell_race_starting_bell", "script_noteworthy" );
...
bell_race_start()
{
    ...
    for (;;)
    {
        ...
        {
            var_4 = getent( "bell_race_ending_bell", "script_noteworthy" );
...
bell_race_complete()
{
    ...
    var_0 = getent( "bell_race_box", "script_noteworthy" );
            ...
            if ( var_7 )
            {
                for ( var_3 = 0; var_3 < var_0.size; var_3++ )
                {
                    if ( var_0[var_3] == var_4[var_5] )
                    {
                        ...
                        var_8 = getent( "hangman_letter_panel" + common_scripts\utility::_id_9AAD( var_3 + 1 ), "script_noteworthy" );
...
hangman_update_cursor_letter( var_0, var_1 )
{
    ...
    var_2 = getent( "hangman_letter_cursor", "targetname" );
    var_2 setmodel( "zbr_cab_letter_" + var_0[var_1] );
}

hangman_attempt_to_solve_forward_input()
{
    var_0 = getent( "hangman_letter_forward", "targetname" );
...
{
    var_0 = getent( "hangman_letter_back", "targetname" );
...
{
    var_0 = getent( "hangman_letter_submit", "targetname" );
...
{
    var_1 = getent( "hangman_zombie_part_0" + common_scripts\utility::_id_9AAD( var_0 ), "targetname" );
    var_1 _meth_805B();
...
hangman_give_jack_in_the_box( var_0 )
{
    ...
    playfxontag( level._effect["zmb_ber_gun_cone_glow"], var_2, "tag_origin" );
    ...
    var_1 delete();
    killfxontag( level._effect["zmb_ber_gun_cone_glow"], var_2, "tag_origin" );
    var_2 delete();
}
...
airship_audiolog_setup_pods()
{
    var_0 = getent( "beam_pod", "script_noteworthy" );
    var_1 = getent( "log_pod", "script_noteworthy" );
...
airship_audiolog_open_doors( var_0, var_1, var_2, var_3 )
{
    ...
    var_5 = getent( var_1, "script_noteworthy" );
...
airship_audiolog_open_door_player_handler( var_0, var_1, var_2, var_3 )
{
    level endon( "game_over" );
    level endon( "flag_override_electroschnell_complete" );
    var_4 = getanimlength( %s2_zmb_drop_pod_open_front_quick );
    var_5 = 0.1;
    var_6 = 0;
