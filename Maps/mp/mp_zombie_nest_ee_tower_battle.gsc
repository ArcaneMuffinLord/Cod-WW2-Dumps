...
_id_46EE( var_0 )
{
    ...
    var_2["respawnExclusionRadius"] = _id_0547::_id_9470( tablelookupbyrow( var_3, var_1, 4 ) );
    var_2["objectiveTime"] = _id_0547::_id_9470( tablelookupbyrow( var_3, var_1, 5 ) );
    var_2["objectiveHealth"] = _id_0547::_id_9470( tablelookupbyrow( var_3, var_1, 6 ) );
    var_2["zombieObjectiveMax"] = _id_0547::_id_9470( tablelookupbyrow( var_3, var_1, 7 ) );
    var_2["objectiveHealthSolo"] = _id_0547::_id_9470( tablelookupbyrow( var_3, var_1, 9 ) );
    return var_2;
}
...
_id_A0E2( var_0, var_1 )
{
    ...
    if ( var_0 <= var_1 * 0.75 && var_0 > var_1 * 0.5 )
    {
        if ( self._id_28FC != 1 )
        {
            ...
            self._id_299D = spawnfx( level._effect["zmb_ee_fuse_dmg_lt"], self.origin, var_2 );
            triggerfx( self._id_299D );
            self._id_28FC = 1;
        }
    }
    else if ( var_0 <= var_1 * 0.5 && var_0 > var_1 * 0.25 )
    {
        if ( self._id_28FC != 2 )
        {
            ...
            var_2 = anglestoforward( self.angles );
            self._id_299D = spawnfx( level._effect["zmb_ee_fuse_dmg_med"], self.origin, var_2 );
            triggerfx( self._id_299D );
            self._id_28FC = 2;
        }
    }
    else if ( var_0 <= var_1 * 0.25 && var_0 > 0 )
    {
        if ( self._id_28FC != 3 )
        {
            ...
            var_2 = anglestoforward( self.angles );
            self._id_299D = spawnfx( level._effect["zmb_ee_fuse_dmg_hvy"], self.origin, var_2 );
            triggerfx( self._id_299D );
            self._id_28FC = 3;
        }
    }
    else if ( var_0 <= 0 )
    {
        if ( self._id_28FC != 4 )
        {
            ...
            var_2 = anglestoforward( self.angles );
            self._id_299D = spawnfx( common_scripts\utility::_id_44F5( "ee_fuse_blowout" ), self.origin, var_2 );
            triggerfx( self._id_299D );
            self._id_28FC = 4;
        }
    }
...
_id_8A37( var_0, var_1 )
{
    if ( 1 )
    {
        ...
        for ( var_3 = 0; var_3 < var_1.size; var_3++ )
            var_2[var_3] = getent( var_1[var_3], "targetname" );
...
_id_46EF( var_0 )
{
    ...
    var_3 = _id_0547::_id_9470( tablelookupbyrow( var_2, var_1, 8 ) );
    return var_3;
}

_id_8A05()
{
    self._id_1170 = getent( self.target, "targetname" );
...
_id_64AC( var_0 )
{
    ...
    if ( !isdefined( var_1._id_7EC4 ) )
    {
        ...
        if ( self.targetname == "inner_spire_lever" )
        {
            ...
            var_1._id_7EC6 = getanimlength( %zmb_tower_rod_mid_up );
            var_1._id_7EC3 = getanimlength( %zmb_tower_rod_mid_down );
        }
        else
        {
            ...
            var_1._id_7EC6 = getanimlength( %zmb_tower_rod_up );
            var_1._id_7EC3 = getanimlength( %zmb_tower_rod_down );
        }
    }
...
_id_8A4B()
{
    var_0 = getent( "nest_ee_fuse_piece_lift", "targetname" );
...
{
    wait 3;
    var_0 = getent( "inner_spire", "targetname" );

    if ( isdefined( var_0 ) )
    {
        foreach ( var_2 in level.players )
        {
            if ( distance2d( var_2.origin, var_0.origin ) < 750 )
...
_id_52FA( var_0 )
{
    ...
    for ( var_3 = 0; var_3 < var_0.size; var_3++ )
    {
        ...
        var_4._id_65E6 = getent( var_4.target, "targetname" );
...
_id_52ED()
{
    ...
    var_0._id_65E7 = getent( "inner_spire_lever", "targetname" );
    var_0._id_65E7._id_65E6 = getent( var_0._id_65E7.target, "targetname" );
    ...
    foreach ( var_3 in var_1 )
    {
        ...
        var_3._id_65E7 = getent( var_3.target, "targetname" );
        var_3._id_65E7._id_65E6 = getent( var_3._id_65E7.target, "targetname" );
...
_id_46ED( var_0, var_1, var_2 )
{
    ...
    {
        var_3["attack_positions"][var_4] = getent( var_2[var_4], "targetname" );
