...
ambient_lightning_strikes()
{
    ...
    for (;;)
    {
        ...
        var_5 = var_4 _meth_8216( randomfloatrange( -0.99, 0.99 ), randomfloatrange( -0.99, 0.99 ), randomfloatrange( -0.99, 0.99 ) );
        ...
        var_0.angles = ( var_0.angles[0], var_0.angles[1] + randomintrange( 45, 315 ), var_0.angles[2] );
        waitframe();
        var_6 = _func_382( "zmb_wm_lightning_beam", var_0, "tag_origin", var_1, "tag_origin" );
        var_6 common_scripts\utility::_id_2CBE( randomfloatrange( 0.15, 0.25 ), ::delete );
    }
}
...
ambient_lightning_strikes_forvfx()
{
    ...
    waitframe();
    var_1 linktosynchronizedparent( var_0 );
    var_2 = getent( "lightning_strike_vol_test", "targetname" );
    var_3 = 4900;
    ...
    for (;;)
    {
        ...
        var_4 = var_2 _meth_8216( randomfloatrange( -0.99, 0.99 ), randomfloatrange( -0.99, 0.99 ), randomfloatrange( -0.99, 0.99 ) );
        ...
        playfxontag( level._effect["zmb_wm_lightning_impact_base_rnr"], var_1, "tag_origin" );

        if ( getdvarint( "snd_zmb_debug_lighting_strike" ) )
            _id_0378::_id_8D74( "lightning_strike", var_0.origin, var_4 );

        var_5 common_scripts\utility::_id_2CBE( randomfloatrange( 0.15, 0.25 ), ::delete );
    }
}
...
windmill_rotateby_speed( var_0 )
{
    ...
    var_1 = getent( "windmill_fan", "targetname" );
...
windmill_rotateby_accelerate_to_speed( var_0, var_1, var_2 )
{
    ...
    if ( var_4 < 0 )
    {
        ...
        var_11 = abs( var_3.angles[0] % var_9 );
