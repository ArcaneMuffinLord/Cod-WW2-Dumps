...
main()
{
    ...
    var_5 = getent( "lhog_control", "targetname" );

    if ( isdefined( var_5 ) )
        var_5 thread maps\mp\mp_zombie_nest_ee_util::_id_4D77( "off" );

    var_1[0] _meth_805B();
    playfxontag( level._effect["zmb_uberschnelle_charge"], var_1[0], "tag_origin" );
...
_id_714D()
{
    var_0 = getent( "left_hand_of_god_model", "targetname" );
    playfxontag( level._effect["zmb_lhog_init"], var_0, "tag_origin" );
}

_id_7862()
{
    level notify( "nest_ee_fuses_complete" );
    var_0 = getent( "overcharge_trig", "targetname" );
    var_0._id_4D91 = _id_0559::_id_7BE3( var_0, "lhog" );
    var_0 _meth_80CE( &"ZOMBIES_SWITCH_HINT_GENERIC_EXAMINE" );
    var_0._id_17A9 = 0;
    var_1 = getent( "left_hand_of_god_model", "targetname" );
    var_2 = getent( "lhog_control", "targetname" );
    ...
    while ( var_0._id_17A9 < 3 )
    {
        ...
        if ( var_8 _id_0585::_id_9E12( "Blimp Battery Hunt" ) )
        {
            ...
            playfxontag( level._effect["zmb_uberschnelle_charge"], var_4[var_0._id_17A9], "tag_origin" );
...
{
    var_0 = getent( "left_hand_of_god_model", "targetname" );
    var_1 = getent( "overcharge_trig", "targetname" );
    ...
    var_4 = getent( "lhog_control", "targetname" );
