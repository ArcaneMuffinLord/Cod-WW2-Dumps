...
_id_A604()
{
    ...
    {
        var_0[var_3] = 0.5 * pow( var_1, var_2 );
        var_2 = var_2 - 1;
    }
...
vog_do_earthshake()
{
    ...
    earthquakes( 0.2, 30, self.origin, 900, self );
}
...
_id_80DF()
{
    var_0 = getent( "scream_trigger_01", "targetname" );
...
_id_80E0()
{
    var_0 = getent( "scream_trigger_02", "targetname" );
...
_id_80E1()
{
    var_0 = getent( "scream_trigger_03", "targetname" );
