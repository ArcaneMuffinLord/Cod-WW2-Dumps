...
{
    var_0 = spawnstruct();
    var_0._id_3E6C = getent( "firingrange_start", "targetname" );
...
{
    level endon( "shutdown_hologram" );
    var_1 = getent( "firing_range_round_trigger_end", "targetname" );
...
_id_63F6( var_0 )
{
    ...
    for (;;)
    {
        ...
        var_1 = distance2d( level._id_3C3B._id_6095.origin, var_0.origin );
...
_id_6384( var_0 )
{
    ...
    for (;;)
    {
        ...
        var_1 = distance2d( level._id_3C3B._id_621F, var_0.origin );
...
_id_6377( var_0 )
{
    ...
    for (;;)
    {
        ...
        var_1 = common_scripts\utility::_id_7F03( float( var_1 ) * var_12, 0 );
        var_1 = int( var_1 );
...
_id_6378( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11 )
{
    ...
    var_2 = common_scripts\utility::_id_7F03( float( var_2 ) * var_13, 0 );
    var_2 = int( var_2 );
...
_id_4D19()
{
    if ( isarray( level._id_3C3B._id_9C7C ) )
    {
...
_id_2D55()
{
    if ( isarray( level._id_3C3B._id_9C7D ) )
    {
...
_id_7CF7()
{
    if ( isarray( level._id_3C3B._id_808A ) )
    {
...
_id_A673( var_0, var_1 )
{
    ...
    var_2 = getgroundposition( level._id_3C3B._id_3E6C.origin, 20, 512, 120 );
    var_1 _meth_808C();
...
_id_861F( var_0, var_1 )
{
    for ( var_2 = 0; var_2 < level._id_2683.size; var_2++ )
    {
        ...
        var_4 = tablelookupbyrow( "mp/agentcostumetable.csv", var_2 + var_3, var_0 );
...
_id_3764( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10 )
{
    ...
    iprintln( self.name + " " + var_8 + " has been hit for " + var_2 + " at " + var_11 );
...
_id_64D0()
{
    ...
    for (;;)
    {
        if ( isdefined( self ) )
        {
            ...
            {
                var_4 = getent( self._id_28F5.target, "targetname" );
                self._id_5B23 = self._id_28F5;
                self._id_28F5 = var_4;
            }
            else
...
_id_649E()
{
    ...
    if ( isdefined( self._id_5B23._id_0165 ) && self._id_5B23._id_0165 == "jump" )
    {
        var_0 = self._id_5B23;
        var_1 = var_0.origin;
        self._id_5B23 = getent( var_0.targetname, "target" );
    }
...
_id_3C36()
{
    ...
    foreach ( var_3 in var_0 )
    {
        ...
        var_3.team = "axis";
        var_3._id_6C3E = getent( var_3.target, "targetname" );
        var_3._id_0B6E = getent( var_3._id_6C3E.target, "targetname" );
        ...
        {
            var_3._id_A580 = getent( var_3._id_0B6E.target, "targetname" );
...
_id_4864( var_0 )
{
    if ( isdefined( level._id_486C ) && isarray( level._id_486C ) )
    {
