...
_id_7830()
{
    var_0 = getent( "bunker_ent_dialogue", "targetname" );
    var_0 _id_A77B();
...
_id_AA06()
{
    var_0 = getent( "well_clip_bottom", "script_noteworthy" );
    var_0.origin = var_0.origin + ( 0, 0, 128 );
    var_0._id_50D0 = 0;
    waitframe();
    var_0 _meth_82C2();
    var_1 = getent( "well_clip_top_plug", "script_noteworthy" );
    var_1.origin = var_1.origin + ( 0, 0, -128 );
    var_1._id_50D0 = 1;
    waitframe();
    var_1 _meth_805F();
    var_2 = getent( "well_clip_door", "script_noteworthy" );
    var_2.origin = var_2.origin + ( 0, 0, -128 );
    var_2._id_50D0 = 1;
    var_3 = getent( "well_clip_door_ai", "script_noteworthy" );
...
_id_AA07()
{
    ...
    waitframe();
    var_0 _meth_82C1();
    var_1 = getent( "well_clip_door_ai", "script_noteworthy" );
    var_1 _meth_8060();
    var_1 _meth_82C2();
}
...
_id_7856()
{
    var_0 = getent( "pilot_light_trigger", "targetname" );
    var_1 = spawnstruct();
...
_id_7855()
{
    ...
    var_8 = getent( "pilot_light_trigger", "targetname" );

    if ( 0 )
    {
        if ( isdefined( var_8 ) )
        {
            var_9 = getent( "nest_ee_pilot_light_model", "targetname" );
...
_id_A29E()
{
    ...
    var_6 = spawnfx( common_scripts\utility::_id_44F5( "zmb_nest_generator_light_red" ), var_3.origin, anglestoforward( var_3.angles ), anglestoup( var_3.angles ) );
    var_7 = spawnfx( common_scripts\utility::_id_44F5( "zmb_nest_generator_bulb_red" ), var_5.origin, anglestoforward( var_5.angles ), anglestoup( var_5.angles ) );
    triggerfx( var_6, 0.5 );
    triggerfx( var_7, 0.5 );
    common_scripts\utility::_id_3C9F( self._id_819A );
    var_6 delete();
    var_7 delete();
    var_6 = spawnfx( common_scripts\utility::_id_44F5( "zmb_nest_generator_light_green" ), var_3.origin, anglestoforward( var_3.angles ), anglestoup( var_3.angles ) );
    var_7 = spawnfx( common_scripts\utility::_id_44F5( "zmb_nest_generator_bulb_green" ), var_5.origin, anglestoforward( var_5.angles ), anglestoup( var_5.angles ) );
    triggerfx( var_6 );
    triggerfx( var_7 );
}
...
_id_7854()
{
    ...
    if ( !common_scripts\utility::_id_562E( level._id_6659 ) )
    {
        ...
        {
            earthquakes( 0.3, 4, var_3.origin, 850 );
...
_id_9CAB( var_0 )
{
    ...
    if ( !common_scripts\utility::_id_562E( level._id_6659 ) )
    {
        ...
        {
            earthquakes( 0.3, 4, var_4.origin, 850 );
...
_id_848D( var_0 )
{
    ...
    var_1 = getent( "pilot_light_trigger", "targetname" );
...
_id_3C21()
{
    ...
    for (;;)
    {
        ...
        if ( !isplayer( var_1 ) && isagent( var_1 ) && common_scripts\utility::_id_562E( var_1._id_565F ) && !var_1 _id_054D::_id_56E1() )
        {
