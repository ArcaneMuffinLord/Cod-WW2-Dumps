...
_id_9CB8( var_0 )
{
    var_0._id_9CB9 = getent( "electric_trap_origin", "targetname" );
...
_id_8B0D()
{
    ...
    var_1 = spawnfx( level._effect["zmb_med_spike_trap_on"], var_0.origin, anglestoforward( var_0.angles ) );
    triggerfx( var_1 );
...
_id_30E4( var_0 )
{
    while ( self._id_9CB9._id_565F )
    {
        ...
        {
            if ( distance2d( var_3.origin, var_0.origin ) < 135 && var_3.origin[2] < self._id_9CB9.origin[2] )
            {
