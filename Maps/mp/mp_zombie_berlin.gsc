...
sizzler_max_count_manager()
{
    ...
    level.next_sizzler_inc_round = level._id_A980 + randomintrange( 3, 5 );
...
{
    var_0 = getent( "casual_knife_pickup_trig", "targetname" );
    var_1 = getent( "casual_bat_pickup_trig", "targetname" );
    var_2 = getent( "casual_axe_pickup_trig", "targetname" );
    var_3 = getent( "shovel_pickup_trig", "targetname" );
...
{
    var_0 = getent( "airship_wunderbuss_pickup_trig", "targetname" );
