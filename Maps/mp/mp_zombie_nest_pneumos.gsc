...
main()
{
    ...
    var_0 = getent( "pneumo_box_origin", "targetname" );
...
_id_64E1()
{
    ...
    {
        self._id_3A6B = 1;
        self._id_3A68 scriptmodelplayanim( self._id_3A68._id_8109 );
        wait 1.13333;
...
_id_203D()
{
    var_0 = getent( "cage_dialogue", "targetname" );
...
_id_8A0B()
{
    ...
    var_0._id_1E2D = getent( "cage_clip", "targetname" );
    return var_0;
}
...
_id_17B8( var_0 )
{
    ...
    {
        var_0._id_17B7 = newclienthudelem( var_0 );
...
_id_3B66( var_0, var_1 )
{
    ...
    foreach ( var_5 in var_2 )
    {
        ...
        if ( isdefined( var_5.target ) )
            var_5._id_1CB1 = getent( var_5.target, "targetname" );
