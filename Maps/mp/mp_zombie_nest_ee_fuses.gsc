...
_id_785C()
{
    var_0 = getent( "right_hand_of_god_trig", "targetname" );
    ...
    _id_A689();
    var_7 = getent( "rhog_control", "targetname" );
...
_id_9B68( var_0 )
{
    wait 0.25;
    thread _id_9B71();
    earthquakes( 0.5, 5, var_0, 3000, self );
    ...
    earthquakes( 0.3, var_4, var_0, 6000, self );
    playrumblelooponposition( "tank_rumble", self.origin );
    wait( var_4 );
    thread _id_9B71();
    stopallrumbless();
...
_id_9DBC( var_0, var_1 )
{
    ...
    var_4 = getent( "right_hand_of_god_model", "targetname" );
    playfxontag( level._effect["zmb_rhog_on"], var_4, "Tag_Origin" );
...
_id_A689()
{
    ...
    var_2 = getent( "right_hand_of_god_model", "targetname" );
    playfxontag( level._effect["zmb_rhog_init"], var_2, "Tag_Origin" );
}

_id_785D()
{
    var_0 = getent( "rhog_control", "targetname" );
...
_id_7E91( var_0 )
{
    if ( 1 )
    {
        ...
        {
            var_1 = getent( "right_hand_of_god_model", "targetname" );
...
_id_4873( var_0 )
{
    if ( 1 )
    {
        ...
        {
            var_1 = getent( "com_map_frame", "targetname" );
...
_id_4874()
{
    var_0 = getent( "fuse_quest_start_trigger", "targetname" );
...
_id_8624()
{
    ...
    var_3 = getent( "fuses_com_map", "targetname" );
...
_id_864A( var_0 )
{
    ...
    if ( isdefined( var_0 ) )
    {
        if ( self._id_2916 == "off" && var_0 == "red" )
        {
            ...
            wait( getanimlength( var_1["off_to_red"] ) );
        }
        else
        {
            self _meth_83FA( "dial", "to_" + var_0 );
            wait( getanimlength( var_1[var_0] ) );
        }
...
_id_3F28()
{
    var_0 = getent( "power_grid_hint_trig", "targetname" );
...
_id_3875()
{
    ...
    var_0 = [];
    var_1 = "";
    var_2 = getent( "fuses_reset_button", "targetname" );
...
_id_9ED5( var_0 )
{
    ...
    wait( getanimlength( var_1[var_0 - 1] ) );
...
_id_52E4()
{
    ...
    var_1 = getent( "rhog_control", "targetname" );
    ...
    var_3 = getent( "fuse_quest_start_trigger", "targetname" );
    var_3 _meth_80CE( &"ZOMBIE_NEST_OBJECTIVE_OFFLINE" );
    level._id_22F5 = getent( "fuses_reset_button", "targetname" );
    level._id_22F5 _id_856A( undefined, 1 );
    var_4 = getent( "fuses_com_map", "targetname" );
