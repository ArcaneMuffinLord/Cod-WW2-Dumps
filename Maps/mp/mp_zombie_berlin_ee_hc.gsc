...
{
    var_0 = getent( "hc_smuggler_register", "script_noteworthy" );
    var_1 = getent( "hc_smuggler_register_clip_open", "script_noteworthy" );
    var_1 _meth_82C2();
    var_2 = getent( "hc_smuggler_register_trig", "script_noteworthy" );
    var_2 _meth_80B0( var_2 _meth_85A0() | 256 );
    var_3 = getent( "hc_register_date", "script_noteworthy" );
...
hc_quest_bat_step01_generate_code()
{
    ...
    for (;;)
    {
        ...
        var_1 = randomintrange( 1, 9 );
        var_3 = randomintrange( 1, 13 );
        var_0 = var_2 + "" + var_1;
    ...
    var_8 = getent( "hc_register_date", "script_noteworthy" );
...
hc_quest_bat_step02_vo_hole_discovery( var_0 )
{
    ...
    {
        var_2 = getent( "hc_org_smuggler_hole_weapon_place", "script_noteworthy" );
    ...
    {
        var_2 = getent( "hc_bat_trig_use_jolt_drop", "script_noteworthy" );
...
hc_quest_bat_step02_gun_drop_listen()
{
    ...
    var_0 = getent( "hc_bat_trig_use_gun_drop_1", "script_noteworthy" );
    var_1 = undefined;
    ...
    for (;;)
    {
        ...
        var_6 = getent( "hc_org_smuggler_hole_weapon_place", "script_noteworthy" );
...
hc_quest_bat_step02_jolt_drop_listen()
{
    ...
    var_0 = getent( "hc_bat_trig_use_jolt_drop", "script_noteworthy" );
    ...
    var_6 = getent( "hc_smuggler_drop_pod", "script_noteworthy" );
...
{
    var_0 = getent( "hc_bat_dmg_trig_smuggler_door", "script_noteworthy" );
    var_1 = 0;
    ...
    var_5 = getent( "bat_pickup_trigger", "targetname" );
    maps\mp\mp_zombie_berlin_utils::special_melee_weapon_pickup_think( var_5, "bat" );
}

hc_quest_bat_step03_door_open_follower()
{
    var_0 = getent( "hc_bat_smuggler_body", "script_noteworthy" );
    var_0 _meth_805B();
    var_1 = getent( "hc_bat_smuggler_bat", "script_noteworthy" );
    var_1 _meth_805B();
    ...
    var_4 = getent( "hc_bat_smuggler_door", "script_noteworthy" );
    var_5 = getent( "hc_bat_smuggler_door_clip", "script_noteworthy" );
    var_5 _meth_82C2();
    var_5 _meth_8060();
    var_5 _meth_82C1();
...
{
    var_0 = getent( "hc_bat_follower_body", "script_noteworthy" );
    var_0 _meth_805B();
    var_1 = getent( "hc_bat_follower_bat", "script_noteworthy" );
    var_1 _meth_805B();
    var_2 = getent( "hc_bat_smuggler_door", "script_noteworthy" );
    var_3 = getent( "hc_bat_smuggler_door_clip", "script_noteworthy" );
...
{
    var_0 = getent( "bat_pickup_trigger", "targetname" );
...
{
    var_0 = getent( "film_final_location", "targetname" );
    var_1 = getent( "film_start_location", "targetname" );
    var_2 = getent( "film_placed", "targetname" );
    var_3 = getent( "film_pickup_trigger", "targetname" );
    var_4 = getent( "projector_use_trig", "targetname" );
    var_5 = getent( "projector", "targetname" );
    var_6 = getent( "projector_full", "targetname" );
    var_0 _meth_805C();
    var_2 _meth_805C();
    var_6 _meth_805C();
    var_1 _meth_82C3( 1 );
...
hc_quest_dagger_step01_painting()
{
    ...
    var_5 = getent( "apartment_dagger_painting_trig", "targetname" );
    ...
    var_8 = getent( "projector_use_trig", "targetname" );
...
hc_quest_dagger_step01_painting_place_on_projector( var_0, var_1 )
{
    ...
    var_5 = getent( "painting_end_org", "targetname" );
...
{
    var_0 = getent( "projector_damage_trig", "targetname" );
    ...
    var_11 = getent( "projector", "targetname" );
    var_12 = getent( "projector_full", "targetname" );
...
{
    var_0 = getent( "map_projection", "targetname" );
    var_0 _meth_805C();
...
{
    var_0 = getent( "projector_use_trig", "targetname" );
...
hc_quest_dagger_step02_waitfor_node_collection_complete( var_0 )
{
    ...
    playfxontag( level._effect["projection_light"], var_0.tag_org, "tag_origin" );
    ...
    killfxontag( level._effect["projection_light"], var_0.tag_org, "tag_origin" );
}
...
hc_quest_dagger_step02_waitfor_node_collection_additional_fx( var_0 )
{
    ...
    for (;;)
    {
        ...
        if ( var_1 == self )
            playfxontag( level._effect["zmb_hc_bucket_indic"], var_0, "tag_origin" );
...
hc_quest_dagger_safe_get_next_input_difference_gamepad()
{
    ...
    if ( abs( var_0[0] ) < 0.99 && abs( var_0[1] ) < 0.99 )
    {
...
hc_quest_dagger_step03_safe_get_input( var_0, var_1 )
{
    ...
    if ( var_1[0] > 0 && var_1[1] > 0 )
    {
        ...
        var_5 = abs( var_0[0] - var_1[0] );
        var_6 = abs( var_0[1] - var_1[1] );
        var_4 = var_5 + var_6;
    }
...
hc_quest_dagger_step03_safe_update_dial( var_0, var_1 )
{
    ...
    var_8 = 0;
    var_9 = 18;
    var_8 = angleclamp( level.dagger_safe_knob.angles[2] - var_0 * 10 );
...
hc_quest_axe_init()
{
    ...
    var_0 = getent( "hc_ee_axe_scale_sizzler_head", "script_noteworthy" );
    var_1 = getent( "hc_ee_axe_scale_cup", "script_noteworthy" );
    var_2 = getent( "hc_ee_axe_scale_cup_church", "script_noteworthy" );
    var_3 = getent( "hc_ee_axe_scale_needle", "script_noteworthy" );
    var_4 = getent( "map_board_mover_selector", "script_noteworthy" );
    var_0 _meth_805C();
    var_1 _meth_805C();
    var_4 _meth_805C();
...
map_board_update_mover( var_0 )
{
    var_1 = self.origin;
    var_2 = var_1;
    var_3 = getent( "map_board_mover_selector", "script_noteworthy" );
...
hc_quest_axe_map_board_check_solution( var_0, var_1 )
{
    while ( !common_scripts\utility::_id_3C77( "flag_hc_quest_axe_step01_map_location_found" ) )
    {
        ...
        if ( level.mapboard_pos[0] == var_0 && level.mapboard_pos[1] == var_1 )
        {
            ...
            wait 0.5;
            var_2 = getent( "mapboard_lockbox_door", "script_noteworthy" );
...
{
    var_1 = getent( "map_board_take_scale", "script_noteworthy" );
...
{
    var_3 = getent( "scale_use", "script_noteworthy" );
    ...
    var_5 = getent( "hc_ee_axe_scale_soul_collector", "script_noteworthy" );
    ...
    var_6 = getent( "hc_ee_axe_scale_drawer", "script_noteworthy" );
    var_7 = getent( "hc_ee_axe_pickup_axe", "script_noteworthy" );
    var_8 = getent( "hc_ee_axe_origin_mover", "script_noteworthy" );
...
hc_quest_axe_enemykilled_sizzlerneararmor( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8 )
{
    ...
    var_10 = distance2d( var_9[0].origin, self.origin );
    var_11 = var_9[0];
...
sever_head_fx( var_0 )
{
    if ( isdefined( var_0 ) )
    {
        var_0.headfx = spawnfx( common_scripts\utility::_id_44F5( "zmb_ber_hc_ee_armor_head" ), var_0.origin, anglestoforward( var_0.angles ) );
        triggerfx( var_0.headfx );
    }
}
...
{
    var_1 = getent( "script_pickup_map_pin", "script_noteworthy" );
    var_2 = getent( "trigger_use_cabaret_map", "script_noteworthy" );
...
hc_quest_axe_debug_skip_step01b()
{
    hc_quest_axe_debug_skip_step01a();
    common_scripts\utility::flag_set( "flag_hc_quest_axe_step01_map_location_found" );
    var_0 = getent( "mapboard_lockbox_door", "script_noteworthy" );
...
hc_quest_axe_debug_skip_step02()
{
    ...
    common_scripts\utility::flag_set( "flag_hc_quest_axe_step02_obtained_scale_cup" );
    common_scripts\utility::flag_set( "flag_hc_quest_axe_step02_placed_scale_cup" );
    var_0 = getent( "hc_ee_axe_scale_cup", "script_noteworthy" );
    var_1 = getent( "hc_ee_axe_scale_needle", "script_noteworthy" );
    var_0 _meth_805B();
...
hc_quest_finale_init()
{
    ...
    var_0 = getent( "garden_keyhole_placed_sword", "targetname" );
    var_0 _meth_805C();
...
hc_quest_finale_step01_place_weapons_handler()
{
    ...
    var_0 = getent( "garden_keyhole_placed_dagger", "targetname" );
    var_1 = getent( "garden_keyhole_placed_bat", "targetname" );
    var_2 = getent( "garden_keyhole_placed_pickaxe", "targetname" );
...
hc_quest_finale_step02_handler()
{
    ...
    var_3 = getent( "sword_pickup_trig", "targetname" );
...
raven_puzzle_wall_statue_handler( var_0, var_1 )
{
    ...
    var_11 = randomintrange( 1, var_3 ) * var_7;
    var_12 = var_11 * var_2;
    self.angles = self.angles - ( 0, var_12, 0 );
    self.angles = ( 0, angleclamp( self.angles[1] ), 0 );
        ...
        for ( var_4 = 0; var_4 < var_3; var_4++ )
        {
            ...
            if ( var_4 == var_3 * 0.75 )
            {
                if ( isdefined( var_2.current_fx ) )
                    killfxontag( level._effect[var_2.current_fx], var_2, "tag_origin" );

                var_2.current_fx = "crest_charge_100";
                playfxontag( level._effect[var_2.current_fx], var_2, "tag_origin" );
                continue;
            }
...
raven_puzzle_wall_statue_play_trigger_fx( var_0 )
{
    if ( isdefined( var_0.current_fx ) )
        killfxontag( level._effect[var_0.current_fx], var_0, "tag_origin" );

    var_0.origin = ( var_0.origin[0], var_0.origin[1], self.origin[2] + var_0.start_offset );
    var_0.current_fx = "crest_charge_detonate";
    playfxontag( level._effect[var_0.current_fx], var_0, "tag_origin" );
}
...
raven_puzzle_wall_statue_apply_angle_offset( var_0, var_1 )
{
    ...
    {
        var_4 = angleclamp( self.angles[1] - var_1 );
...
raven_puzzle_check_completion( var_0, var_1, var_2, var_3 )
{
    ...
    iprintlnbold( var_2 + " flag set! YOU DID IT!" );
...
hc_quest_finale_step02_statue_puzzle_reset_bird_fx( var_0 )
{
    ...
    playfxontag( level._effect["statue_bolt"], var_1, "tag_origin" );
...
hc_quest_finale_step02_statue_puzzle_play_fail_fx_on_bird( var_0 )
{
    ...
    var_1 setmodel( "tag_origin" );
    playfxontag( level._effect["statue_light_white"], var_1, "tag_origin" );
    wait( var_0 / 2 );
    stopfxontag( level._effect["statue_light_white"], var_1, "tag_origin" );
    playfxontag( level._effect["statue_light_red"], var_1, "tag_origin" );
    iprintlnbold( "Incorrect!" );
    wait( var_0 / 2 );
    stopfxontag( level._effect["statue_light_red"], var_1, "tag_origin" );
...
hc_quest_finale_step02_statue_puzzle_play_crumble_fx()
{
    ...
    wait 0.7;
    var_0 = getent( "bird_statue_sword_bit", "targetname" );
    var_0 delete();
}
...
hc_quest_finale_step02_statue_puzzle_play_pass_fx_on_bird( var_0 )
{
    ...
    wait( var_0 );
    stopfxontag( level._effect["statue_light_white"], var_1, "tag_origin" );
    playfxontag( level._effect["statue_light_green"], var_1, "tag_origin" );
...
hc_quest_finale_step02_statue_puzzle_player_place_bird()
{
    ...
    while ( !var_0 )
    {
        ...
        while ( distance2d( self.origin, level.bird_data["statue"].origin ) <= 125 )
        {
            ...
            foreach ( var_5 in var_2 )
            {
                if ( common_scripts\utility::within_fov( self geteye(), self.angles, var_5.origin, cos( 25 ) ) )
                {
                    var_3 = var_5;
                    break;
                }
...
{
    var_3 = getent( "garden_door_" + var_0 + "_keyhole", "targetname" );
    var_4 = getent( "garden_keyhole_placed_" + var_0, "targetname" );
    var_4 _meth_805C();
    var_5 = 0;
...
{
    var_1 = getent( "hc_finale_gate_l", "targetname" );
    var_2 = getent( "hc_finale_gate_clip_l", "targetname" );
    var_3 = getent( "hc_finale_gate_l_org", "targetname" );
    var_1 linktosynchronizedparent( var_3 );
    var_2 linktosynchronizedparent( var_3 );
    var_4 = getent( "hc_finale_gate_r", "targetname" );
    var_5 = getent( "hc_finale_gate_clip_r", "targetname" );
    var_6 = getent( "hc_finale_gate_r_org", "targetname" );
...
hc_quest_finale_utility_close_doors()
{
    var_0 = getent( "hc_finale_gate_l", "targetname" );
    var_1 = getent( "hc_finale_gate_clip_l", "targetname" );
    var_2 = getent( "hc_finale_gate_l_org", "targetname" );
    var_0 linktosynchronizedparent( var_2 );
    var_1 linktosynchronizedparent( var_2 );
    var_3 = getent( "hc_finale_gate_r", "targetname" );
    var_4 = getent( "hc_finale_gate_clip_r", "targetname" );
    var_5 = getent( "hc_finale_gate_r_org", "targetname" );
...
hat_spawn()
{
    ...
    var_3 = getent( "hat_1_trig", "targetname" );
...
hat_spawn_2()
{
    ...
    var_2.angles = var_1.angles;
    var_3 = getent( "hat_2_trig", "targetname" );
    var_3.origin = var_1.origin;
    var_3 common_scripts\utility::_id_9DA3();
...
hat_spawn_3()
{
    ...
    var_2.angles = var_1.angles;
    var_3 = getent( "hat_3_trig", "targetname" );
    var_3.origin = var_1.origin;
    var_3 common_scripts\utility::_id_9DA3();
...
hat_spawn_4()
{
    ...
    var_2.angles = var_1.angles;
    var_3 = getent( "hat_4_trig", "targetname" );
    var_3.origin = var_1.origin;
    var_3 common_scripts\utility::_id_9DA3();
...
hat_spawn_5()
{
    ...
    var_2.angles = var_1.angles;
    var_3 = getent( "hat_5_trig", "targetname" );
    var_3.origin = var_1.origin;
    var_3 common_scripts\utility::_id_9DA3();
...
hat_stacker()
{
    ...
    var_0 = getent( "hatrack_trig_new", "targetname" );
