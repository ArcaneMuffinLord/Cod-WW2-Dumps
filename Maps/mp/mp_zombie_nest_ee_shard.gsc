...
_id_786A()
{
    if ( 1 )
    {
        var_0 = getent( "nest_ee_shard_intro_start_trig", "targetname" );
        var_1 = getent( "hilt_altar_model", "targetname" );
        ...
        if ( isdefined( var_0 ) )
        {
            ...
            var_4 = getent( "hilt_control", "targetname" );
...
_id_784E()
{
    playfxontag( level._effect["zmb_gk_hilt_init"], level._id_3571, "TAG_FX" );
    ...
    playfxontag( level._effect["zmb_geistkraft_radius_400"], var_2, "tag_origin" );
    ...
    killfxontag( level._effect["zmb_geistkraft_radius_400"], var_2, "tag_origin" );
    var_2 delete();
    playfxontag( level._effect["zmb_gk_hilt"], level._id_3576, "TAG_FX" );
    thread _id_089D();
...
_id_7866()
{
    ...
    if ( !common_scripts\utility::_id_3C77( "flag_com_valve_turned" ) )
    {
        ...
        if ( 0 )
        {
            var_0 = getent( "shard_valve", "targetname" );
...
_id_202A()
{
    var_0 = getanimlength( %s2_zom_shroud_lift_active );
    wait( var_0 - 0.2 );
}

_id_2029()
{
    var_0 = getanimlength( %s2_zom_shroud_lift_2 );
...
_id_202B()
{
    var_0 = getanimlength( %s2_zom_shroud_lift_rise_active );
...
_id_2718()
{
    var_0 = getnotetracktimes( %s2_zom_shroud_cover_lift_open, "actually_start_open" );
    var_1 = var_0[0];
...
_id_2022( var_0 )
{
    switch ( var_0 )
    {
        ...
        case "camera_shake":
            ...
            var_3 = self.origin;
            var_4 = 200;
            earthquakes( var_1, var_2, var_3, var_4 );
            break;
...
_id_52EA()
{
    ...
    var_0 = getent( "shard_valve_light", "targetname" );

    if ( isdefined( var_0 ) )
        var_0 thread _id_2021();

    var_1 = getent( "hilt_control", "targetname" );
...
_id_2E79()
{
    ...
    var_0 = getent( "hilt_altar_model", "targetname" );
    var_0 _meth_82C3( 1 );
