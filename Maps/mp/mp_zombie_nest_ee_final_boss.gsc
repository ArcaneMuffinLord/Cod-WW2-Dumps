...
_id_785A()
{
    ...
    else
    {
        ...
        if ( 1 )
        {
            var_4 = getent( "hilt_altar_model", "targetname" );
...
_id_785B()
{
    ...
    var_3 = getent( "hilt_altar_model", "targetname" );
...
_id_8A0A()
{
    self._id_3ACE = getent( "brute_boss_agent_interact", "targetname" );
...
{
    wait 3.5;
    playfxontag( level._effect["zmb_klaus_fire_hide"], level._id_5A89, "TAG_ORIGIN" );
}
...
_id_9C7A( var_0, var_1, var_2, var_3 )
{
    ...
    var_4 = getanimlength( var_0 ) * ( var_3[var_2 + 1]["time"] - var_3[var_2]["time"] );
...
_id_5CCA( var_0 )
{
    ...
    foreach ( var_8 in var_1 )
    {
        ...
        {
            var_8._id_3BBC = spawnfx( common_scripts\utility::_id_44F5( "zmb_brute_debris_fire_01" ), var_8.origin, var_10 );
            triggerfx( var_8._id_3BBC );
        }
    }
    ...
    var_14 = getent( "brute_debris_floor_clip", "targetname" );
    var_14 _meth_82C1();
    var_14 _meth_8060();
    ...
    var_18 = getent( "brute_exit_blocker_tower_path", "targetname" );
    var_18 _meth_805C();
    var_14 _meth_82C2();
}
...
_id_AA09()
{
    ...
    foreach ( var_2 in var_0 )
    {
        ...
        if ( var_2.model == "zmb_brute_debris_01" )
        {
            ...
            var_2._id_3BBC = spawnfx( common_scripts\utility::_id_44F5( "zmb_brute_debris_fire_02" ), var_2.origin, var_4 );
            triggerfx( var_2._id_3BBC );
        }
    }
}
...
_id_1CB7()
{
    var_0 = getent( "brute_debris_floor_clip", "targetname" );
    var_0 _meth_82C1();
    var_0 _meth_8060();
}
