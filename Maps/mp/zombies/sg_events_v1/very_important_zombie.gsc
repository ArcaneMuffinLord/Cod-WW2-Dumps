...
get_player_push_nodes( var_0, var_1 )
{
    ...
    {
        var_6 = var_6 + var_2;
        var_8 = _func_2E1( vectorlerp( var_0.origin, var_1.origin, var_6 / var_5 ), self );
...
pushplayervib()
{
    ...
    for (;;)
    {
        ...
        {
            if ( var_6 istouching( self ) || distance2d( var_6.origin, var_4 ) < var_2 && abs( var_6.origin[2] - var_4[2] ) < 64 )
            {
