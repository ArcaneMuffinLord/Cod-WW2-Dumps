...
basic_extermination_run( var_0 )
{
    ...
    if ( isdefined( var_1._id_2A35 ) )
    {
        ...
        {
            if ( isarray( var_1._id_2A35.ext_type ) )
            {
                if ( isarray( var_1._id_2A35.ext_type[0] ) )
...
objective_extermination_sizzler_handler()
{
    ...
    for (;;)
    {
        ...
        if ( level.current_sizz < level.max_sizzlers )
        {
            ...
            {
                if ( !isagent( var_4 ) || !isalive( var_4 ) || var_4 _meth_85A5() != "zombie_animclass" || common_scripts\utility::_id_562E( var_4.transformingtosizzler ) )
...
try_to_become_a_sizzler( var_0 )
{
    ...
    if ( !_id_0547::_id_5565( var_1._id_0A4B, "zombie_generic" ) || !isagent( var_1 ) || !isalive( var_1 ) || var_1 _meth_85A5() != "zombie_animclass" || common_scripts\utility::_id_562E( var_1.transformingtosizzler ) )
        return 0;
...
_id_5D67( var_0 )
{
    ...
    playfxontag( level._effect["zmb_wm_lightning_impact_base_rnr"], var_3, "tag_origin" );
