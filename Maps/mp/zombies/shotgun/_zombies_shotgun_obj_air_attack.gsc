...
air_attack_wave_handler()
{
    ...
    while ( !common_scripts\utility::_id_3C77( "flag_players_have_won" ) )
    {
        ...
        switch ( var_1 )
        {
            case 1:
                air_attack_adjust_rules();
                level.wave_a = getvehiclenodearray( "plane_start_node_a", "targetname" );
                var_2 = level.wave_a air_attack_spawn_plane_wave();
                break;
            case 2:
                air_attack_adjust_rules();
                level.wave_b = getvehiclenodearray( "plane_start_node_b", "targetname" );
                var_2 = level.wave_b air_attack_spawn_plane_wave();
                break;
            case 3:
                air_attack_adjust_rules();
                level.wave_c = getvehiclenodearray( "plane_start_node_c", "targetname" );
                var_2 = level.wave_c air_attack_spawn_plane_wave();
                break;
            case 4:
                air_attack_adjust_rules();
                level.wave_d = getvehiclenodearray( "plane_start_node_d", "targetname" );
...
{
    self endon( "death" );
    var_0 = getent( "vol_plane_damage_area", "targetname" );
    ...
    while ( common_scripts\utility::_id_3794( "turret_on" ) )
    {
        ...
        if ( isdefined( var_5["position"] ) )
        {
            ...
            var_7 = sortbydistance( var_7, var_6, var_4, 1 );

            foreach ( var_9 in var_7 )
            {
                if ( bullettracepassed( var_6 + ( 0, 0, 25 ), var_9 geteye(), 0 ) )
                    var_9 _meth_8059( 80, self.origin );
            }

            var_11 = sortbydistance( level.players, var_6, var_4, 1 );

            foreach ( var_13 in var_11 )
            {
                if ( bullettracepassed( var_6 + ( 0, 0, 25 ), var_13.origin, 0 ) || bullettracepassed( var_6 + ( 0, 0, 25 ), var_13 gettagorigin( "j_spine4" ), 0 ) || bullettracepassed( var_6 + ( 0, 0, 25 ), var_13 geteye(), 0 ) )
                {
...
plane_gun_think()
{
    ...
    while ( common_scripts\utility::_id_3794( "turret_on" ) )
    {
        playfxontag( common_scripts\utility::_id_44F5( "zmb_isl_enemy_plane_tracer" ), self, "TAG_MUZZLE_FX_1" );
        playfxontag( common_scripts\utility::_id_44F5( "zmb_isl_enemy_plane_tracer" ), self, "TAG_MUZZLE_FX_2" );
        wait 0.2;
    }
}
...
plane_crashy()
{
    ...
    if ( !isdefined( self._id_272B ) || self._id_272B == 0 )
    {
        ...
        {
            var_1 = randomfloatrange( -90, 90 );
            var_2 = ( 0, cos( var_1 ), sin( var_1 ) );
            var_3 = ( randomfloatrange( -1000, 1000 ), randomfloatrange( -1000, 1000 ), randomfloatrange( -1000, 1000 ) );
            var_4 = 1.2;
            self _meth_8224( level.player.origin + var_3, self _meth_8283() * var_4, var_2 );
        }

        common_scripts\utility::waittill_notify_or_timeout( "veh_collision", randomfloatrange( 0.5, 3.0 ) );
    }
...
plane_wait_for_valid_crash_path()
{
    ...
    for (;;)
    {
        ...
        {
            var_0 = getvehiclenodearray( self._id_2944.script_exploder, "script_linkname" );
...
plane_flak_projectile_zombie_proximity_detonate( var_0, var_1 )
{
    ...
    for (;;)
    {
        if ( isdefined( var_3 ) && distance2d( var_3 geteye(), var_0.origin ) < var_2 && abs( var_0.origin[2] - var_3.origin[2] ) < 120 )
        {
            var_1 _id_04C7::_id_A102( "standard" );
...
plane_goto_linkto_path( var_0 )
{
    ...
    if ( isdefined( var_0 ) && isdefined( var_0.script_exploder ) )
    {
        var_1 = getvehiclenodearray( var_0.script_exploder, "script_linkname" );
...
aud_plane_damage_player()
{
    ...
    {
        wait 0.1;
        var_1 = var_0.origin + ( randomintrange( 25, 50 ), randomintrange( 25, 50 ), var_0.origin[2] );
