...
blimp_init()
{
    level._id_179A = getent( "obj_blimp", "targetname" );
...
{
    self.battery = getent( var_0, "targetname" );
...
blimp_wait_for_anim_finished( var_0 )
{
    var_1 = getanimlength( blimp_string_to_anim( var_0 ) );
    wait( var_1 );
}
...
weakpoint_open_doors( var_0, var_1 )
{
    ...
    wait( getanimlength( var_2["zom_zeppelin_panels_01_open"] ) );
    ...
    for (;;)
    {
        ...
        if ( common_scripts\utility::_id_562E( level._id_179A._id_1F8D ) )
        {
            ...
            while ( isalive( var_2 ) )
            {
                ...
                var_14 = abs( var_13["position"][2] - var_2.origin[2] );
            ...
            playfxontag( common_scripts\utility::_id_44F5( "zmb_zeppelin_shot_charge" ), level._id_179A.blimp_turret, "TAG_YAW" );
            playfxontag( common_scripts\utility::_id_44F5( "zmb_zeppelin_shot_charge_barrel" ), level._id_179A.blimp_turret, "TAG_AIM" );
            ...
            playfxontag( level._effect["zmb_zeppelin_spotlight_assault"], var_18, "tag_origin" );
            playfxontag( level._effect["zmb_zeppelin_shot"], var_15, "tag_origin" );
            wait 1;
            stopfxontag( level._effect["zmb_zeppelin_spotlight_assault"], var_18, "tag_origin" );
            turret_start_firing();
    ...
    for (;;)
    {
        ...
        if ( common_scripts\utility::_id_562E( self._id_1F1F ) )
        {
            ...
            foreach ( var_7 in self.rocket_bays )
            {
                ...
                var_12 = bullettracepassed( var_11, var_10, 0, var_7 );
                var_13 = bullettracepassed( var_10, var_11, 0, var_7 );
