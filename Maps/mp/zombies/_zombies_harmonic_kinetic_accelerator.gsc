...
set_orbiters( var_0 )
{
    ...
    foreach ( var_4 in var_1._id_21F6 )
        stopfxontag( common_scripts\utility::_id_44F5( "proj_trail_white" ), var_4, "tag_origin" );
...
reset_fx()
{
    ...
    foreach ( var_2 in var_0._id_21F6 )
        playfxontag( common_scripts\utility::_id_44F5( "proj_trail_white" ), var_2, "tag_origin" );
}
...
launchplayers( var_0 )
{
    ...
    for (;;)
    {
        ...
        triggerfx( var_1.launchpadfx[var_0._id_82EC] );
...
magnitude( var_0 )
{
    return sqrt( squared( var_0[0] ) + squared( var_0[1] ) + squared( var_0[2] ) );
}
