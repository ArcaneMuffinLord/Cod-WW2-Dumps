...
watch_for_grab()
{
    ...
    for (;;)
    {
        ...
        if ( distance2d( var_0.origin, var_1[0].origin ) > 70 )
            continue;
    ...
    for (;;)
    {
        ...
        foreach ( var_2 in level.grenades_in_orbit )
        {
            ...
            foreach ( var_4 in level.grenades_in_orbit )
            {
                ...
                if ( var_4 != var_2 && distance2d( var_4.origin, var_2.origin ) < 60 )
                {
...
watch_for_grenades_and_projectiles( var_0 )
{
    ...
    for (;;)
    {
        ...
        if ( abs( self.origin[2] - var_4[2] ) > 60 || distance2d( var_6.origin, var_4 ) > var_3 )
        {
