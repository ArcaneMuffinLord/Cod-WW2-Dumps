...
spawn_an_aod()
{
    ...
    foreach ( var_2 in level.players )
    {
        ...
        if ( distance2d( var_0, var_2.origin ) < 265 && abs( self.origin[2] - var_2.origin[2] ) < 128 )
        {
            var_3 = 3 * ( distance2d( var_0, var_2.origin ) / 265 );
            var_4 = 4 * ( distance2d( var_0, var_2.origin ) / 265 );
            var_2 thread run_shellshock( var_4, var_3, self.origin );
            level notify( "survivalist_blood_2_type_2_failed" );
        }

        if ( distance2d( var_0, var_2.origin ) > 185 || abs( self.origin[2] - var_2.origin[2] ) > 128 )
            continue;
...
set_new_assassin_origin( var_0 )
{
    ...
    set_assassin_has_teleported();
    playfxontag( common_scripts\utility::_id_44F5( "zmb_isl_assassin_spawn_wisp01" ), self, "TAG_ORIGIN" );
...
dodamageonjoints( var_0, var_1, var_2 )
{
    ...
    for (;;)
    {
        ...
        foreach ( var_5 in var_0 )
        {
            ...
            {
                var_9 = distance2d( var_8.origin, var_6 );
                var_10 = abs( var_8.origin[2] - var_6[2] );
