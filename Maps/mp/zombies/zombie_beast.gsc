...
init()
{
    ...
    level._effect["zmb_ber_bob_smk_cloud_lp"] = loadfx( "vfx/map/mp_zombie_berlin/zmb_ber_bob_smk_cloud_sml_lp" );
    ...
    var_0._id_4C12 = 1;
    var_0.overridehealth = int( bob_health_scale_per_num_players() * 525000 );
    var_0._id_60E2 = 65;
    var_0._id_8302 = 85;
    var_0._id_8303 = 15;
...
init_bob_health()
{
    self.health = int( bob_health_scale_per_num_players() * 525000 );
    self.phase2health = int( self.health * 0.6 );
    self.phase3health = int( self.health * 0.3 );
    self.allow_non_engine_hits = 1;
...
zombie_bob_do_charge()
{
    ...
    _id_0378::_id_8D74( "dlc3_bob_engine", "bob_engine_rev" );
    level._id_5B1B = gettime();
...
zombie_bob_sizzle_think()
{
    ...
    {
        _id_0378::_id_8D74( "dlc3_bob_stab_leg" );
...
zombie_bob_smoke_think()
{
    ...
    if ( self.health <= 1 )
    {
        _id_0378::_id_8D74( "dlc3_bob_engine", "bob_killed" );
        ...
        maps\mp\agents\humanoid\_humanoid_util::_id_8318( self.origin, self.angles, var_5, undefined, 0, undefined, 1 );
        return 1;
    }
    ...
    {
        _id_0378::_id_8D74( "dlc3_bob_stab_leg" );
        var_3 = "bob_stand_powerup";
        var_4 = self [[ maps\mp\agents\_agent_utility::_id_0A59( "get_action_params" ) ]]();
        var_5 = maps\mp\agents\_scripted_agent_anim_util::_id_087C( var_3, var_4 );
        maps\mp\agents\humanoid\_humanoid_util::_id_8318( self.origin, self.angles, var_5, 2, 0, undefined, 1 );
        self.nextsmoketime = gettime() + var_6 * 1000;
        self.enterednewphase = undefined;
    }
...
zombie_bob_is_dead()
{
    ...
    self notify( "bob_stop_engine_pulse" );
    self.zmdemigod = 0;
    self.zombie_bob_vulnerable_double_damage = 1;
    self.smoke_damage = 1;
...
zombie_bob_think()
{
    ...
    common_scripts\utility::_id_3799( "bob_was_koed" );
    self.zombie_bob_vulnerable_double_damage = 0;
    init_bob_health();
    self.shortstun = 1;
...
set_bob_phase( var_0 )
{
    ...
    _id_0378::_id_8D74( "dlc3_bob_engine", var_0 );
...
zombie_bob_on_damaged( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10 )
{
    ...
    if ( var_5 != "wunderbuss_zm" )
    {
        ...
        if ( distancesquared( var_11, var_6 ) > 256 )
            var_2 = int( var_2 * 0.85 );

        if ( !isdefined( self.lastmetalhit ) )
            self.lastmetalhit = gettime();

        if ( gettime() - self.lastmetalhit > 350 )
        {
            self.lastmetalhit = gettime();
    ...
    if ( !self.zombie_bob_vulnerable_double_damage && !isdefined( self.smoke_damage ) )
        var_2 = var_2 * 2;
...
zombie_bob_infect_zombies()
{
    ...
    childthread zombie_bob_throw_grenades();
    maps\mp\agents\humanoid\_humanoid_util::_id_8318( self.origin, self.angles, var_2, undefined, 0, undefined, 1 );
}

zombie_bob_throw_grenades()
{
    self endon( "death" );
    var_0 = get_beast_grenade_launch_origin();
    var_1 = common_scripts\utility::_id_4461( self.origin, level.players, 400 );

    if ( !isdefined( var_1 ) )
        var_1 = common_scripts\utility::_id_4461( self.origin, _id_0547::_id_4090( "zombie_fodder" ), 400 );

    var_2 = 3;
    wait 1.6;
    _id_0378::_id_8D74( "dlc3_bob_throw_grenade", var_0 );

    if ( isdefined( self.max_sizzler_count ) )
        var_3 = self.max_sizzler_count;
    else
        var_3 = 0;
    ...
    for ( var_4 = 0; var_4 < var_2; var_4++ )
    {
        ...
        if ( var_4 == 1 )
        {
            ...
            {
                if ( maps\mp\_utility::_id_3B8E( self, var_7, 100 ) )
                {
                    if ( var_7 maps\mp\zombies\sg_events_v1\extermination::try_to_become_a_sizzler( 1 ) )
                        var_5++;
                }
        ...
        var_0 = get_beast_grenade_launch_origin();
        var_9 = get_beast_grenade_launch_volicty( var_0, var_1.origin );
        magicgrenademanual( "semtex_beast_zm", var_0, var_9, 2, self );
        wait 0.2;
    }
}

get_beast_grenade_launch_origin()
{
    return self gettagorigin( "TAG_FX_GUN" ) + 4 * vectornormalize( anglestoforward( self _meth_8181( "TAG_FX_GUN" ) ) );
}

get_beast_grenade_launch_volicty( var_0, var_1 )
{
    return 1200 * vectornormalize( var_1 - var_0 );
}
...
zombie_bob_smoke_atk_cloud_damage( var_0 )
{
    ...
    for ( var_1 = 25; var_1 > 0; var_1 = var_1 - 0.05 )
    {
        ...
        {
            if ( distance2d( var_3.origin, var_0 ) < 60 )
...
zombie_bob_smoke_listen_for_damage( var_0, var_1 )
{
    ...
    for (;;)
    {
        ...
        if ( distance2d( var_0.origin, var_1 ) < 72.0 )
        {
            playfxontag( level._effect["zmb_ber_bob_smk_dmg"], var_0, "Engine" );
...
zombie_bob_smoke_atk_spawn_hit_volumes( var_0, var_1 )
{
    var_2 = 2;
    wait( var_2 );
    var_3 = getent( "bob_smoke_collision", "targetname" );
    var_4 = undefined;
    ...
    var_5 = getent( "bob_smoke_trigger_damage", "targetname" );
    var_6 = undefined;
...
{
    var_0 _id_0378::_id_8D74( "dlc3_bob_engine", "bob_engine_rev" );
    var_0 _id_0378::_id_8D74( "dlc3_bob_smoke_attack_strt" );
    wait 2;
    var_1 = anglestoforward( var_0.angles );
    var_2 = anglestoup( var_0.angles );
    var_3 = var_0.origin;
    var_4 = spawnfx( level._effect["zmb_ber_bob_smk_cloud_lp"], var_3, var_1, var_2 );
    _id_0378::_id_8D74( "dlc3_bob_smoke_attack_loop", 25, var_3 );
    triggerfx( var_4 );
    ...
    for ( var_3 = int( 3.33333 ); var_3; var_3 = var_3 - 1 )
    {
        ...
        foreach ( var_10 in var_1 )
        {
            ...
            if ( var_11 == "zombie_animclass" && var_2 )
            {
                ...
                _id_0378::_id_8D74( "dlc3_bob_shoot_gun", var_5 );
                var_2--;
            }
        }
        ...
        if ( !isdefined( var_4 ) )
        {
            ...
            var_4 = playfxontag( level._effect["zmb_ber_bob_beam_wv"], self, "TAG_FX_GUN" );
            _id_0378::_id_8D74( "dlc3_bob_shoot_gun", var_5 );
        }
...
{
    var_3 = max( self.health, self.maxhealth );
