...
{
    _id_0547::_id_A78B();
    var_1 = getgroundposition( var_0.origin + ( 0, 0, 50 ), 1 );
...
zm_care_spawn_toggle_fx( var_0, var_1, var_2 )
{
    if ( !isdefined( var_1 ) )
    {
        ...
        {
            if ( distance2d( var_6.origin, var_2.origin ) < 250 )
    ...
    {
        var_8 = getgroundposition( var_1.origin + ( 0, 0, 50 ), 1 );
...
unresolved_collision_nearest_node_carepackage( var_0 )
{
    ...
    for (;;)
    {
        ...
        if ( positionwouldtelefrag( var_4 ) )
        {
            waitframe();
            continue;
        }
