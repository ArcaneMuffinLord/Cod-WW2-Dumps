    ...
    for (;;)
    {
        ...
        if ( var_0.not_over_zombie_limit && var_0.wave_isnt_over && var_0.is_in_player_zone && var_0.is_in_recently_enabled_zone && level._id_A980 != 0 && level._id_7F2A != "zombie_dog" && level.vignette_cooldown_current <= 0 && var_0.limit_not_reached && var_0.radial_cooldown_is_safe && var_0.players_not_seen_for_time && var_0.req_zombs_remaining )
        {
            ...
            foreach ( var_13 in level.players )
            {
                ...
                var_15 = common_scripts\utility::within_fov( var_13 geteye(), var_13.angles, var_7, cos( 32.5 ) );
                var_16 = distance( var_7, var_13.origin ) < var_2;
                var_17 = distance( var_7, var_13.origin ) < level.vignette_min_dist;
                var_18 = 0;

                if ( abs( var_13.origin[2] - self.origin[2] ) < 150 )
                    var_18 = 1;
                ...
                var_19 = common_scripts\utility::within_fov( self.origin, self.angles + ( 0, var_14, 0 ), var_13.origin, cos( 60 ) );
                var_20 = 1;
...
vignette_run( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7 )
{
    ...
    if ( isdefined( var_7 ) && isalive( var_10 ) )
    {
        ...
        var_14 = getstartorigin( self.origin, self.angles, var_13 );
        var_15 = getstartangles( self.origin, self.angles, var_13 );
...
vignette_execute_paired_scene( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    var_7 = getstartorigin( self.origin, self.angles, var_6 );
    var_8 = getstartangles( self.origin, self.angles, var_6 );
    ...
    var_12 = getstartorigin( self.origin, self.angles, var_11 );
    var_13 = getstartangles( self.origin, self.angles, var_11 );
    var_14 = undefined;

    if ( var_4 )
        var_14 = randomfloatrange( level.vignette_loop_min_timeout, level.vignette_loop_max_timeout );
...
vignette_monitor_last_seen()
{
    ...
    for (;;)
    {
        ...
        {
            var_4 = common_scripts\utility::within_fov( var_3 geteye(), var_3.angles, var_0.origin, cos( 32.5 ) );
            var_5 = var_4 && sighttracepassed( var_3 geteye(), var_0.origin + ( 0, 0, 36 ), 0, 0 );
