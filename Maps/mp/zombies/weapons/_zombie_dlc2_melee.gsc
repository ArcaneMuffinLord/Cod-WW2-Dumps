...
delayed_bat_hit( var_0, var_1 )
{
    ...
    playfxontag( level._effect["zmb_bat_long_hit_crit_blood"], var_0, "TAG_EYE" );
...
bat_hc_blast_think( var_0 )
{
    ...
    playfxontag( common_scripts\utility::_id_44F5( "zmb_hc_bat_aoe_fx" ), var_0, "tag_origin" );
...
bat_hc_blast_watch_collision( var_0 )
{
    ...
    for (;;)
    {
        ...
        if ( isdefined( var_1.team ) && !isenemyteam( var_0.player.team, var_1.team ) )
            continue;
