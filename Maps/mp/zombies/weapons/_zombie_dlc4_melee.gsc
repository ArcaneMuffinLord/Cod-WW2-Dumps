...
raven_thrown_max_ammo_func( var_0 )
{
    ...
    {
        var_1 = weaponclipsize( self._dlc4_weapon_manager["stored_lethal"], self );
    ...
    {
        var_1 = weaponclipsize( self._dlc4_weapon_manager["stored_tactical"], self );
...
pickup_override_think( var_0 )
{
    ...
    while ( isdefined( var_0.wep._id_9D65 ) )
    {
        if ( var_1 usebuttonpressed() && distance2d( var_1.origin, var_0.wep.origin ) <= var_5 )
        {
            if ( var_2 == 0 )
            {
                var_2 = 1;
...
raven_track_weapon_pos( var_0 )
{
    ...
    {
        var_2 = getgroundposition( self.origin, 12, 36, 12 );
...
delayed_shield_hit( var_0, var_1 )
{
    ...
    playfxontag( level._effect["zmb_giestkraft_impact"], var_0, "J_Spine4" );
        ...
        if ( shield_emp_uber_conditions() && isdefined( level.obj_shield ) )
        {
            ...
            if ( isdefined( self.reserved_plate ) && !isdefined( self.blood_shield_uber_fx ) )
            {
                ...
                while ( !shield_timeout_reached() && has_shield_emp() )
                {
                    ...
                    {
                        if ( distance2d( var_1.origin, level.obj_shield.origin ) < 100 )
...
shield_push_run( var_0 )
{
    ...
    playfxontag( common_scripts\utility::_id_44F5( "zmb_raven_sword_barb_burst" ), var_1, "tag_origin" );
...
shield_push_handle_collision( var_0 )
{
    ...
    for (;;)
    {
        ...
        if ( lengthsquared( var_10 ) < var_7 )
            break;

        var_11 = vectortoyaw( var_10 );
        var_12 = abs( angleclamp180( var_11 - var_8 ) );
...
shield_push_zombie_impact_damage( var_0, var_1, var_2 )
{
    ...
    {
        var_3 = var_1.angles;
        var_3 = ( var_3[0], angleclamp180( var_3[1] + 10 + 1 ), var_3[2] );
        var_1.angles = var_3;
    }
...
solve_yaw_for_shield_push_anim( var_0, var_1, var_2 )
{
    ...
    return angleclamp180( var_2 - var_5[1] );
}
...
delayed_hammer_hit( var_0, var_1 )
{
    ...
    playfxontag( level._effect["zmb_hammer_smack"], var_0, "TAG_EYE" );
...
handle_hammer_grenade( var_0 )
{
    ...
    playfxontag( level._effect["zmb_stormhammer_trail"], var_1, "Tag_Weapon" );
    ...
    while ( _id_0547::_id_5565( var_1.inflight, 1 ) && vectordot( var_5 - var_1.tag_tracker.origin, var_10 ) > 0 )
    {
        ...
        if ( var_1.isarmed )
        {
            if ( !isagent( var_1.htarget ) || !isalive( var_1.htarget ) || distancesquared( var_1.htarget.origin, var_5 ) > distancesquared( var_1.origin, var_5 ) )
            {
...
{
    if ( !bullettracepassed( self.origin, var_0, 0, self ) )
    {
...
hammer_detonate_attack( var_0, var_1 )
{
    ...
    var_3 = _id_0547::_id_408F();
    var_3 = sortbydistance( var_3, var_0, 92 );
    ...
    waitframe();
    physicsexplosionsphere( var_0, 128, 50, 3.5 );
}
...
hammer_throw_take_grenade()
{
    ...
    else
    {
        ...
        self _meth_8349( var_0 );
        var_1 = weaponclipsize( var_0, self );
...
delayed_hammer_emp_hit( var_0, var_1 )
{
    ...
    if ( var_0._id_0A4B == "zombie_king" )
        playfxontag( level._effect["zmb_storm_hmr_godking_stun"], var_0, "TAG_ORIGIN" );
    else
        playfxontag( level._effect["zmb_storm_hmr_zmb_stun"], var_0, "TAG_ORIGIN" );
...
moonorb_active_think( var_0 )
{
    ...
    while ( isdefined( var_1 ) )
    {
        ...
        if ( _id_0547::_id_5565( var_10, "missile_stuck" ) || _id_0547::_id_5565( var_10, "moonorb_near_orrery" ) )
        {
            ...
            if ( isdefined( var_9[1] ) && isagent( var_9[1] ) && var_9[1].health > 0 )
            {
                var_3 = var_9[1];
            ...
            if ( isdefined( var_7 ) && isplayer( var_7 ) )
            {
                if ( _id_0547::_id_5565( var_0, 1 ) )
                {
                    if ( isdefined( var_9[1] ) && isagent( var_9[1] ) && !common_scripts\utility::_id_562E( var_7.has_shown_spike_emp_control_hint ) )
                    {
        ...
        if ( _id_0547::_id_5565( var_0, 1 ) && ( _id_0547::_id_5565( var_10, "orb_control_request" ) || _id_0547::_id_5565( var_10, "orb_stagnate_timeout" ) ) )
        {
            ...
            var_15 = sortbydistance( var_15, var_1.origin, 128, 1 );
...
moonorb_safe_vol_track()
{
    ...
    for (;;)
    {
        ...
        foreach ( var_2 in level.moonorb_safe_vols )
        {
            ...
            {
                if ( _func_2E6( getgroundposition( var_0, 64 ) ) )
                {
...
moon_orb_teleport_validation( var_0 )
{
    ...
    foreach ( var_12, var_8 in var_6.validposarray )
    {
        ...
        if ( var_1[0] == 1 )
        {
            ...
            if ( _func_21B( var_9, getent( "zone_crash", "targetname" ) ) )
            {
                var_11 = undefined;
                var_11 = getgroundposition( var_9, 64 );
...
moon_orb_head_bump_test( var_0 )
{
    ...
    if ( isdefined( var_0 ) )
    {
        for ( var_5 = 0; var_5 < 2; var_5++ )
        {
            ...
            {
                var_8 = playerphysicstrace( var_6, var_6 + ( 0, 0, var_1 ), level.moon_orb_manager["moonscepter_orb_active"] );
...
spike_emp_spec_effect()
{
    ...
    {
        playfxontagforclients( common_scripts\utility::_id_44F5( "zmb_melee_drain_player" ), var_0, "J_Spine4", var_0 );
...
scythe_throw_blades( var_0 )
{
    ...
    var_4 = magicgrenademanual( "scythe_shard_zm", self geteye() + ( 3, 0, 0 ), vectornormalize( var_1 ) * 1600, 10, self, 1, 1 );
    var_5 = magicgrenademanual( "scythe_shard_zm", self geteye(), vectornormalize( var_2 ) * 1600, 10, self, 1, 1 );
    var_6 = magicgrenademanual( "scythe_shard_zm", self geteye() - ( 3, 0, 0 ), vectornormalize( var_3 ) * 1600, 10, self, 1, 1 );
    var_4._id_0117 = self;
    var_5._id_0117 = self;
    var_6._id_0117 = self;
...
scythe_death_shield_burst()
{
    ...
    var_0 = sortbydistance( var_0, self.origin, 256 );
    scythe_death_shield_set_empty();
...
plinth_weapon_move_into_place( var_0, var_1 )
{
    ...
    {
        case "shield_emp":
            var_0.towerfx = spawnfx( common_scripts\utility::_id_44F5( "zmb_desc_fire_pillar_01" ), var_2[0].origin );
            ...
            break;
        case "hammer_emp":
            var_0.towerfx = spawnfx( common_scripts\utility::_id_44F5( "zmb_desc_fire_pillar_01" ), var_2[1].origin );
            ...
            break;
        case "spike_emp":
            var_0.towerfx = spawnfx( common_scripts\utility::_id_44F5( "zmb_desc_fire_pillar_01" ), var_2[2].origin );
            ...
            break;
        case "scythe_emp":
            var_0.towerfx = spawnfx( common_scripts\utility::_id_44F5( "zmb_desc_fire_pillar_01" ), var_2[3].origin );
...
{
    var_1 = getent( "shield_angles_destination", "targetname" );
    var_2 = getent( "shield_manual_pivot", "targetname" );
...
plinth_check_for_all_weapons()
{
    ...
    var_1 = getent( "shield", "script_noteworthy" );
