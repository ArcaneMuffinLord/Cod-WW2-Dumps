...
spawn_bubble_bomb( var_0, var_1, var_2 )
{
    ...
    var_6 = magicbullet( var_4, var_3.origin, var_1, 1, var_5[2] + 42, var_3 );
...
{
    var_3 = getgroundposition( var_0, 12 );
    ...
    if ( !var_2 )
        playfxontag( common_scripts\utility::_id_44F5( "zmb_giestbomb_exp_1shot" ), var_4, "TAG_ORIGIN" );
    ...
    else
    {
        ...
        {
            if ( distance2d( var_15.origin, var_0 ) <= 160 )
...
try_charlton_blackhole( var_0, var_1 )
{
    ...
    var_2 = getgroundposition( var_0, 12 );
...
dp28_modify_projectile( var_0, var_1 )
{
    ...
    if ( var_1 )
    {
        playfxontag( common_scripts\utility::_id_44F5( "zmi_hc_rune_green" ), self, "tag_origin" );
...
dp28_noisy_cricket( var_0 )
{
    ...
    var_4 = sortbydistance( var_4, var_2, 256 );
    ...
    foreach ( var_6 in var_4 )
    {
        ...
        if ( distance2d( var_6.origin, var_2 ) <= 128 )
        {
        ...
        else if ( distance2d( var_6.origin, var_2 ) <= 192 )
        {
            if ( common_scripts\utility::_id_562E( var_3 ) )
        ...
        else if ( distance2d( var_6.origin, var_2 ) <= 256 )
        {
            if ( common_scripts\utility::_id_562E( var_3 ) )
