...
flare_handle_effects( var_0, var_1 )
{
    ...
    playfxontag( common_scripts\utility::_id_44F5( "signal_flare_zombie" ), var_2._id_3F83, "TAG_ORIGIN" );
    ...
    while ( isdefined( self ) )
    {
        ...
        foreach ( var_5 in var_3 )
        {
            ...
            {
                if ( bullettracepassed( var_5.origin, var_2.landing_point, 0, var_5, self ) )
                {
...
{
    self waittill( "death" );
    killfxontag( common_scripts\utility::_id_44F5( "signal_flare_zombie" ), var_0._id_3F83, "TAG_ORIGIN" );
