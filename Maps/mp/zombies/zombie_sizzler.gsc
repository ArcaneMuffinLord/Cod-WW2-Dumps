...
zombie_make_sizzler( var_0, var_1 )
{
    ...
    var_15 = getmovedelta( var_13, 0, var_14 );
    ...
    playfxontag( level._effect["zmb_ber_bolt_rod_gk_attach"], var_21, "TAG_ORIGIN" );
    var_21 scriptmodelplayanim( "s2_zom_ww_bolt_extend" );
    var_21 thread monitor_sizzler_bolt( self );
    var_22 = getanimlength( var_13 );
    ...
    killfxontag( level._effect["zmb_ber_bolt_rod_gk_attach"], var_21, "TAG_ORIGIN" );
...
zombie_make_sizzler_simple()
{
    ...
    var_8 = getmovedelta( var_6, 0, var_7 );
...
zombie_sizzler_vfx()
{
    self endon( "death" );
    waitframe();
    playfxontag( common_scripts\utility::_id_44F5( "zmb_sizzler_zombie_smoldering" ), self, "J_Spine4" );
    playfxontag( common_scripts\utility::_id_44F5( "zmb_sizzler_head" ), self, "J_head" );
    playfxontag( common_scripts\utility::_id_44F5( "zmb_sizzler_flames" ), self, "J_Knee_LE" );
    playfxontag( common_scripts\utility::_id_44F5( "zmb_sizzler_flames" ), self, "J_Knee_RI" );
    waitframe();
    playfxontag( common_scripts\utility::_id_44F5( "zmb_sizzler_mouth" ), self, "jnt_mandible" );
}
...
monitor_sizzler_bolt( var_0 )
{
    ...
    killfxontag( level._effect["zmb_ber_bolt_rod_gk_attach"], var_1, "TAG_ORIGIN" );
    waitframe();
    var_1 _meth_82C2();
