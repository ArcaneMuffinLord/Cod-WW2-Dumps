...
{
    var_0 = spawnstruct();
    var_0._id_10BD = getent( "assemble_ww_trig", "targetname" );
...
_id_AA6E( var_0, var_1 )
{
    ...
    for (;;)
    {
        ...
        if ( isdefined( var_3._id_A2B0 ) && isdefined( var_3._id_A2B0[var_1] ) )
            ...
            var_3 setweaponammoclip( var_1, weaponclipsize( var_1 ) );
...
{
    var_8 = getnotetracktimes( var_0, var_4 );
    var_9 = var_8[0] * getanimlength( var_0 );
    var_10 = getnotetracktimes( var_0, var_5 );
    var_11 = var_10[0] * getanimlength( var_0 );
    wait( var_9 );
...
_id_AA73( var_0 )
{
    ...
    var_8 delete();
    self._id_48F2 scriptmodelclearanim();
    self._id_48F2 scriptmodelplayanim( _func_286( var_5 ), "", 9.2 );
    wait 0.866667;
...
_id_AA7A( var_0 )
{
    ...
    wait( var_8 - 0.1 );
    var_0._id_48F2 scriptmodelclearanim();
    var_0._id_48F2 scriptmodelplayanim( _func_286( var_6 ), "", 9.2 );
    wait 0.866667;
...
_id_AA79( var_0 )
{
    ...
    for (;;)
    {
        ...
        else if ( distancesquared( self.origin, var_0._id_48F2._id_9255 ) < var_2 && var_0._id_78A1 == "closed" )
        {
            ...
            wait( var_10 - 0.1 );
            var_0._id_48F2 scriptmodelclearanim();
            var_0._id_48F2 scriptmodelplayanim( _func_286( var_8 ), "", 9.2 );
            wait 0.866667;
...
_id_AA76()
{
    ...
    for (;;)
    {
        ...
        if ( isdefined( var_2._id_A2B0 ) && isdefined( var_2._id_A2B0[self._id_A9E0] ) )
            ...
            var_2 setweaponammoclip( self._id_A9E0, weaponclipsize( self._id_A9E0 ) );
