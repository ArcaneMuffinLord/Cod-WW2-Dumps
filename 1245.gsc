...
_id_280A()
{
    self._id_4DEF = spawnturret( "misc_turret", self.origin, level._id_83E9["sentry_minigun"]._id_01D1 );
...
_id_9BC5()
{
    ...
    for (;;)
    {
        if ( isdefined( self._id_4DEF ) )
        {
            ...
            self._id_4DEF._id_1F2F = _id_2865() && self _meth_8346() && var_3["result"] && _id_21EE( self._id_4DEF ) && abs( self._id_4DEF.origin[2] - self.origin[2] ) < 8;
            ...
            if ( self._id_4DEF._id_1F2F != var_0 )
            {
                if ( self._id_4DEF._id_1F2F )
                {
                    ...
                    waitframe();
                    playfxontagforclients( level._id_94F1, self._id_4DEF, "TAG_ORIGIN", self );
                ...
                else
                {
                    ...
                    waitframe();
                    playfxontagforclients( level._id_94F2, self._id_4DEF, "TAG_ORIGIN", self );
...
_id_7FAF( var_0, var_1, var_2 )
{
    ...
    thread maps\mp\_utility::printonteam_( &"HUB_NOTIFY_OPEN_SUPPLY_DROP", self.team, self.name );
...
_id_5106( var_0, var_1, var_2 )
{
    ...
    else
    {
        ...
        if ( var_5 == 3 || var_5 == 4 )
            playfxontag( var_2[var_5], self._id_08DD, var_8 );
        ...
        {
            case 3:
                thread maps\mp\_utility::printonteam_( &"HUB_NOTIFY_RECEIVED_EPIC_ITEM", self.team, self.name );
                break;
            case 4:
                thread maps\mp\_utility::printonteam_( &"HUB_NOTIFY_RECEIVED_HEROIC_ITEM", self.team, self.name );
                break;
            default:
                break;
        }
...
_id_93FA( var_0, var_1 )
{
    ...
    killfxontag( var_0, self._id_08DD, var_1 );
}
...
_id_24E2( var_0 )
{
    var_1 = getent( "psd_collision", "targetname" );
